...
Verify the cache invalidation flow: content sync detects hash change → invalidateAudio mutation resets records → next request regenerates audio.
...
### Subtask 5.2.1: Create Invalidation Test
...
### Subtask 5.2.2: Manual Invalidation Test
