...
- Function <InlineMath math="g(x) = (2x)^2" /> (orange) is horizontally compressed by factor 2
- Function <InlineMath math="h(x) = (0.5x)^2" /> (sky) is horizontally stretched by factor 0.5
...
- Function <InlineMath math="g(x) = 2x + 2" /> has slope 2 (horizontally compressed)
- Function <InlineMath math="h(x) = 0.5x + 2" /> has slope 0.5 (horizontally stretched)
