...
- Fungsi <InlineMath math="g(x) = f(2x) = 2x + 2" /> memiliki kemiringan 2 (ditekan horizontal)
- Fungsi <InlineMath math="h(x) = f(0.5x) = 0.5x + 2" /> memiliki kemiringan 0.5 (diregangkan horizontal)
