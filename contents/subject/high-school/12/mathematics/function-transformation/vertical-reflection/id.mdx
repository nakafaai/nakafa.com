...
- Fungsi asli <InlineMath math="f(x) = x^2" /> (ungu) membuka ke atas dengan titik puncak di <InlineMath math="(0, 0)" />
- Fungsi hasil refleksi <InlineMath math="g(x) = -x^2" /> (oranye) membuka ke bawah dengan titik puncak tetap di <InlineMath math="(0, 0)" />
...
- Asimtot horizontal berubah dari <InlineMath math="y = 0" /> menjadi <InlineMath math="y = 0" /> (tetap sama karena <InlineMath math="-0 = 0" />)
