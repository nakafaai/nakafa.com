  ...
  data={[
    ...
    },
    {
      points: Array.from({ length: 21 }, (_, i) => {
        const x = (i - 10) * 0.4;
        const y = x * x * 0.3;
        // Combination: translation +2 then dilation 0.5
  ...
  data={[
    ...
    },
    {
      points: Array.from({ length: 21 }, (_, i) => {
        const x = (i - 10) * 0.3;
        const y = x * x * 0.2;
        // Order 1: Dilation first (×2), then translation (+1)
        const y1 = 2 * y + 1;
        return { x, y: y1, z: 0 };
      }),
    ...
    },
    {
      points: Array.from({ length: 21 }, (_, i) => {
        const x = (i - 10) * 0.3;
        const y = x * x * 0.2;
        // Order 2: Translation first (+1), then dilation (×2)
        const y2 = 2 * (y + 1);
        return { x, y: y2, z: 0 };
      }),
...
<LineEquation
  ...
  data={[
    ...
    },
    {
      points: Array.from({ length: 15 }, (_, i) => {
        const x = (i - 7) * 0.4;
        // Combination: reflection then horizontal translation +2
