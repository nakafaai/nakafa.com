...
<div className="mt-4">
  <LineEquation
    title="Graph of f(x) = x² - 2x - 3"
    description="Parabola passing through points K(-1, 0), L(0, -3), and M(1, -4)"
    smooth={true}
...
<div className="mt-4">
  <LineEquation
    ...
    description="Parabola with vertex at (2, 0) and passing through point (4, 4)"
    smooth={true}
...
<div className="mt-4">
  <LineEquation
    ...
    description="Parabola with roots at x = -2 and x = 3, passing through point (1, -6)"
    smooth={true}
...
<div className="mt-4">
  <LineEquation
    title="Graph of f(x) = (1/16)x²"
    description="Parabola passing through points (0, 0), (4, 1), and (-4, 1)"
    smooth={true}
