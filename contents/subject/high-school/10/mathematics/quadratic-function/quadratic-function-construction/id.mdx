...
<div className="mt-4">
  <LineEquation
    ...
    description="Parabola yang melalui titik K(-1, 0), L(0, -3), dan M(1, -4)"
    smooth={true}
...
<div className="mt-4">
  <LineEquation
    ...
    description="Parabola dengan titik puncak (2, 0) dan melalui titik (4, 4)"
    smooth={true}
...
<div className="mt-4">
  <LineEquation
    title="Grafik f(x) = (x + 2)(x - 3)"
    description="Parabola dengan akar-akar x = -2 dan x = 3, melalui titik (1, -6)"
    smooth={true}
...
<div className="mt-4">
  <LineEquation
    title="Grafik f(x) = (1/16)x²"
    description="Parabola melalui titik (0, 0), (4, 1), dan (-4, 1)"
    smooth={true}
