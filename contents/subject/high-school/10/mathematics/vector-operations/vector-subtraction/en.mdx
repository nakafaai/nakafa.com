...
<Vector3d
  ...
  description={
    <>
      Vector subtraction <InlineMath math="a - b" /> (purple color) is
      equivalent to vector <InlineMath math="a" /> (blue color) added to the
      negative of vector <InlineMath math="b" /> (red color).
    </>
  }
  vectors={[
    {
