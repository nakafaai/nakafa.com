...
1.  <InlineMath math="(A^T)^T = A" /> (The transpose of a transpose matrix is the matrix
    itself)
2.  <InlineMath math="(A + B)^T = A^T + B^T" /> (Transpose of the sum of two matrices)
3.  <InlineMath math="(A - B)^T = A^T - B^T" /> (Transpose of the subtraction of two matrices)
