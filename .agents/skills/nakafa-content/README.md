...
- Match the target grade and subject. A grade 10 physics page should use first-year high-school language, familiar examples, and only the prerequisite math or science that the lesson has introduced.
