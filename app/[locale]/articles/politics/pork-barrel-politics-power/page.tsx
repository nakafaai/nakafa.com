...
const githubUrl =
  "https://github.com/nabilfatih/nakafa.com/tree/main/app/%5Blocale%5D/articles/politics/pork-barrel-politics-power";
...
export default async function Page({ params }: Props) {
  ...
  try {
    ...
    const rawContent = await fs
      .readFile(
        `app/[locale]/articles/politics/pork-barrel-politics-power/${locale}.mdx`,
        "utf-8"
      )
      .catch(() => {
        return "";
