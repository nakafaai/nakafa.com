...
Perhatikan pembelahan bakteri pada gambar. Satu bakteri dapat membelah menjadi dua, kemudian empat, delapan, dan seterusnya.
...
awal adalah 1 juta orang dengan pertumbuhan 2% per tahun, setelah 10 tahun populasinya menjadi <InlineMath math="1.000.000 \times (1 + 0,02)^{10} = 1.000.000 \times 1,22 = 1.220.000" /> orang.
