...
Misalnya, jika kita memiliki sudut elevasi matahari 30° (tan 30° = 0,57) dan ingin menghitung panjang bayangan remaja dengan tinggi 148 cm:
...
<div className="mt-4">
  <Triangle
    ...
    description="Visualisasi segitiga dengan sudut 30° seperti pada contoh perhitungan."
    angle={30}
    labels={{
