...
<Vector3d
  ...
  description="Visualization of a vector in three-dimensional space with x, y, and z components."
  vectors={[
    {
      from: [0, 0, 0],
      to: [3, 4, 2],
...
- <InlineMath math="a_x" /> is the vector component on the x-axis
- <InlineMath math="a_y" /> is the vector component on the y-axis
- <InlineMath math="a_z" /> is the vector component on the z-axis
- <InlineMath math="\vec{i}, \vec{j}, \vec{k}" /> are the unit vectors on the x,
  y, and z axes

<div className="mt-4">
  <Vector3d
    title="Components of a Three-Dimensional Vector"
    description="Three-dimensional vector with components on the x, y, and z axes."
    vectors={[
      {
        from: [0, 0, 0],
        to: [4, 0, 0],
...
<div className="mt-4">
  <Vector3d
    ...
    description="Visualization of adding vectors a and b to produce vector c = a + b."
    vectors={[
      {
        from: [0, 0, 0],
        to: [2, 3, 1],
...
<div className="mt-4">
  <Vector3d
    ...
    description="Visualization of scalar multiplication k times vector a, where k = 2."
    vectors={[
      {
        from: [0, 0, 0],
        to: [2, 1, 2],
