  ...
  return createPrompt({
    ...
    detailedTaskInstructions: `
      ...
      <WEB_TOOLS_USAGE>
        ...
        <citation_format>Use inline citations like: "According to (citation), ..." or "Research shows that (finding) (citation).". Citation can be created from the title and url of the source with the following format: [title](url) - CRITICAL: NO SPACE between ] and ( or the link will break</citation_format>
      </WEB_TOOLS_USAGE>
