...
describe("providerCompatibleObjectSchema", () => {
  it.effect(
  ...
  it("inlines named fields before merging union metadata", () => {
  ...
  it("preserves recursive fields and rejects recursive roots", () => {
    interface RecursiveValue {
      readonly next?: RecursiveValue;
    }
