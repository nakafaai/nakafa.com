...
describe("research web search tool", () => {
  ...
  it.live(
    "keeps sources scoped to distinctive query terms when adjacent tools appear",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({
          web: [
  ...
  it.live(
    "keeps natural multilingual source queries scoped to the named product",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({
          web: [
  ...
  it.live("keeps primary-source requests on first-party product domains", () =>
    Effect.gen(function* () {
      firecrawlApp.search.mockResolvedValue({
        web: [
          {
  ...
  it.live(
    "scopes a single mixed-case query term when the first source matches it",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({
          web: [
            ...
            {
              description:
                "Developer tooling without the requested source name.",
  ...
  it.live(
    "scopes sources to explicit task terms even when generic results rank first",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({
          web: [
  ...
  it.live(
    "scopes lowercase hyphenated source queries when the first source matches",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({
          web: [
  ...
  it.live(
    "deduplicates repeated distinctive query terms before source scoping",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({
          web: [
  ...
  it.live(
    "does not scope short single acronyms that are too broad for filtering",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({
          web: [
  ...
  it.live(
    "does not clip school-event research queries from the user task",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({});
        const { parts, writer } = createWriter();
  ...
  it.live(
    "does not execute broad school-event query variants without the named school",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockResolvedValue({});
        const { parts, writer } = createWriter();
  ...
  it.live(
    "keeps distinctive task terms when optimized queries drift generic",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockImplementation((query: string) =>
          Promise.resolve({
  ...
  it.live(
    "does not inject hidden task-anchor searches when a query is provided",
    () =>
      Effect.gen(function* () {
        firecrawlApp.search.mockImplementation((query: string) => {
