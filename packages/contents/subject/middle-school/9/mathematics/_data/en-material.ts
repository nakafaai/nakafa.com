...
const enMaterials: MaterialList = [
  {
    ...
    items: [
      {
        title: "Concept of Linear Equations in Two Variables",
        href: `${BASE_PATH}/linear-equations-two-variables/concept`,
      },
      {
        title: "Modeling Linear Equations in Two Variables",
      ...
      {
        title: "Concept of System of Linear Equations in Two Variables",
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Classification of 3D Shapes and Nets",
        href: `${BASE_PATH}/solid-geometry/classification`,
      },
      {
        title: "Surface Area of Prisms, Cuboids, and Cubes",
      ...
      {
        title: "Effect of Scale Change on Flat-Sided 3D Shapes' Surface Area",
      ...
      {
        title: "Calculating Volume of Cubes, Cuboids, and Prisms",
        href: `${BASE_PATH}/solid-geometry/volume-prism`,
      },
      {
        title: "Volume of Arrangement of Unit Cubes",
        href: `${BASE_PATH}/solid-geometry/volume-unit-cubes`,
      },
      {
        title: "Volume of Aquarium",
      ...
      {
        title: "Building Regular Hexagonal Pyramid",
        href: `${BASE_PATH}/solid-geometry/building-pyramid`,
      },
      {
        title: "Effect of Scale Change on Flat-Sided 3D Shapes' Volume",
      ...
      {
        title: "Effect of Scale Change on Curved-Sided 3D Shapes' Surface Area",
      ...
      {
        title: "Finding Volume of Sphere",
        href: `${BASE_PATH}/solid-geometry/volume-sphere`,
      },
      {
        title: "Effect of Scale Change on Curved-Sided 3D Shapes' Volume",
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Center and Direction of Rotation",
        href: `${BASE_PATH}/geometric-transformation/rotation-center-direction`,
      },
      {
        title: "Rotation Against Center Point (0,0)",
      ...
      {
        title: "Characteristics of Translation, Reflection, and Rotation",
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Determining Sample Space",
      ...
      {
        title: "Range of Probability Values",
      ...
      {
        title:
          "Relationship Between Relative Frequency and Theoretical Probability",
        href: `${BASE_PATH}/probability-sampling/frequency-theoretical`,
      },
      {
        title: "Guessing Sample Space",
