export const metadata = {
    ...
    description: "Learn Python syntactic sugar features like list comprehensions, lambda functions, and assignment operators to write cleaner, more efficient code.",
