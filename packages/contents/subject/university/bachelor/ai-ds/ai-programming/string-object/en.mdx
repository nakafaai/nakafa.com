export const metadata = {
    ...
    description: "Learn Python string objects through definitions, multiline strings, concatenation literals, and variables. Understand how the str data type works.",
