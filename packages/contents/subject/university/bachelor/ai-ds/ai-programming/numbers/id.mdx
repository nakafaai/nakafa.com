export const metadata = {
  title: "Numbers",
  description: "Pelajari tipe angka Python: integer, float, dan kompleks. Pelajari type checking, constructor, dan notasi ilmiah untuk pemrograman AI.",
...
Integer adalah bilangan bulat tanpa koma desimal. Ini termasuk bilangan positif, negatif, dan nol. Dalam kehidupan sehari-hari, kamu menggunakan integer untuk menghitung barang yang tidak bisa dipecah, seperti jumlah mahasiswa dalam satu ruangan atau nomor halaman buku.
