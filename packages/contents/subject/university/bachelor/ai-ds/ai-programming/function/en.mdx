export const metadata = {
    title: "Functions",
    description: "Learn Python functions, including parameters, return values, variable scope, closures, and error handling with code examples.",
...
<Mermaid
  title="Variable Scope in Functions"
