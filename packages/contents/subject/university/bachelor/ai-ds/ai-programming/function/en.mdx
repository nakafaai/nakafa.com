export const metadata = {
    title: "Functions",
    description: "Learn Python functions: parameters, return values, variable scope, closures, error handling. Complete guide with tested code examples for AI programming students.",
