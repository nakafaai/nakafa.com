...
Slicing seperti memotong roti tawar. Jika kamu punya <InlineMath math="6" /> lembar roti (indeks <InlineMath math="0\text{-}5" />), maka `x[1:4]` berarti mengambil lembar ke-<InlineMath math="2" /> sampai ke-<InlineMath math="4" /> (tidak termasuk lembar ke-<InlineMath math="5" />). Sedangkan `x[1:4:2]` berarti mengambil lembar ke-<InlineMath math="2" /> dan ke-<InlineMath math="4" /> saja (melompati <InlineMath math="1" /> lembar).
...
<Mermaid
  title="Operasi dan Kesamaan dengan String"
