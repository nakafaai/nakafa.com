...
> For complete reference about NumPy data types, you can visit the [official NumPy documentation](https://numpy.org/doc/stable/user/basics.types.html) which provides technical details and usage examples for each data type.
