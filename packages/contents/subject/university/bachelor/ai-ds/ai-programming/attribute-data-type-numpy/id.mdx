...
> Informasi mendalam tentang sistem tipe data tersedia di [NumPy Data Types Reference](https://numpy.org/doc/stable/user/basics.types.html) dengan penjelasan teknis dan implementasi praktis untuk setiap tipe data.
