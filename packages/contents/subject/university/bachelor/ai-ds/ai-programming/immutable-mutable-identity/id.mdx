export const metadata = {
    ...
    description: "Pelajari konsep mutabilitas, identitas, dan manajemen memori objek Python. Pelajari cara kerja list, referensi, dan identitas objek dengan contoh praktis.",
...
<Mermaid
  title="Identitas, Tipe, dan Nilai Objek"
...
<Mermaid
  title="Perilaku Assignment vs Modifikasi"
