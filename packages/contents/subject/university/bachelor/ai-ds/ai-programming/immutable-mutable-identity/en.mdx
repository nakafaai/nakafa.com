export const metadata = {
  ...
  description: "Learn Python object mutability, identity, and memory management. Learn how lists, references, and object identity work with practical examples and code.",
...
<Mermaid
  title="Object Identity, Type, and Value"
...
<Mermaid
  title="Assignment vs Modification Behavior"
