...
<Mermaid
  title="Dictionary sebagai Container"
  description="Lihat bagaimana key membawa program langsung ke value tertentu tanpa bergantung pada urutan posisi."
  chart={`
    flowchart TD
...
Sejak Python <InlineMath math="3.6" />, dictionary mempertahankan urutan penyisipan elemen. Ketika kamu mendefinisikan ulang nilai dari kunci yang sudah ada, hanya nilai terbaru yang tersimpan tanpa mengubah urutan penyisipan kunci.
