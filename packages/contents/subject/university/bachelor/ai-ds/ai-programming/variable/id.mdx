export const metadata = {
    title: "Variabel",
    description: "Pelajari konsep variabel Python, aturan penamaan, keyword yang tidak boleh digunakan, dan cara kerja memori dengan contoh.",
...
Ketika kamu menuliskan `x = 2`, Python melakukan tiga hal penting. Pertama, Python membuat objek dengan nilai <InlineMath math="2" /> di dalam memori. Kedua, Python menyimpan objek tersebut di alamat memori tertentu. Ketiga, Python menghubungkan nama variabel `x` dengan alamat memori tersebut.
...
<Mermaid
  title="Cara Kerja Variabel dan Memori"
...
Nama variabel dalam Python dapat terdiri dari tiga komponen utama. Pertama adalah huruf, baik huruf kecil (`a`, `b`, `c`, ..., `z`) maupun huruf besar (`A`, `B`, `C`, ..., `Z`). Kedua adalah angka (<InlineMath math="0, 1, 2, \dots, 9" />). Ketiga adalah karakter underscore (_).
