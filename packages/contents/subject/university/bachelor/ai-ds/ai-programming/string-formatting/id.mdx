export const metadata = {
    ...
    description: "Pelajari teknik pemformatan string Python dengan format(), f-strings, alignment, precision control, error handling, dan contoh praktis.",
...
<Mermaid
  ...
  chart={`
    flowchart TD
        A["String input: 'xxx'"] --> B["Pilihan perataan"]
