export const metadata = {
    ...
    description: "Learn Python string formatting with format(), f-strings, width control, alignment options, sign specification, and examples.",
...
<Mermaid
  title="Argument Reference Methods"
...
<Mermaid
  title="Complete Format Specification Pattern"
