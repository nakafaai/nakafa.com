export const metadata = {
    ...
    description: "Learn Python string formatting with format(), f-strings, width control, alignment options, and sign specification. Complete guide with tested examples.",
