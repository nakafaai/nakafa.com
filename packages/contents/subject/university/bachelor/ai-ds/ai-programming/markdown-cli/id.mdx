export const metadata = {
  ...
  description: "Pelajari sintaks Markdown dan perintah CLI untuk alur kerja dokumentasi efisien. Pelajari operasi file, skrip otomasi, dan tools konversi pandoc.",
...
Kombinasi CLI dan markdown berguna untuk dokumentasi dan pengembangan. Kamu bisa membuat alur kerja yang efisien:
...
Dengan menguasai markdown dan antarmuka baris perintah, kamu bisa membuat alur kerja dokumentasi yang efisien dan otomatis. Markdown memberikan cara mudah untuk menulis konten terstruktur, sementara CLI menyediakan alat untuk mengelola, mengkonversi, dan menyebarkan dokumentasi tersebut.
