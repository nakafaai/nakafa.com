export const metadata = {
  ...
  description: "Learn Markdown syntax and CLI commands for efficient documentation workflows. Learn file operations, automation scripts, and pandoc conversion tools.",
