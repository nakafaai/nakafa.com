export const metadata = {
    ...
    description: "Learn Python comparison and boolean operators with interactive diagrams. Learn operator precedence, falsy/truthy values, and safe float comparisons.",
...
<Mermaid
  title="Operator Precedence Order"
