export const metadata = {
    ...
    description: "Pelajari teknik indexing dan slicing Python untuk mengakses elemen string dan list. Pelajari penggunaan indeks positif, negatif, dan stride.",
...
Python menggunakan sistem penomoran yang dimulai dari <InlineMath math="0" />, bukan <InlineMath math="1" />. Jadi elemen pertama memiliki indeks <InlineMath math="0" />, elemen kedua memiliki indeks <InlineMath math="1" />, dan seterusnya. Selain itu, Python juga mendukung indeks negatif yang menghitung mundur dari akhir.
