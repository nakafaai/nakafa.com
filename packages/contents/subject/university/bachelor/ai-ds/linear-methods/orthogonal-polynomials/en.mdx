export const metadata = {
    ...
    description: "Learn Chebyshev and Legendre polynomials with weighted scalar products, Gram-Schmidt process, and Gauss approximation for numerical analysis.",
