export const metadata = {
    ...
    description: "Pelajari matriks definit positif dengan kriteria nilai eigen, minor utama, sifat geometris, dan aplikasi optimasi untuk solusi matematika andal.",
...
Mengapa demikian? Karena jika kita ambil vektor basis standar <InlineMath math="e_i" /> yang hanya memiliki komponen <InlineMath math="1" /> pada posisi ke-<InlineMath math="i" /> dan <InlineMath math="0" /> di tempat lain, maka:
...
Karena ada nilai eigen negatif, matriks ini adalah **indefinit**. Meskipun elemen diagonalnya (<InlineMath math="1" /> dan <InlineMath math="4" />) keduanya positif, hal ini tidak menjamin definit positif.
