export const metadata = {
    ...
    description: "Learn complex vector spaces with complex numbers, fundamental theorem of algebra, and 8 essential axioms. Learn AI linear methods step-by-step.",
