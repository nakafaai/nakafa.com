export const metadata = {
    ...
    description: "Pelajari ruang vektor kompleks dengan bilangan kompleks, teorema fundamental aljabar, dan delapan aksioma penting metode linear AI secara bertahap.",
