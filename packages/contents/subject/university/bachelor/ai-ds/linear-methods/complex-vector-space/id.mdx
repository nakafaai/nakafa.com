...
**Definisi Ruang Vektor Kompleks**: Suatu himpunan <InlineMath math="V" /> dengan operasi penjumlahan
...
Elemen-elemen <InlineMath math="x \in V" /> disebut **vektor**, sedangkan elemen-elemen <InlineMath math="\lambda \in \mathbb{C}" /> disebut **skalar**.
...
Perbedaan utama terletak pada **lapangan skalar** yang digunakan. Sementara ruang vektor real menggunakan <InlineMath math="\mathbb{R}" /> sebagai lapangan skalar, ruang vektor kompleks menggunakan <InlineMath math="\mathbb{C}" /> yang memberikan fleksibilitas lebih dalam perhitungan.