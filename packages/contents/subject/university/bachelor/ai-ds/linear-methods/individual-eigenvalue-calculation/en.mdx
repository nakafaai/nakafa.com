export const metadata = {
    ...
    description: "Learn three eigenvalue calculation methods: inverse iteration with shift, von Mises for dominant eigenvalues, and smallest eigenvalue techniques.",
