export const metadata = {
    title: "Regularisasi",
    description: "Pelajari regularisasi Tikhonov untuk sistem linear tidak stabil. Pelajari cara menyelesaikan masalah ill-conditioned dan menstabilkan estimasi parameter.",
