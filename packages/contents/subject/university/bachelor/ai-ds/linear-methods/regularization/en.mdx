export const metadata = {
    ...
    description: "Learn Tikhonov regularization for unstable linear systems. Learn to solve ill-conditioned problems, prevent overfitting, and stabilize parameter estimation.",
