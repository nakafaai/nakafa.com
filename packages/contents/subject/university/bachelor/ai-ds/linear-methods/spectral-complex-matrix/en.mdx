export const metadata = {
   ...
   description: "Learn orthogonal diagonalization of normal matrices: prove equivalence between normality and eigenvector bases using mathematical induction.",
