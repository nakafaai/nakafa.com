export const metadata = {
    title: "Cramer's Rule",
    description: "Solve linear systems using determinants with Cramer's rule. Learn complementary matrices, inverse formulas, and worked examples for AI applications.",
