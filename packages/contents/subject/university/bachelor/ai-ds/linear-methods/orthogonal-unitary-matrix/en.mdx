export const metadata = {
    ...
    description: "Learn orthogonal and unitary matrices through determinant properties, eigenvalue analysis, rotation examples, and linear algebra applications.",
...
What's interesting about orthogonal and unitary matrices is that their determinants always have absolute value <InlineMath math="1" />. Why is this?
...
For real orthogonal matrices, the eigenvalues can be <InlineMath math="1" /> or <InlineMath math="-1" /> if real. But if complex, they can be written as:
