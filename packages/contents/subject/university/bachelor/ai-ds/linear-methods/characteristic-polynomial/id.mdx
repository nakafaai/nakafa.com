export const metadata = {
    ...
    description: "Pelajari polinomial karakteristik untuk mencari nilai eigen, memahami multiplisitas aljabar, dan melihat hubungan dengan jejak matriks.",
