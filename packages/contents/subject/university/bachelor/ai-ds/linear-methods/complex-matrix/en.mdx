...
**Definition of Complex Matrix**: A rectangular scheme of complex numbers with <InlineMath math="m \in \mathbb{N}" /> rows and <InlineMath math="n \in \mathbb{N}" /> columns is called a complex <InlineMath math="m \times n" /> matrix:
...
**Definition of Adjoint Matrix**: Let <InlineMath math="A \in \mathbb{C}^{m \times n}" /> be a complex <InlineMath math="m \times n" /> matrix. The **adjoint matrix** (complex conjugate transpose matrix) <InlineMath math="A^H" /> of <InlineMath math="A" /> is the complex <InlineMath math="n \times m" /> matrix obtained by swapping the rows and columns of <InlineMath math="A" /> and taking the complex conjugate of each entry:
...
**Definition of Euclidean Norm**: For <InlineMath math="v \in \mathbb{C}^n" />, we define:
