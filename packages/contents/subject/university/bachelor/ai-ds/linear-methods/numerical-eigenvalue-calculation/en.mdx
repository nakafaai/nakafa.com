export const metadata = {
    ...
    description: "Learn iterative eigenvalue algorithms for nonlinear problems. Learn dominant eigenvalue methods, diagonalization, and computational approaches for AI.",
