export const metadata = {
    ...
    description: "Pelajari kapan matriks dapat didiagonalisasi dengan vektor eigen ortonormal. Pelajari matriks normal, hermitian, dan kesatuan untuk AI.",
...
Kondisi ini terlihat sederhana, tetapi memiliki makna geometri yang kuat. Matriks yang dapat "bertukar tempat" dengan konjugat transposnya memiliki sifat geometri yang istimewa.
...
Nilai eigen matriks kesatuan memiliki besaran <InlineMath math="1" />, artinya terletak pada lingkaran satuan di bidang kompleks. Kita bisa menunjukkan hal ini dengan perhitungan berikut.
...
Kondisi <InlineMath math="\lambda \cdot \overline{\lambda} = 1" /> secara matematis sama dengan <InlineMath math="|\lambda|^2 = 1" />, yang berarti <InlineMath math="|\lambda| = 1" />. Jadi semua nilai eigen matriks kesatuan memiliki modulus tepat sama dengan <InlineMath math="1" />. Modulus ini adalah jarak dari titik nol di bidang kompleks. Bayangkan seperti roda yang berputar, transformasi kesatuan hanya memutar vektor tanpa mengubah panjangnya.
