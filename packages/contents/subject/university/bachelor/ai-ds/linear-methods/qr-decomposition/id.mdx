export const metadata = {
   ...
   description: "Pelajari QR dekomposisi menggunakan metode Gram-Schmidt dan Householder untuk faktorisasi matriks, transformasi ortogonal, dan sistem linear.",
