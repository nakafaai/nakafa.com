export const metadata = {
    ...
    description: "Learn the QR method for calculating all eigenvalues through iterative matrix decomposition. Learn convergence properties and diagonal elements.",
