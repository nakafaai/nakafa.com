...
import { BASE_PATH } from "@repo/contents/subject/high-school/11/physics/_data/path";
...
const idMaterials = [
  ...
  },
  {
    title: "Kinematika",
    description:
      "Pelajari cara menjelaskan gerak benda dari posisi, kecepatan, percepatan, sampai bentuk lintasannya.",
