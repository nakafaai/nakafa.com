...
import { BASE_PATH } from "@repo/contents/subject/high-school/11/mathematics/_data/path";

const enMaterials = [
  {
    title: "Function Composition and Inverse Function",
    description:
      "Advanced algebra that underlies data encryption and modern computer algorithms.",
  ...
  },
  {
    title: "Polynomial",
    description:
      "Versatile equations that model various natural phenomena and industrial processes.",
  ...
  },
  {
    title: "Matrix",
    description:
      "Mathematical structure underlying computer graphics, AI, and network analysis.",
  ...
  },
  {
    ...
    description: "Movement and shape changes vital in animation and design.",
  ...
  },
  {
    ...
    description:
      "Mathematical tools for describing relationships and predicting real-world system behavior.",
