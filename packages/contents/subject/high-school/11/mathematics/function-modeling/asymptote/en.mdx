...
export const metadata = {
  title: "Asymptote",
  description: "Learn vertical, horizontal, and oblique asymptotes with examples for drawing rational function graphs.",
...
**How to find:** For rational functions, vertical asymptotes occur when <InlineMath math="\text{denominator} = 0" /> and <InlineMath math="\text{numerator} \neq 0" />, or when <InlineMath math="Q(x) = 0" /> and <InlineMath math="P(x) \neq 0" />.
...
1. <InlineMath math="f(x) = \frac{2x + 1}{x^2 - 4}" />
   ...
   **Solution:**
   ...
   - Degree of numerator <InlineMath math="= 1" />, degree of denominator <InlineMath math="= 2" />
- Since <InlineMath math="1 < 2" />, horizontal asymptote: <InlineMath math="y = 0" />

2. <InlineMath math="g(x) = \frac{3x^2 - 1}{2x^2 + 5}" />

   **Solution:**

   - Degree of numerator <InlineMath math="= 2" />, degree of denominator <InlineMath math="= 2" />
...
- <InlineMath math="\text{degree of numerator }(2) = \text{degree of denominator }(1) + 1" />
...
- But when <InlineMath math="x = 2" />, <InlineMath math="\text{numerator} = 0" />, so <InlineMath math="x = 2" /> is not an asymptote
- When <InlineMath math="x = -2" />, <InlineMath math="\text{numerator} = 0" />, so <InlineMath math="x = -2" /> is not an asymptote
- Horizontal asymptote: <InlineMath math="y = 1" /> (same degree, ratio <InlineMath math="= 1/1" />)
...
So minimum cost per unit <InlineMath math="= 3" />

**Answer** <InlineMath math="4" />:

- Vertical asymptotes: <InlineMath math="x = 1" /> and <InlineMath math="x = -1" />
- Horizontal asymptote: <InlineMath math="y = 0" /> (degree of numerator is less than degree of denominator)
