...
**Example:** An earthquake that occurred in Haiti in 2010 had an intensity of <InlineMath math="10^7\text{ times}" /> compared to zero-level earthquakes. What is the Richter scale strength of that earthquake?
