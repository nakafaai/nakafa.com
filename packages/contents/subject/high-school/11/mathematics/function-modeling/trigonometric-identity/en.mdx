...
export const metadata = {
  ...
  description: "Learn trigonometric identities with step-by-step proofs. Learn Pythagorean, reciprocal & quotient identities to solve equations and simplify expressions.",
...
Have you ever noticed that some mathematical equations are always true for any value of their variables? For example, <InlineMath math="(a + b)^2 = a^2 + 2ab + b^2" /> is always true for any values of <InlineMath math="a" /> and <InlineMath math="b" />. Equations like this are called identities.
...
Let's start with the most fundamental identity. Consider a unit circle with point <InlineMath math="P(x, y)" /> that forms angle <InlineMath math="\theta" /> with the positive <InlineMath math="x" />-axis.

<UnitCircle
  title="Unit Circle and Pythagorean Identity"
  description={
    <>
      Notice how the coordinates of point <InlineMath math="P" /> change as the
...
- Radius <InlineMath math="= 1" />
- <InlineMath math="x" />-coordinate is <InlineMath math="\cos \theta" />
- <InlineMath math="y" />-coordinate is <InlineMath math="\sin \theta" />

Using the Pythagorean theorem for point <InlineMath math="P" />:

<BlockMath math="x^2 + y^2 = 1^2" />

Substituting the values of <InlineMath math="x" /> and <InlineMath math="y" />:
...
<ContentStack>
  ...
  <Triangle
    ...
    description={<>Observe how the ratios of triangle sides give <InlineMath math="\sin" />, <InlineMath math="\cos" />, and <InlineMath math="\tan" /> values. Also notice how these values change as the angle changes.</>}
    angle={30}
    labels={{
...
**Even function (symmetry about <InlineMath math="y" />-axis):**
...
<ContentStack>
  ...
  <UnitCircle
    ...
    description={<>Try moving the slider to negative and positive values. Notice how <InlineMath math="\cos" />, <InlineMath math="\sin" />, and <InlineMath math="\tan" /> values change for opposite angles.</>}
    angle={60}
  />
</ContentStack>
...
If <InlineMath math="\sin \theta = \frac{3}{5}" /> and <InlineMath math="90^\circ < \theta < 180^\circ" /> (quadrant II), determine the values of other trigonometric functions.
...
3. If <InlineMath math="\cos \theta = \frac{5}{13}" /> and <InlineMath math="270^\circ < \theta < 360^\circ" />, determine the values of all trigonometric functions.
