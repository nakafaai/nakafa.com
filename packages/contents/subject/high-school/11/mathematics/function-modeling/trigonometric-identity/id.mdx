...
export const metadata = {
  ...
  description: "Pelajari identitas trigonometri dengan pembuktian langkah demi langkah. Pelajari identitas Pythagoras, kebalikan & hasil bagi untuk menyelesaikan soal.",
...
Pernahkah kalian memperhatikan bahwa beberapa persamaan matematika selalu benar untuk setiap nilai variabelnya? Misalnya, <InlineMath math="(a + b)^2 = a^2 + 2ab + b^2" /> selalu benar untuk sembarang nilai <InlineMath math="a" /> dan <InlineMath math="b" />. Persamaan seperti ini disebut identitas.
...
Mari kita mulai dengan identitas paling fundamental. Perhatikan lingkaran satuan dengan titik <InlineMath math="P(x, y)" /> yang membentuk sudut <InlineMath math="\theta" /> dengan sumbu <InlineMath math="x" /> positif.

<UnitCircle
  title="Lingkaran Satuan dan Identitas Pythagoras"
  description={
    <>
      Perhatikan bagaimana koordinat titik <InlineMath math="P" /> berubah saat
      sudut berubah. Koordinat ini adalah nilai <InlineMath math="\cos\theta" />{" "}
      dan <InlineMath math="\sin\theta" />.
    </>
  }
  angle={45}
/>
...
- <InlineMath math="\text{jari-jari} = 1" />
- Koordinat <InlineMath math="x = \cos \theta" />
- Koordinat <InlineMath math="y = \sin \theta" />

Menggunakan teorema Pythagoras untuk titik <InlineMath math="P" />:

<BlockMath math="x^2 + y^2 = 1^2" />

Substitusi nilai <InlineMath math="x" /> dan <InlineMath math="y" />:
...
<ContentStack>
  ...
  <Triangle
    ...
    description={<>Amati bagaimana perbandingan sisi-sisi segitiga memberikan nilai <InlineMath math="\sin" />, <InlineMath math="\cos" />, dan <InlineMath math="\tan" />. Perhatikan juga bagaimana nilai-nilai ini berubah saat sudut berubah.</>}
    angle={30}
    labels={{
      opposite: "Sisi Depan",
...
**Fungsi genap (simetri terhadap sumbu <InlineMath math="y" />):**
...
<ContentStack>
  ...
  <UnitCircle
    ...
    description={<>Coba geser sudut ke nilai negatif dan positif. Perhatikan bagaimana nilai <InlineMath math="\cos" />, <InlineMath math="\sin" />, dan <InlineMath math="\tan" /> berubah untuk sudut yang berlawanan.</>}
    angle={60}
  />
</ContentStack>
...
Jika <InlineMath math="\sin \theta = \frac{3}{5}" /> dan <InlineMath math="90^\circ < \theta < 180^\circ" /> (kuadran II), tentukan nilai fungsi trigonometri lainnya.
...
3. Jika <InlineMath math="\cos \theta = \frac{5}{13}" /> dan <InlineMath math="270^\circ < \theta < 360^\circ" />, tentukan nilai semua fungsi trigonometri.
