...
In the early pandemic, COVID-19 spread in Indonesia could be modeled with an exponential function. If on March 2, 2020 there were <InlineMath math="2 \text{ cases}" /> and in <InlineMath math="60 \text{ days}" /> it reached <InlineMath math="10{,}118 \text{ cases}" />, then:
