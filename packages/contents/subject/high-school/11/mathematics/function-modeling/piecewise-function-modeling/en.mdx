...
- Passes through <InlineMath math="(-2, 0)" /> with slope <InlineMath math="2" />
...
- Passes through <InlineMath math="(2, 4)" /> with slope <InlineMath math="-1" />
...
2. An online taxi company applies the following rates:
   ...
   - Base fare: <InlineMath math="\text{Rp }10,000" /> (for the first <InlineMath math="2 \text{ km}" />)
- Km <InlineMath math="3\text{-}10" />: <InlineMath math="\text{Rp }4,000/\text{km}" />
   - Above <InlineMath math="10 \text{ km}" />: <InlineMath math="\text{Rp }3,000/\text{km}" />
...
5. A worker is paid with the following system:
   ...
   - First <InlineMath math="8 \text{ hours}" />: <InlineMath math="\text{Rp }50,000/\text{hour}" />
   - Overtime (<InlineMath math="9" />th hour onwards): <InlineMath math="\text{Rp }75,000/\text{hour}" />
