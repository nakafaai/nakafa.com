...
2. An online taxi company applies the following rates:
   ...
   - Base fare: Rp 10,000 (for the first <InlineMath math="2 \text{ km}" />)
- Km <InlineMath math="3\text{-}10" />: Rp 4,000/km
   - Above <InlineMath math="10 \text{ km}" />: Rp 3,000/km
...
5. A worker is paid with the following system:
   ...
   - First <InlineMath math="8 \text{ hours}" />: Rp 50,000/hour
   - Overtime (<InlineMath math="9" />th hour onwards): Rp 75,000/hour
