...
1. Interval <InlineMath math="1" />: <InlineMath math="[-2, 0)" />

- Melalui <InlineMath math="(-2, 0)" /> dengan kemiringan <InlineMath math="2" />
   - Persamaan: <InlineMath math="y = 2(x + 2) = 2x + 4" />

2. Interval <InlineMath math="2" />: <InlineMath math="[0, 2)" />

   - Garis horizontal
   - Persamaan: <InlineMath math="y = 4" />

3. Interval <InlineMath math="3" />: <InlineMath math="[2, 4]" />
- Melalui <InlineMath math="(2, 4)" /> dengan kemiringan <InlineMath math="-1" />
...
2. Sebuah perusahaan taksi online menerapkan tarif:
   ...
   - Tarif dasar: <InlineMath math="\text{Rp }10.000" /> (untuk <InlineMath math="2 \text{ km}" /> pertama)
- Km <InlineMath math="3\text{-}10" />: <InlineMath math="\text{Rp }4.000/\text{km}" />
   - Di atas <InlineMath math="10 \text{ km}" />: <InlineMath math="\text{Rp }3.000/\text{km}" />
...
5. Seorang pekerja dibayar dengan sistem:
   ...
   - <InlineMath math="8 \text{ jam}" /> pertama: <InlineMath math="\text{Rp }50.000/\text{jam}" />
   - Lembur (jam ke-<InlineMath math="9" /> dst): <InlineMath math="\text{Rp }75.000/\text{jam}" />
