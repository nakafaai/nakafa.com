...
- <InlineMath math="0\text{-}50" /> kWh: Rp 1.000/kWh
- <InlineMath math="51\text{-}100" /> kWh: Rp 1.500/kWh
...
2. Sebuah perusahaan taksi online menerapkan tarif:
   ...
   - Tarif dasar: Rp 10.000 (untuk <InlineMath math="2 \text{ km}" /> pertama)
- Km <InlineMath math="3\text{-}10" />: Rp 4.000/km
   - Di atas <InlineMath math="10 \text{ km}" />: Rp 3.000/km
...
5. Seorang pekerja dibayar dengan sistem:
   ...
   - <InlineMath math="8 \text{ jam}" /> pertama: Rp 50.000/jam
   - Lembur (jam ke-<InlineMath math="9" /> dst): Rp 75.000/jam
