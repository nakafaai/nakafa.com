...
3. <InlineMath math="P(10) = 50000 \cdot (1.03)^{10} = 50000 \cdot 1.344 = 67.195 \text{ people}" />

4. <InlineMath math="M(15) = 100 \cdot \left(\frac{1}{2}\right)^{15/5} = 100 \cdot \left(\frac{1}{2}\right)^3 = 100 \cdot \frac{1}{8} = 12.5 \text{ grams}" />
