...
5. The distance between two cities is <InlineMath math="150 \text{ km}" />. If city A is located at coordinate <InlineMath math="-50 \text{ km}" />, where is city B located?
...
5. **Calculating position based on distance:**
   ...
   Given that the distance between cities A and B is <InlineMath math="150 \text{ km}" />, with city A at coordinate <InlineMath math="-50 \text{ km}" />. Let city B be at coordinate <InlineMath math="x_B" />:
   ...
   So city B can be located at coordinate <InlineMath math="100 \text{ km}" /> or <InlineMath math="-200 \text{ km}" />.
