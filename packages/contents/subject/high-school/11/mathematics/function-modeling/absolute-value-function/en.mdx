...
export const metadata = {
  ...
  description: "Learn absolute value functions with interactive graphs, transformations, and step-by-step solutions. Learn properties, equations, and real applications.",
...
- The symbol <InlineMath math="|x|" /> is read as absolute value of <InlineMath math="x" />.
...
- If <InlineMath math="a < 0" />: the graph is inverted (reflection across the <InlineMath math="x" />-axis)
...
| ------------------------------- | ------------ | --------------------- |
| <InlineMath math="a > 1" />     | Positive, <InlineMath math="> 1" /> | Graph becomes steeper |
| <InlineMath math="0 < a < 1" /> | Positive, <InlineMath math="< 1" /> | Graph becomes gentler |
...
5. The distance between two cities is <InlineMath math="150 \text{ km}" />. If city <InlineMath math="A" /> is located at coordinate <InlineMath math="-50 \text{ km}" />, where is city <InlineMath math="B" /> located?

### Answer Key

1. **Calculating function values for various inputs:**

   Substitute each value of <InlineMath math="x" /> into the function <InlineMath math="f(x) = |2x - 6|" />:
...
5. **Calculating position based on distance:**
   ...
   Given that the distance between cities <InlineMath math="A" /> and <InlineMath math="B" /> is <InlineMath math="150 \text{ km}" />, with city <InlineMath math="A" /> at coordinate <InlineMath math="-50 \text{ km}" />. Let city <InlineMath math="B" /> be at coordinate <InlineMath math="x_B" />:
   ...
   So city <InlineMath math="B" /> can be located at coordinate <InlineMath math="100 \text{ km}" /> or <InlineMath math="-200 \text{ km}" />.
