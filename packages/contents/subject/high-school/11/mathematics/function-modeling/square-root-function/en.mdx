...
3. **Always non-negative values**: The result of a square root function is always non-negative (<InlineMath math="\geq 0" />).
...
| ---- | ------------------------- | ---------------------------------------------------------------------------------------------- |
| 1    | Determine starting point  | <InlineMath math="x-1 = 0 \Rightarrow x = 1" />, <InlineMath math="f(1) = 3" />, Point: <InlineMath math="(1, 3)" /> |
...
| 5    | Plot points               | Plot <InlineMath math="(1,3)" />, <InlineMath math="(2,5)" />, <InlineMath math="(5,7)" />, etc. |
...
2. **Drawing the graph** <InlineMath math="g(x) = -\sqrt{x+4} + 2" />
   ...
   **Steps to draw:**
   ...
   | ---- | ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | Identify transformations | <InlineMath math="a = -1" /> (reflection across the <InlineMath math="x" />-axis), <InlineMath math="h = -4" /> (shift <InlineMath math="4 \text{ units}" /> left), <InlineMath math="k = 2" /> (shift <InlineMath math="2 \text{ units}" /> up) |
| 2    | Determine starting point | <InlineMath math="x+4 = 0 \Rightarrow x = -4" />, <InlineMath math="g(-4) = 0 + 2 = 2" />, Starting point: <InlineMath math="(-4, 2)" /> |
...
4. <InlineMath math="h(9) = 100\sqrt{9} = 100 \times 3 = 300 \text{ meters}" />
