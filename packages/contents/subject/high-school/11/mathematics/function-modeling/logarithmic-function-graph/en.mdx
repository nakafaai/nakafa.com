...
export const metadata = {
  ...
  description: "Learn to draw logarithmic function graphs one step at a time. Explore transformations, asymptotes, and key characteristics with interactive visualizations.",
