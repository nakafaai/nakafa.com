export const metadata = {
  ...
  description: "Pelajari komposisi fungsi (f∘g)(x) dengan contoh promo belanja nyata. Pelajari penerapan fungsi berurutan dan sifat tidak komutatif.",
...
Mari kita hitung hasil akhir untuk barang seharga <InlineMath math="\text{Rp}200.000{,}00" /> dengan kedua promo di atas menggunakan konsep fungsi.
