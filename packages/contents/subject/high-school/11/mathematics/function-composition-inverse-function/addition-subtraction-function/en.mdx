...
export const metadata = {
  ...
  description: "Learn how to add and subtract functions step-by-step with domain intersection rules. Learn function operations through clear examples and practice problems.",
