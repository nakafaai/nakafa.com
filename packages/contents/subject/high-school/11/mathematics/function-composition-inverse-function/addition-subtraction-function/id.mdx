...
export const metadata = {
  ...
  description: "Pelajari cara menjumlahkan dan mengurangkan fungsi dengan aturan irisan domain. Pelajari operasi fungsi melalui contoh jelas dan soal latihan lengkap.",
...
2.  <InlineMath math="g(x) = \sqrt{x+2}" />, dengan domain <InlineMath math="D_g = \{x | x \ge -2, x \in \mathbb{R}\}" /> (semua
    bilangan real yang lebih besar atau sama dengan <InlineMath math="-2" />, karena akar tidak boleh
    negatif).
