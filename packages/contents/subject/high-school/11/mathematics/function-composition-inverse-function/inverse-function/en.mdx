...
export const metadata = {
  ...
  description: "Learn inverse functions step-by-step: definition, bijective requirements, finding formulas, and graph reflections. Learn f⁻¹(x) with clear examples.",
