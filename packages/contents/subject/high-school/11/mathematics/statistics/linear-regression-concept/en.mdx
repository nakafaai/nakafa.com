...
With [Scatter Diagrams](/subject/high-school/11/mathematics/statistics/scatter-diagram/en), we can see the relationship between two variables, namely <InlineMath math="X" /> data and <InlineMath math="Y" /> data.
