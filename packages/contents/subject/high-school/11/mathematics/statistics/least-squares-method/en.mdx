...
Imagine we have a set of data from observations or experiments consisting of pairs of values <InlineMath math="(x, y)" />. If we plot these data points on a scatter diagram, we sometimes see a pattern or trend that resembles a straight line.
