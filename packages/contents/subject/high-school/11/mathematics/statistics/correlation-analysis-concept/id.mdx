...
2.  **Kekuatan Hubungan:**
    - Seberapa dekat nilai <InlineMath math="r" /> ke <InlineMath math="+1" /> atau <InlineMath math="-1" /> menunjukkan seberapa kuat hubungan linearnya. Semakin dekat ke <InlineMath math="+1" /> atau <InlineMath math="-1" />, semakin kuat hubungannya (titik-titik data semakin mendekati pola garis lurus).
    - Jika nilai <InlineMath math="r" /> dekat dengan <InlineMath math="0" />, artinya hubungan linearnya **lemah** atau bahkan **tidak ada** (titik-titik data menyebar acak).

**Rentang Nilai <InlineMath math="r" />:**
Nilai koefisien korelasi selalu berada di antara <InlineMath math="-1" /> dan <InlineMath math="+1" />.
...
Misalnya, jika <InlineMath math="r = 0.8" /> antara jam belajar dan nilai ujian, maka <InlineMath math="r^2 = (0.8)^2 = 0.64" />. Ini berarti sekitar <InlineMath math="64\%" /> variasi nilai ujian siswa _bisa dijelaskan_ oleh perbedaan jam belajar mereka. Sisanya (<InlineMath math="36\%" />) mungkin dipengaruhi faktor lain (kecerdasan, cara belajar, dll.).

Nilai <InlineMath math="r^2" /> selalu antara <InlineMath math="0" /> dan <InlineMath math="1" />.

<BlockMath math="0 \le r^2 \le 1" />

Semakin dekat <InlineMath math="r^2" /> ke <InlineMath math="1" />, semakin baik variabel <InlineMath math="X" /> menjelaskan variasi pada variabel <InlineMath math="Y" />.
