...
Diagram Pencar (Scatter Diagram) itu seperti peta yang menunjukkan hubungan antara dua jenis data. Misalnya, kita mau lihat hubungan antara lama waktu belajar (sumbu <InlineMath math="x" />) dengan nilai ujian (sumbu <InlineMath math="y" />).
