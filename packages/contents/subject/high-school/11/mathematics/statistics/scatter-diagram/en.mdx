...
A Scatter Diagram is like a map that shows the relationship between two types of data. For example, we might want to see the relationship between study time (<InlineMath math="x" />-axis) and exam scores (<InlineMath math="y" />-axis).
