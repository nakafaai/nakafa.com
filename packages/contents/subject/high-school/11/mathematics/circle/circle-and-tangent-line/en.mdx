...
export const metadata = {
  ...
  description: "Learn tangent lines to circles, including equations, properties, external points, and common tangents.",
...
<LineEquation
  ...
  description={
    <>
      From point <InlineMath math="P" /> outside the circle, two tangent lines can
      be drawn.
    </>
  }
  data={[
...
4. Two circles are centered at <InlineMath math="O_1(-4, 0)" /> with radius <InlineMath math="2" /> and <InlineMath math="O_2(4, 0)" /> with radius <InlineMath math="3" />. Find the length of the external common tangent line!
