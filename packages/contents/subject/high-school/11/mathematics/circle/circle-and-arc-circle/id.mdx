export const metadata = {
  ...
  description: "Pelajari dasar lingkaran, jenis busur, dan perhitungan juring. Pelajari persamaan, unsur-unsur, serta menyelesaikan soal panjang busur lengkap.",
...
- Jika sudut pusat adalah <InlineMath math="\alpha" />, maka busur = <InlineMath math="\alpha" />
...
1. <InlineMath math="\text{Sudut pusat} = 2 \times \text{sudut keliling} = 2 \times 30^\circ = 60^\circ" />

2. Diketahui: <InlineMath math="r = 21 \text{ cm}" />, <InlineMath math="\alpha = 120^\circ" />

- Panjang busur <InlineMath math="AB = \frac{120^\circ}{360^\circ} \times 2\pi \times 21 = \frac{1}{3} \times 42\pi = 14\pi \text{ cm} \approx 43{,}98 \text{ cm}" />
- Luas juring <InlineMath math="AOB = \frac{120^\circ}{360^\circ} \times \pi \times 21^2 = \frac{1}{3} \times 441\pi = 147\pi \text{ cm}^2 \approx 461{,}81 \text{ cm}^2" />

3. Sudut keliling yang menghadap busur yang sama memiliki besar yang sama, jadi sudut keliling yang lain adalah <InlineMath math="45^\circ" />
