...
- Panjang busur <InlineMath math="AB" /> = <InlineMath math="\frac{120^\circ}{360^\circ} \times 2\pi \times 21 = \frac{1}{3} \times 42\pi = 14\pi \text{ cm} \approx 43,98 \text{ cm}" />
- Luas juring <InlineMath math="AOB" /> = <InlineMath math="\frac{120^\circ}{360^\circ} \times \pi \times 21^2 = \frac{1}{3} \times 441\pi = 147\pi \text{ cm}^2 \approx 461,81 \text{ cm}^2" />
