...
export const metadata = {
  ...
  description: "Pelajari hubungan lingkaran dan tali busur, termasuk teorema, sifat, dan cara menghitung panjang tali busur lewat contoh serta pembahasan.",
...
<LineEquation
  ...
  description={
    <>
      Sudut keliling yang menghadap tali busur <InlineMath math="AB" /> memiliki
      besar yang sama.
    </>
  }
  data={[
...
Pada diagram di atas, <InlineMath math="\angle ACB = \angle ADB" /> karena keduanya menghadap tali busur <InlineMath math="AB" /> yang sama.
