export const metadata = {
  ...
  description: "Learn Horner's method for efficient polynomial division. Learn this simplified alternative to long division with step-by-step examples and practice.",
