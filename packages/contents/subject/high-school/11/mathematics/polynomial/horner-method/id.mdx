export const metadata = {
  title: "Metode Horner",
  description: "Pelajari metode Horner untuk pembagian polinomial yang efisien. Pelajari alternatif sederhana dari pembagian bersusun dengan contoh dan latihan.",
...
1.  **Identifikasi Koefisien Polinomial yang Dibagi (<InlineMath math="P(x)" />):**
    ...
    Tuliskan semua koefisien dari polinomial yang akan dibagi secara berurutan, dimulai dari suku dengan pangkat tertinggi hingga konstanta. Pastikan tidak ada pangkat yang terlewat. Jika ada suku dengan pangkat tertentu yang tidak ada, koefisiennya ditulis sebagai <InlineMath math="0" />.
    
    **Contoh:**
    
    Untuk <InlineMath math="P(x) = 2x^3 + 5x^2 + 6" />, koefisien suku <InlineMath math="x" /> adalah <InlineMath math="0" />. Maka, koefisien yang kita tulis berurutan adalah: <InlineMath math="2, 5, 0, 6" />.
...
4.  **Ulangi:** Ulangi langkah <InlineMath math="2" /> (kali dengan <InlineMath math="c" />) dan langkah <InlineMath math="3" /> (jumlahkan dengan koefisien di atasnya) untuk semua koefisien yang tersisa.
...
3.  **Penjelasan Skema:**
    ...
    - Angka <InlineMath math="2" /> (koefisien <InlineMath math="x^3" />) diturunkan.
    - <InlineMath math="2 \times (-3) = -6" />. Letakkan <InlineMath math="-6" /> di bawah <InlineMath math="5" />.
    - <InlineMath math="5 + (-6) = -1" />. Tulis <InlineMath math="-1" /> di baris hasil.
    - <InlineMath math="-1 \times (-3) = 3" />. Letakkan <InlineMath math="3" /> di bawah <InlineMath math="0" />.
    - <InlineMath math="0 + 3 = 3" />. Tulis <InlineMath math="3" /> di baris hasil.
    - <InlineMath math="3 \times (-3) = -9" />. Letakkan <InlineMath math="-9" /> di bawah <InlineMath math="6" />.
    - <InlineMath math="6 + (-9) = -3" />. Tulis <InlineMath math="-3" /> (sisa) di baris hasil paling kanan.

4.  **Hasil:**

    - Angka terakhir di baris hasil adalah <InlineMath math="\boxed{-3}" />. Ini adalah **Sisa Pembagian (<InlineMath math="S" />)**.
    - Angka-angka lainnya adalah <InlineMath math="2, -1, 3" />. Ini adalah koefisien **Hasil Bagi (<InlineMath math="H(x)" />)**. Karena <InlineMath math="P(x)" /> berderajat <InlineMath math="3" />, maka <InlineMath math="H(x)" /> berderajat <InlineMath math="2" />.
