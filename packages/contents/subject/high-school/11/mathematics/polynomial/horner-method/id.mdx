export const metadata = {
  title: "Metode Horner",
  description: "Pelajari metode Horner untuk pembagian polinomial yang efisien. Pahami alternatif sederhana dari pembagian bersusun dengan contoh dan latihan.",
