...
What about a constant (a number without variables), like 5? A non-zero constant is considered to have a **degree of <InlineMath math="0" />**, because we can write it as <InlineMath math="5x^0" /> (since <InlineMath math="x^0 = 1" />).

Here is a summary of monomial degree examples in a table:

| Monomial                                | Degree | Explanation                                                       |
| :-------------------------------------- | :----- | :---------------------------------------------------------------- |
| <InlineMath math="4x^5" />              | <InlineMath math="5" /> | The exponent of <InlineMath math="x" /> is 5.                     |
| <InlineMath math="\frac{3}{4}x^2y^7" /> | <InlineMath math="9" /> | Sum of exponents <InlineMath math="2+7=9" />.                     |
| <InlineMath math="0.12x" />             | <InlineMath math="1" /> | The exponent of <InlineMath math="x" /> is 1.                     |
