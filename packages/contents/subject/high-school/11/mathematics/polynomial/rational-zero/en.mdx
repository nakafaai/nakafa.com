export const metadata = {
  ...
  description: "Learn the Rational Zero Theorem to find polynomial roots efficiently. Learn step-by-step methods with examples to factor high-degree polynomials easily.",
