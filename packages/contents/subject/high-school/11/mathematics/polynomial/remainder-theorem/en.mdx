...
The result is the same! Using the Remainder Theorem, we found the remainder is <InlineMath math="6" />, just like with Horner's method, but without performing the full division process.
