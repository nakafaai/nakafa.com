...
export const metadata = {
  ...
  description: "Learn polynomial graphing with point plotting, end behavior analysis, and visual patterns. Learn to sketch linear, quadratic, and cubic graphs step-by-step.",
