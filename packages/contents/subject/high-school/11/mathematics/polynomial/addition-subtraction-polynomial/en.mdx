...
export const metadata = {
  ...
  description: "Learn polynomial addition and subtraction with step-by-step examples. Learn like terms, horizontal & vertical methods, plus graphical visualization.",
