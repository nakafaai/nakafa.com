export const metadata = {
  ...
  description: "Learn polynomial long division with systematic clear approach. Learn quotient and remainder calculations through worked examples and practice.",
