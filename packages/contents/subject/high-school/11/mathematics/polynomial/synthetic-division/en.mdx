export const metadata = {
  ...
  description: "Learn polynomial long division with systematic step-by-step approach. Learn quotient and remainder calculations through detailed examples and practice.",
...
2.  **Complete Terms:**
    ...
    If any term with a specific power is missing (its coefficient is zero), still write that term with a coefficient of <InlineMath math="0" /> as a _placeholder_. This is crucial for keeping the columns aligned during subtraction.
...
5.  **Repeat:** Repeat steps <InlineMath math="1\text{-}4" /> with this new polynomial until the degree of the temporary remainder is less than the degree of the divisor <InlineMath math="Q(x)" />.
...
3. **Step-by-Step Explanation:**
   ...
   **Stop:** The degree of the remainder (<InlineMath math="-2x+1" />, degree <InlineMath math="1" />) is less than the degree of the divisor (<InlineMath math="x^2+4x-1" />, degree <InlineMath math="2" />), so the division stops.
