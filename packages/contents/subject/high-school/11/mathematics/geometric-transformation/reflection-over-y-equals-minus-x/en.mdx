...
export const metadata = {
  ...
  description: "Explore negative diagonal reflections with comprehensive tutorials and coordinate-swapping rules through detailed examples.",
...
Thus, the image of point <InlineMath math="P(x, y)" /> is <InlineMath math="P'(-y, -x)" />. Notice that the <InlineMath math="x" /> and <InlineMath math="y" /> coordinates swap places and change signs (become their negatives).

## Reflecting a Point

Suppose we have point <InlineMath math="D(2, 1)" />. If point <InlineMath math="D" /> is reflected over the line <InlineMath math="y = -x" />, its image, <InlineMath math="D'" />, is:
...
Thus, the image of point <InlineMath math="D" /> is <InlineMath math="D'(-1, -2)" />.
