...
export const metadata = {
  ...
  description: "Discover coordinate exchange in main diagonal reflections with clear tutorials for points, triangles, and equations.",
...
Thus, the image of point <InlineMath math="P(x, y)" /> is <InlineMath math="P'(y, x)" />. Notice that the <InlineMath math="x" /> and <InlineMath math="y" /> coordinates swap positions.
...
Thus, the image of point <InlineMath math="A" /> is <InlineMath math="A'(4, 1)" />.
