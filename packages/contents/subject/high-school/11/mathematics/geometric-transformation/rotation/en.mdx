...
export const metadata = {
  title: "Rotation",
  description: "Learn geometric rotation transformations with step-by-step formulas, examples, and visual guides. Learn to rotate points and lines around the origin.",
