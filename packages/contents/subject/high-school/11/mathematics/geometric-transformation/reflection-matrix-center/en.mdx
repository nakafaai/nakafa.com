...
export const metadata = {
  ...
  description: "Learn reflection matrices over the origin. Learn point transformations with worked calculations and visual examples.",
...
The image of point <InlineMath math="A" /> is <InlineMath math="A'(1,-1)" />.
...
The image of point <InlineMath math="B" /> is <InlineMath math="B'(-3,2)" />.
