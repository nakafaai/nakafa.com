...
export const metadata = {
  ...
  description: "Learn how to reflect points over an arbitrary point using translation, matrix operations, and combined transformations.",
...
The form presented as Property <InlineMath math="4.11" /> in the book (<InlineMath math="\begin{pmatrix} -1 & 0 \\ 0 & -1 \end{pmatrix} \begin{pmatrix} x \\ y \end{pmatrix} + 2 \begin{pmatrix} a \\ b \end{pmatrix}" />) is a simplification of <InlineMath math="\begin{pmatrix} -x+2a \\ -y+2b \end{pmatrix}" />.
