...
From the element in row <InlineMath math="1" />, column <InlineMath math="1" />: <InlineMath math="2x-3 = 5" />
...
From the element in row <InlineMath math="1" />, column <InlineMath math="2" />: <InlineMath math="7-z = 10" />
...
From the element in row <InlineMath math="2" />, column <InlineMath math="1" />: <InlineMath math="y-5 = -3" />
...
From the element in row <InlineMath math="2" />, column <InlineMath math="2" />: <InlineMath math="5+2x = 1" />.
