export const metadata = {
  ...
  description: "Learn matrix subtraction with step-by-step examples, properties, and practice problems. Learn subtracting corresponding elements and matrix operations.",
