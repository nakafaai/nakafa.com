export const metadata = {
  ...
  description: "Pelajari pengurangan matriks dengan contoh langkah demi langkah, sifat-sifat, dan soal latihan. Pelajari operasi pengurangan elemen matriks seletak.",
...
Dari elemen baris <InlineMath math="1" />,kolom <InlineMath math="1" />: <InlineMath math="2x-3 = 5" />
...
Dari elemen baris <InlineMath math="1" />, kolom <InlineMath math="2" />: <InlineMath math="7-z = 10" />
...
Dari elemen baris <InlineMath math="2" />, kolom <InlineMath math="1" />: <InlineMath math="y-5 = -3" />
...
Dari elemen baris <InlineMath math="2" />, kolom <InlineMath math="2" />: <InlineMath math="5+2x = 1" />.
