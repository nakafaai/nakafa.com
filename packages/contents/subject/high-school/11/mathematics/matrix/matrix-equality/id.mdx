export const metadata = {
  ...
  description: "Pelajari syarat kesamaan matriks: ordo sama dan elemen seletak sama melalui contoh soal, penentuan variabel, dan latihan praktis.",
...
Meskipun matriks <InlineMath math="S" /> dan <InlineMath math="T" /> berordo sama(<InlineMath math="2 \times 2" />), keduanya tidak sama (<InlineMath math="S \neq T" />) karena elemen pada baris ke-<InlineMath math="2" /> kolom ke-<InlineMath math="1" /> tidak sama (<InlineMath math="s_{21} = -2" /> sedangkan <InlineMath math="t_{21} = 2" />).
...
2.  **Salah**. Dua matriks yang berbeda bisa saja memiliki ordo yang sama, tetapi elemen seletaknya berbeda (lihat Contoh <InlineMath math="3" />).
...
5.  Matriks identitas <InlineMath math="I" /> berordo <InlineMath math="2 \times 2" /> adalah <InlineMath math="I = \begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}" />.
    ...
    1.  <InlineMath math="-x-3y = 1" /> (Persamaan <InlineMath math="1" />)
    2.  <InlineMath math="(x-2y)^2 = 0" /> (Persamaan <InlineMath math="2" />)

    Selesaikan Persamaan <InlineMath math="2" /> terlebih dahulu:
    ...
    Substitusikan Persamaan <InlineMath math="2" />' ke Persamaan <InlineMath math="1" />:
    ...
    Substitusikan nilai <InlineMath math="y = -\frac{1}{5}" /> ke Persamaan <InlineMath math="2'" />:
...
6.  Diketahui kesamaan matriks:
    ...
    Selesaikan sistem persamaan untuk <InlineMath math="a" /> dan <InlineMath math="b" /> (persamaan <InlineMath math="1" /> dan <InlineMath math="2" />):
    ...
    Untuk mengeliminasi <InlineMath math="b" />, kalikan persamaan (<InlineMath math="2" />) dengan <InlineMath math="2" />:
    ...
    Kurangkan persamaan (<InlineMath math="1" />) dari persamaan (<InlineMath math="2" />'):
    ...
    Substitusikan nilai <InlineMath math="a=-3" /> ke persamaan (<InlineMath math="1" />):
    ...
    Selesaikan sistem persamaan untuk <InlineMath math="c" /> dan <InlineMath math="d" /> (persamaan <InlineMath math="3" /> dan <InlineMath math="4" />):
    ...
    Kurangkan persamaan (<InlineMath math="3" />) dari persamaan (<InlineMath math="4" />) untuk mengeliminasi <InlineMath math="d" />:
    ...
    Substitusikan nilai <InlineMath math="c=-6" /> ke persamaan (<InlineMath math="3" />):
