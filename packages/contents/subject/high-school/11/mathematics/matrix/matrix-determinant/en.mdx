export const metadata = {
  ...
  description: "Calculate order-two matrix determinants and solve linear equations using Cramer's Rule. Learn determinant formulas with step-by-step examples and practice.",
