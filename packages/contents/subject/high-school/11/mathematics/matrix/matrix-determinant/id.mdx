export const metadata = {
  ...
  description: "Hitung determinan matriks ordo dua dan selesaikan SPLDV dengan Aturan Cramer. Pelajari rumus determinan dengan contoh langkah demi langkah dan latihan.",
...
Jadi, nilai determinan dari matriks <InlineMath math="B" /> adalah <InlineMath math="26" />.
...
**Langkah** <InlineMath math="1" />: Hitung determinan <InlineMath math="D" />.
...
**Langkah** <InlineMath math="2" />: Hitung determinan <InlineMath math="D_x" />.

<BlockMath math="D_x = \begin{vmatrix} 7 & -1 \\ 14 & -4 \end{vmatrix} = (7 \times -4) - (-1 \times 14) = -28 - (-14) = -28 + 14 = -14" />

**Langkah** <InlineMath math="3" />: Hitung determinan <InlineMath math="D_y" />.

<BlockMath math="D_y = \begin{vmatrix} 2 & 7 \\ 1 & 14 \end{vmatrix} = (2 \times 14) - (7 \times 1) = 28 - 7 = 21" />

**Langkah** <InlineMath math="4" />: Hitung nilai <InlineMath math="x" /> dan <InlineMath math="y" />.
...
1.  Untuk matriks <InlineMath math="M = \begin{bmatrix} 9 & x \\ 8 & -7 \end{bmatrix}" />, determinannya adalah:
    ...
    Jadi, nilai <InlineMath math="x" /> adalah <InlineMath math="-9" />.
