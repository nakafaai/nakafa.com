export const metadata = {
    ...
    description: "Learn matrix transpose by swapping rows and columns. Learn step-by-step methods, explore essential properties, and practice with detailed examples.",
