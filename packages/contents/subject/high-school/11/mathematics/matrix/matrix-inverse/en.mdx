export const metadata = {
  ...
  description: "Learn inverse formulas for order-two and order-three matrices. Learn determinant calculations, adjoint methods, and solve linear equations step-by-step.",
...
The identity matrix <InlineMath math="I" /> is a square matrix where all main diagonal elements are <InlineMath math="1" /> and all other elements are <InlineMath math="0" />. For example, for a <InlineMath math="2 \times 2" /> order: <InlineMath math="I = \begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}" />.
...
2.  **Adjoint of Matrix <InlineMath math="A" /> (<InlineMath math="\text{Adj}(A)" />)**:
...
Step <InlineMath math="1" />: Identify the elements of matrix <InlineMath math="P" />.

<InlineMath math="a=3, b=-7, c=-1, d=2" />

Step <InlineMath math="2" />: Calculate the determinant of matrix <InlineMath math="P" />.

<BlockMath math="\det(P) = (3)(2) - (-7)(-1) = 6 - 7 = -1" />

Since <InlineMath math="\det(P) \neq 0" />, matrix <InlineMath math="P" /> has an inverse.

Step <InlineMath math="3" />: Determine the adjoint of matrix <InlineMath math="P" />.

<BlockMath math="\text{Adj}(P) = \begin{bmatrix} 2 & -(-7) \\ -(-1) & 3 \end{bmatrix} = \begin{bmatrix} 2 & 7 \\ 1 & 3 \end{bmatrix}" />

Step <InlineMath math="4" />: Calculate the inverse of matrix <InlineMath math="P" />.
...
However, the calculation of the determinant (<InlineMath math="\det(A)" />) and adjoint (<InlineMath math="\text{Adj}(A)" />) for a <InlineMath math="3 \times 3" /> matrix is more complex.
...
- **The adjoint of a <InlineMath math="3 \times 3" /> matrix** is obtained from the transpose of its cofactor matrix.

A fuller discussion on how to calculate the determinant and adjoint of a <InlineMath math="3 \times 3" /> matrix will usually be studied separately because it involves more steps.
