...
The identity matrix <InlineMath math="I" /> is a square matrix where all main diagonal elements are 1 and all other elements are 0. For example, for a <InlineMath math="2 \times 2" /> order: <InlineMath math="I = \begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}" />.
