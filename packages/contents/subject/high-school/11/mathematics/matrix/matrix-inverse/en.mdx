export const metadata = {
  ...
  description: "Learn inverse formulas for order-two and order-three matrices. Master determinant calculations, adjoint methods, and solve linear equations step-by-step.",
...
An in-depth discussion on how to calculate the determinant and adjoint of a <InlineMath math="3 \times 3" /> matrix will usually be studied separately as it involves more steps.
