export const metadata = {
  ...
  description: "Pelajari rumus invers matriks ordo dua dan ordo tiga. Pelajari perhitungan determinan, metode adjoin, dan penyelesaian sistem persamaan linear bertahap.",
