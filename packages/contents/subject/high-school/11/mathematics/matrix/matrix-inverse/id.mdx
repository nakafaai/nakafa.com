export const metadata = {
  ...
  description: "Pelajari rumus invers matriks ordo dua dan ordo tiga. Kuasai perhitungan determinan, metode adjoin, dan penyelesaian sistem persamaan linear langkah demi langkah.",
...
Matriks identitas <InlineMath math="I" /> adalah matriks persegi yang semua elemen diagonal utamanya adalah 1 dan elemen lainnya adalah 0. Contohnya, untuk ordo <InlineMath math="2 \times 2" />: <InlineMath math="I = \begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}" />.
...
Perhitungan determinan dan adjoin matriks <InlineMath math="3 \times 3" /> memerlukan langkah yang lebih panjang, sehingga halaman ini cukup memakai keduanya sebagai alat untuk membaca bentuk invers matriks.
