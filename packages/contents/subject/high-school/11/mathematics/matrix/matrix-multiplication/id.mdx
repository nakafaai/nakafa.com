export const metadata = {
  ...
  description: "Pelajari aturan perkalian matriks, syarat, dan perhitungan. Pelajari metode langkah demi langkah, sifat-sifat, dan aplikasi nyata dengan contoh.",
...
Namun, perhatikan ordo matriks. Matriks <InlineMath math="P" /> berordo <InlineMath math="3 \times 3" /> dan matriks <InlineMath math="Q" /> berordo <InlineMath math="3 \times 1" />. Jumlah kolom <InlineMath math="P" /> (<InlineMath math="3" />) sama dengan jumlah baris <InlineMath math="Q" /> (<InlineMath math="3" />), sehingga <InlineMath math="PQ" /> dapat dihitung dan akan menghasilkan matriks <InlineMath math="R" /> berordo <InlineMath math="3 \times 1" />.
...
Dari matriks <InlineMath math="R" />, kita bisa melihat bahwa total pendapatan dari penjualan keripik tempe adalah <InlineMath math="\text{Rp}1.080.000" />, keripik pisang <InlineMath math="\text{Rp}1.100.000" />, dan keripik kentang <InlineMath math="\text{Rp}1.125.000" />.
