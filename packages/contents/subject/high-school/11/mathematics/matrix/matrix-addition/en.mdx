export const metadata = {
  ...
  description: "Learn matrix addition with same-order matrices. Learn properties like commutativity & associativity, solve practical problems with detailed examples.",
