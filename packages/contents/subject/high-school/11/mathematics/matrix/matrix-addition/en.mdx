export const metadata = {
  ...
  description: "Learn matrix addition with same-order matrices. Understand properties like commutativity and associativity, then solve practical problems with worked examples.",
...
Both matrices are of order <InlineMath math="3 \times 2" /> (<InlineMath math="3" /> rows and <InlineMath math="2" /> columns), so they can be added.
...
3.  **Existence of an Identity Element (Zero Matrix)**: There exists a zero matrix <InlineMath math="O" /> that acts as the identity element in addition.
    ...
    This zero matrix plays a role similar to the number <InlineMath math="0" /> in the addition of numbers.
...
For the element in row <InlineMath math="1" />, column <InlineMath math="1" />: <InlineMath math="2x+4 = 10" />
...
For the element in row <InlineMath math="1" />, column <InlineMath math="2" />: <InlineMath math="3 = 3" /> (already consistent).

For the element in row <InlineMath math="2" />, column <InlineMath math="1" />: <InlineMath math="-1+z = 6" />
...
For the element in row <InlineMath math="2" />, column <InlineMath math="2" />: <InlineMath math="3y+7 = 1" />
