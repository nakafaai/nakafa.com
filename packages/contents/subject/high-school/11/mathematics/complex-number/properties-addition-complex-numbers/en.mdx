export const metadata = {
  ...
  description: "Explore algebraic properties of complex addition: commutative, associative, identity, inverse. Learn scalar multiplication and prove expressions.",
