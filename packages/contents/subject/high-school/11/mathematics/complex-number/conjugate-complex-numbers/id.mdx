...
export const metadata = {
  ...
  description: "Pelajari konjugat bilangan kompleks, pencerminan geometrisnya, sifatnya, dan alasan z×z̄ menghasilkan bilangan real.",
...
2.  **Jika** <InlineMath math="z = 2" />
    ...
    Maka konjugatnya <InlineMath math="\bar{z} = 2 - 0i = 2" />. (Bagian imajiner <InlineMath math="0" />, tandanya tidak berubah)
