...
<div className="flex flex-col gap-4">
  <BlockMath math="z_1 \times (z_2 + z_3) = 2 \times ((1+i) + (3-2i)) = 2 \times (1+3 + i-2i) = 2 \times (4-i) = 8-2i" />
  <BlockMath math="(z_1 \times z_2) + (z_1 \times z_3) = (2(1+i)) + (2(3-2i)) = (2+2i) + (6-4i) = (2+6) + (2i-4i) = 8-2i" />
</div>
