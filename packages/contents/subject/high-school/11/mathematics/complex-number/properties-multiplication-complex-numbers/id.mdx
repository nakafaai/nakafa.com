export const metadata = {
  ...
  description: "Pelajari sifat komutatif, asosiatif, distributif dan invers perkalian bilangan kompleks dengan contoh bertahap dan pembuktian aljabar.",
...
Dengan menyelesaikan sistem persamaan ini (misalnya dengan mengalikan persamaan <InlineMath math="1" /> dengan <InlineMath math="x" />, persamaan <InlineMath math="2" /> dengan <InlineMath math="y" />, lalu menjumlahkannya, dan metode substitusi), kita akan dapatkan:
