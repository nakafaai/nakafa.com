export const metadata = {
  ...
  description: "Learn commutative, associative, distributive properties and multiplicative inverse of complex numbers with step-by-step examples and algebraic proofs.",
...
By solving this system of equations (for example, by multiplying equation <InlineMath math="1" /> by <InlineMath math="x" />, equation <InlineMath math="2" /> by <InlineMath math="y" />, then adding them, and using the substitution method), we will get:
