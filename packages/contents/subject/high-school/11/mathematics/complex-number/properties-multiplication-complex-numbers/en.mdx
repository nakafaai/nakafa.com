export const metadata = {
  ...
  description: "Learn commutative, associative, distributive properties and multiplicative inverse of complex numbers with worked examples and algebraic proofs.",
