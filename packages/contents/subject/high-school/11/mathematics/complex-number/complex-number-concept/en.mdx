export const metadata = {
  ...
  description: "Learn what complex numbers are, why they exist, how the imaginary unit i works, and how to solve equations with negative roots.",
...
The core of complex numbers is the **imaginary unit**, denoted by <InlineMath math="i" />. This imaginary unit is defined as the square root of <InlineMath math="-1" />.
