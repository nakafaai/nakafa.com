    ...
    items: [
      {
        ...
        callouts: [
          { id: "genome-entry", label: "genom virus" },
      ...
      {
        tab: "Lisogenik",
        caption: <>DNA inang membawa segmen genom virus. Dua sel anak memperlihatkan salinan itu ikut terbawa saat sel membelah.</>,
        callouts: [
          { id: "host-dna", label: "DNA inang" },
          { id: "viral-genome", label: "genom virus" },
          { id: "daughter-cells", label: "sel anak" },
        ],
...
<Mermaid
  title="Sintesis Berbeda dari Perakitan"
