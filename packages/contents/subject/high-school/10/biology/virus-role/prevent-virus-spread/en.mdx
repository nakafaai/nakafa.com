...
<VirusPreventionLab
  ...
  labels={{
    ...
    items: [
      {
        tab: "Distance",
        caption: <>Droplets carry infectious particles from the mouth and nose. Distance and airflow make exposure less likely to reach another person.</>,
      ...
      {
        tab: "Soap",
        caption: <>Soap micelles surround fats and help lift particles from skin or surfaces.</>,
