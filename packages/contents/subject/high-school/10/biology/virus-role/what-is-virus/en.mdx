...
The next model is different from the general-parts model above. It shows a more realistic **SARS-CoV-2** surface example. Orange spikes show the open form, while beige spikes show the closed form. Use it to read one enveloped-virus example, not as the shape of every virus.

<SarsCov2VirionLab
  title={<>SARS-CoV-2 surface as a real example</>}
  description={
    <>
  ...
  labels={{
    ...
    focusLabel: "What to read",
    takeawayLabel: "Biological meaning",
    viewLabel: "3D SARS-CoV-2 surface model",
    items: [
      {
        tab: "Surface",
