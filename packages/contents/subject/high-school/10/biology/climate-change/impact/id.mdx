...
<Mermaid
  title="Perpindahan Habitat Mengubah Hubungan Organisme"
  description="Baca dari tekanan iklim ke pergeseran habitat, lalu ke perubahan hubungan antarorganisme."
  chart={`flowchart LR
