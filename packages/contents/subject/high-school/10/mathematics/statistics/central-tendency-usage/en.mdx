...
- **Robustness Example:** For data <InlineMath math="7, 8, 9, 8, 10" /> (sorted: <InlineMath math="7, 8, 8, 9, 10" />), the median is <InlineMath math="8" />. If a score of <InlineMath math="1" /> is added (sorted: <InlineMath math="1, 7, 8, 8, 9, 10" />), the median is <InlineMath math="(8+8)/2=8" />. The median hardly changes despite the outlier.
...
- **Robustness & Qualitative Example:** For data <InlineMath math="7, 8, 9, 8, 10" />, the mode is <InlineMath math="8" />. If a score of <InlineMath math="1" /> is added, the mode remains <InlineMath math="8" />. If the data is favorite colors (red, blue, red, green), the mode is red.
