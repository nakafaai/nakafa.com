...
- **Sensitivity Example:** If your test scores are <InlineMath math="7, 8, 9, 8, 10" /> (Mean is <InlineMath math="8.4" />), and then one additional score of 1 (an outlier) is added, the new Mean becomes <InlineMath math="(7+8+9+8+10+1)/6 = 7.17" />. The Mean drops drastically due to the outlier.
