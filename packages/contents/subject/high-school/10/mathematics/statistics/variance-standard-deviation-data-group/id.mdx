...
Bagaimana sebaran data yang disajikan dalam bentuk tabel frekuensi berkelompok? Misalnya, data durasi baterai HP yang dikelompokkan dalam interval jam (<InlineMath math="6\text{-}10" /> jam, <InlineMath math="11\text{-}15" /> jam, dst.).

Karena kita tidak tahu nilai pasti setiap data dalam satu kelas interval (misalnya, di kelas <InlineMath math="11\text{-}15" /> jam, kita tidak tahu apakah durasinya pas <InlineMath math="11 \text{ jam}" />, <InlineMath math="12 \text{ jam}" />, atau lainnya), kita perlu asumsi.
