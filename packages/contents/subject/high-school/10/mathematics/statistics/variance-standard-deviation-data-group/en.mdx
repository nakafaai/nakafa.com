export const metadata = {
  ...
  description: "Learn to calculate variance and standard deviation for grouped frequency data with worked examples. Learn statistical formulas for class intervals.",
