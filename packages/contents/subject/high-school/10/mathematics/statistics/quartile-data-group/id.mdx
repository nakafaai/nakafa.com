...
3.  **Kita kumpulkan bahan-bahannya:**
    - Tepi bawah kelas <InlineMath math="Q_1" /> (<InlineMath math="T_b" />) = <InlineMath math="39,5" />
    - Jumlah data (<InlineMath math="n" />) = <InlineMath math="30" />
    - Frekuensi kumulatif sebelum kelas <InlineMath math="Q_1" /> (<InlineMath math="F_{kum}" />) = <InlineMath math="2" /> (lihat <InlineMath math="F_k" /> kelas <InlineMath math="37\text{-}39" />)
    - Frekuensi kelas <InlineMath math="Q_1" /> (<InlineMath math="f_1" />) = <InlineMath math="11" />
    - Panjang kelas (<InlineMath math="p" />) = <InlineMath math="3" />
4.  **Masukkan ke rumus:**
...
3.  **Kumpulkan bahan:**
    ...
    - <InlineMath math="T_b" /> = <InlineMath math="42,5" /> (tepi bawah kelas <InlineMath math="Q_3" />
      )
    - <InlineMath math="n" /> = <InlineMath math="30" /> (jumlah data)
    - <InlineMath math="F_{kum}" /> = <InlineMath math="13" /> (lihat <InlineMath math="F_k" /> kelas <InlineMath math="40\text{-}42" />)
    - <InlineMath math="f_3" /> = <InlineMath math="10" /> (frekuensi kelas <InlineMath math="Q_3" />)
    - <InlineMath math="p" /> = <InlineMath math="3" /> (panjang kelas)
