...
4.  **Find the New Mode:**
    ...
    The most frequent values are still 3 (<InlineMath math="2 \text{ times}" />) and 5 (<InlineMath math="2 \text{ times}" />).
...
What if one of the new data points was very extreme? For example, the <InlineMath math="12" />th student donated 100 items, not 22.
