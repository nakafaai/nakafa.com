...
3.  **Cari Median Baru:**
    ...
    Nilai urutan ke-<InlineMath math="6" /> adalah 6, nilai urutan ke-<InlineMath math="7" /> adalah 7.
...
4.  **Cari Modus Baru:**
    ...
    Nilai yang paling sering muncul masih 3 (<InlineMath math="2 \text{ kali}" />) dan 5 (<InlineMath math="2 \text{ kali}" />).
...
Bagaimana jika salah satu data baru sangat ekstrem? Misal, siswa ke-<InlineMath math="12" /> menyumbang 100 baju, bukan 22.
