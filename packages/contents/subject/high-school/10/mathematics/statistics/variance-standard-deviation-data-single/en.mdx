...
These results show that the age data in **Group 1 is very clustered and uniform** around the mean of <InlineMath math="16" />, whereas the age data in **Group 2 is widely spread out** far from the mean of <InlineMath math="16" />.
