export const metadata = {
  ...
  description: "Learn variance and standard deviation calculations for ungrouped data with clear formulas and real examples. Analyze data spread effectively.",
...
Let's use an example of two groups of age data to see how variance and standard deviation work. These groups are interesting because they have the **same mean (<InlineMath math="\bar{x}" />), which is <InlineMath math="16" />**, but their data spreads are different.
...
We calculate <InlineMath math="(x_i - \bar{x})^2" /> for each data point in Group <InlineMath math="1" /> (<InlineMath math="\bar{x}=16" />):
...
We calculate <InlineMath math="(x_i - \bar{x})^2" /> for each data point in Group <InlineMath math="2" /> (<InlineMath math="\bar{x}=16" />):
...
- Variance of Group <InlineMath math="1" /> (<InlineMath math="\sigma^2 = 2" />) is **much smaller** than the Variance of Group <InlineMath math="2" /> (<InlineMath math="\sigma^2 \approx 159.17" />).
- Standard Deviation of Group <InlineMath math="1" /> (<InlineMath math="\sigma \approx 1.41" />) is also **much smaller** than the Standard Deviation of Group <InlineMath math="2" /> (<InlineMath math="\sigma \approx 12.62" />).

These results show that the age data in **Group <InlineMath math="1" /> is very clustered and uniform** around the mean of <InlineMath math="16" />, whereas the age data in **Group <InlineMath math="2" /> is widely spread out** far from the mean of <InlineMath math="16" />.
...
This formula says: "Calculate the square of each data point and sum them up (<InlineMath math="\sum x_i^2" />), divide by <InlineMath math="n" />. Then subtract the square of the mean (<InlineMath math="(\bar{x})^2 = (\frac{\sum x_i}{n})^2" />)".

Let's recalculate the variance for Group <InlineMath math="1" /> using this formula:
