...
export const metadata = {
  title: "Histogram",
  description: "Learn histograms vs bar charts in statistics. Learn to visualize data distribution, interpret frequency patterns, and choose the right chart type.",
...
- Apple is the most used brand (<InlineMath math="12" /> students)
- Samsung is in second place (<InlineMath math="10" /> students)
- Xiaomi is in third place (<InlineMath math="8" /> students)
- Oppo and Lenovo are both used by <InlineMath math="5" /> students each
...
- <InlineMath math="10" /> students use their phones for <InlineMath math="0\text{-}2 \text{ hours}" /> per day
- <InlineMath math="12" /> students use their phones for <InlineMath math="2\text{-}4 \text{ hours}" /> per day
- The highest number is <InlineMath math="32" /> students who use their phones for <InlineMath math="4\text{-}6 \text{ hours}" /> per day
- <InlineMath math="28" /> students use their phones for <InlineMath math="6\text{-}8 \text{ hours}" /> per day
- <InlineMath math="8" /> students use their phones for <InlineMath math="8\text{-}10 \text{ hours}" /> per day

From this data, we can conclude that the majority of students use their phones between <InlineMath math="4\text{-}8 \text{ hours}" /> per day, with the peak in the <InlineMath math="4\text{-}6 \text{ hours}" /> range.
