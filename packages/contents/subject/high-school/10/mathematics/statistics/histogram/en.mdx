...
- <InlineMath math="10" /> students use their phones for <InlineMath math="0\text{-}2" /> hours per day
- <InlineMath math="12" /> students use their phones for <InlineMath math="2\text{-}4" /> hours per day
- The highest number is <InlineMath math="32" /> students who use their phones for <InlineMath math="4\text{-}6" /> hours per day
- <InlineMath math="28" /> students use their phones for <InlineMath math="6\text{-}8" /> hours per day
- <InlineMath math="8" /> students use their phones for <InlineMath math="8\text{-}10" /> hours per day

From this data, we can conclude that the majority of students use their phones between <InlineMath math="4\text{-}8" /> hours per day, with the peak in the <InlineMath math="4\text{-}6" /> hour range.
