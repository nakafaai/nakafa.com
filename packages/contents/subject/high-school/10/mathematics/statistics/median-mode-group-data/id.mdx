export const metadata = {
  ...
  description: "Pelajari cara mencari median dan kelas modus data kelompok dengan rumus lengkap. Pelajari tabel frekuensi dan perhitungan kumulatif untuk statistika.",
