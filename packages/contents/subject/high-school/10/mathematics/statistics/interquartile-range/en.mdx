...
This is where the **Interquartile Range (IQR)** comes in handy! The IQR is a measure of data spread that focuses on the **middle <InlineMath math="50\%" /> of the data** after it has been sorted.
...
2.  **Interquartile Range (IQR):**
    ...
    - IQR Group One is <InlineMath math="17 - 15 = 2" />
    - IQR Group Two is <InlineMath math="28.5 - 4.5 = 24" />
...
- **Group One** has a small Range (5) and a very small IQR (2). This means the ages of people in Group One are **very close together**, especially the middle <InlineMath math="50\%" />, whose ages only differ by <InlineMath math="2 \text{ years}" /> (<InlineMath math="Q_1=15, Q_3=17" />). The data is **clustered** around the mean.
- **Group Two** has a large Range (35) and a large IQR (24). This means the ages of people in Group Two are **much more spread out**. Even the middle <InlineMath math="50\%" /> spans <InlineMath math="24 \text{ years}" /> (<InlineMath math="Q_1=4.5, Q_3=28.5" />). The data is **not as clustered** as Group One.
