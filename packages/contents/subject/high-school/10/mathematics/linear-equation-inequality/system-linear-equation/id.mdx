...
export const metadata = {
  ...
  description: "Pelajari cara menyelesaikan sistem persamaan linear dengan metode substitusi dan eliminasi melalui contoh aplikasi dan panduan visual.",
...
**Langkah** <InlineMath math="4" />: Substitusi balik untuk mendapatkan nilai variabel lainnya.
