...
export const metadata = {
  ...
  description: "Learn solving linear equation systems with substitution and elimination methods. Learn real-world applications with step-by-step examples and visual guides.",
...
**Step** <InlineMath math="1" />: Express one variable from the simpler equation.

From equation (<InlineMath math="2" />): <InlineMath math="x + y = 10" />, we express <InlineMath math="x" /> in terms of <InlineMath math="y" />:

<BlockMath math="x = 10 - y \ldots (3)" />

**Step** <InlineMath math="2" />: Substitute into the other equation.

Insert equation (<InlineMath math="3" />) into equation (<InlineMath math="1" />):

<BlockMath math="2(10 - y) + 3y = 21" />

**Step** <InlineMath math="3" />: Solve the resulting equation.
...
**Step** <InlineMath math="4" />: Back-substitute to find the other variable.

Substitute the value <InlineMath math="y = 1" /> from equation (<InlineMath math="4" />) into equation (<InlineMath math="3" />):
...
**Step** <InlineMath math="1" />: Match the coefficients of one variable.

Multiply equation (<InlineMath math="2" />) by <InlineMath math="2" /> to match the coefficient of <InlineMath math="x" />:

<BlockMath math="\begin{cases} 2x + 3y = 21 & \ldots (1) \\ 2x + 2y = 20 & \ldots (3) \end{cases}" />

**Step** <InlineMath math="2" />: Eliminate the variable by subtracting the equations.
...
**Step** <InlineMath math="3" />: Use the value of <InlineMath math="y" /> to find <InlineMath math="x" />.

Substitute the value <InlineMath math="y = 1" /> from equation (<InlineMath math="4" />) into equation (<InlineMath math="2" />):
...
- Equation (<InlineMath math="1" />): <InlineMath math="2(9) + 3(1) = 18 + 3 = 21" /> ✓
- Equation (<InlineMath math="2" />): <InlineMath math="9 + 1 = 10" /> ✓
...
In basketball, there are three types of shots with different point values: free throws (<InlineMath math="1" /> point), two-point shots (<InlineMath math="2" /> points), and three-point shots (<InlineMath math="3" /> points).

Let's define:

- <InlineMath math="a" /> = number of <InlineMath math="1\text{-point}" /> shots
- <InlineMath math="b" /> = number of <InlineMath math="2\text{-point}" /> shots
- <InlineMath math="c" /> = number of <InlineMath math="3\text{-point}" /> shots

If Wijaya scored <InlineMath math="27" /> points, made <InlineMath math="16" /> shots total with <InlineMath math="6" /> of them being free throws, then:
...
Therefore, Wijaya made <InlineMath math="6" /> free throws, <InlineMath math="9" /> two-point shots, and <InlineMath math="1" /> three-point shot.
