...
export const metadata = {
  ...
  description: "Learn solving linear equation systems with substitution and elimination methods. Learn real-world applications with worked examples and visual guides.",
