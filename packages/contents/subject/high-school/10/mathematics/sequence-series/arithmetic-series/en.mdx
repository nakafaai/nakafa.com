...
Ever heard the story about Carl Friedrich Gauss, the math genius? When he was in elementary school, his teacher assigned the task of summing all numbers from <InlineMath math="1" /> to <InlineMath math="100" />: <InlineMath math="1 + 2 + 3 + \dots + 98 + 99 + 100" />. The teacher hoped this would keep the students busy for a while.
...
It turns out there are <InlineMath math="50" /> pairs of numbers, each summing to <InlineMath math="101" />. So, the total sum is <InlineMath math="50 \times 101 = 5050" />. Clever, right?
