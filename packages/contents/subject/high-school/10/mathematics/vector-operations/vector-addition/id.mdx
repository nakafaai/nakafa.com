...
<InlineMath math="3 \text{ kg}" /> gula + <InlineMath math="4 \text{ kg}" /> gula = <InlineMath math="7 \text{ kg}" /> gula

**Contoh penjumlahan vektor**:

perpindahan <InlineMath math="3 \text{ m}" /> ke timur + <InlineMath math="4 \text{ m}" /> ke timur adalah <InlineMath math="7 \text{ m}" /> ke timur, tetapi perpindahan <InlineMath math="3 \text{ m}" /> ke timur + <InlineMath math="4 \text{ m}" /> ke barat = <InlineMath math="1 \text{ m}" /> ke barat.
