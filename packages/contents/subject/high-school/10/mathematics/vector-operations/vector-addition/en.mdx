...
export const metadata = {
  ...
  description: "Learn vector addition using triangle, parallelogram & polygon methods. Learn resultant calculations, component addition, and real-world applications.",
