...
<InlineMath math="3 \text{ kg}" /> of sugar + <InlineMath math="4 \text{ kg}" /> of sugar = <InlineMath math="7 \text{ kg}" /> of sugar

**Example of vector addition**:

displacement of <InlineMath math="3 \text{ m}" /> east + <InlineMath math="4 \text{ m}" /> east is <InlineMath math="7 \text{ m}" /> east, but displacement of <InlineMath math="3 \text{ m}" /> east + <InlineMath math="4 \text{ m}" /> west = <InlineMath math="1 \text{ m}" /> west.
