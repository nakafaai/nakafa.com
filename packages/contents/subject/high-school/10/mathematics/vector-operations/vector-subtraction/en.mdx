...
export const metadata = {
  ...
  description: "Learn vector subtraction with step-by-step examples, geometric visualization, and real-world applications. Learn algebraic methods and properties.",
