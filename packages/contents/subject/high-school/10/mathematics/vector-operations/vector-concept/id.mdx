...
Dalam matematika, besaran yang punya **nilai (besar)** sekaligus **arah** seperti ini disebut **vektor**. Jadi, kecepatan dan arah angin pada peta cuaca adalah contoh bagus dari vektor. Panjang panah mewakili _besar_ kecepatan angin (misalnya <InlineMath math="30 \text{ km/jam}" />), dan arah panah menunjukkan _arah_ hembusannya.
