...
export const metadata = {
  ...
  description: "Learn Cartesian coordinates in 2D and 3D space. Learn position vectors, displacement vectors, notation methods, and real-world GPS applications.",
...
- In **three dimensions**, we add a <InlineMath math="z" /> axis that is perpendicular to the <InlineMath math="xy" /> plane. A point's position is expressed as <InlineMath math="(x, y, z)" />, used for determining the position of objects like aircraft in space.
