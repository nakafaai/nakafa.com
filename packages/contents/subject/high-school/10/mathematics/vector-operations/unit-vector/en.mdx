...
A unit vector is a vector that has a length or magnitude equal to <InlineMath math="1 \text{ unit}" />. Unit vectors are used to indicate the direction of a vector in space. If we have a vector, we can obtain a unit vector with the same direction by dividing the vector by its length.
...
- <InlineMath math="\hat{\imath}" /> is the unit vector in the direction of the <InlineMath math="x" />-axis
- <InlineMath math="\hat{\jmath}" /> is the unit vector in the direction of the <InlineMath math="y" />-axis
- <InlineMath math="\hat{k}" /> is the unit vector in the direction of the <InlineMath math="z" />-axis
