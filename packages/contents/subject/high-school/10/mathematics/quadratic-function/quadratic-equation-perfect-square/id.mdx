export const metadata = {
   ...
   description: "Pelajari metode melengkapi kuadrat sempurna untuk menyelesaikan persamaan kuadrat dengan mengubahnya menjadi trinomial kuadrat sempurna bertahap.",
