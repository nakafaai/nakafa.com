export const metadata = {
   ...
   description: "Pelajari metode melengkapi kuadrat sempurna untuk menyelesaikan persamaan kuadrat dengan mengubahnya menjadi trinomial kuadrat sempurna langkah demi langkah.",
...
Tidak semua persamaan kuadrat mudah difaktorkan. Contohnya, persamaan <InlineMath math="x^2 + 4x + 2 = 0" /> tidak dapat difaktorkan dengan mudah menggunakan bilangan rasional karena tidak ada dua bilangan yang jika dikalikan menghasilkan <InlineMath math="2" /> dan jika dijumlahkan menghasilkan <InlineMath math="4" />.
...
7. **Selesaikan untuk Mendapatkan Nilai Variabel**
