export const metadata = {
  ...
  description: "Learn factoring quadratic equations into (x-p)(x-q) form. Learn systematic steps, grouping methods, and special cases with detailed examples and practice problems.",
