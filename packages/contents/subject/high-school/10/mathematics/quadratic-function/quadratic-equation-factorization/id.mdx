export const metadata = {
  ...
  description: "Pelajari faktorisasi persamaan kuadrat ke bentuk (x-p)(x-q). Pelajari langkah sistematis, metode pengelompokan, dan kasus khusus dengan contoh detail dan latihan soal.",
