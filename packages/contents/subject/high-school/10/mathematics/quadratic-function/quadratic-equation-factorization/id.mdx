export const metadata = {
  ...
  description: "Pelajari faktorisasi persamaan kuadrat ke bentuk (x-p)(x-q). Pelajari langkah sistematis, metode pengelompokan, dan kasus khusus dengan contoh terarah dan latihan soal.",
...
1. Memfaktorkan persamaan:
   ...
   **Langkah** <InlineMath math="1" />: Persamaan sudah dalam bentuk standar dengan ruas kanan bernilai nol.

   **Langkah** <InlineMath math="2" />: Kita perlu mencari dua bilangan yang:

   - Jika dikalikan menghasilkan <InlineMath math="ac = 1 \times 6 = 6" />
   - Jika dijumlahkan menghasilkan <InlineMath math="b = 5" />

   Faktor-faktor dari <InlineMath math="6" /> adalah <InlineMath math="1" />, <InlineMath math="2" />, <InlineMath math="3" />, dan <InlineMath math="6" />.
   ...
   **Langkah** <InlineMath math="3" />: Kita dapat menulis persamaan sebagai:
   ...
   **Langkah** <InlineMath math="4" />: Dari bentuk faktor di atas, kita mendapatkan:
...
3. Faktorisasi Ketika Koefisien <InlineMath math="a \neq 1" />
   ...
   Ketika koefisien <InlineMath math="a" /> tidak sama dengan <InlineMath math="1" />, kita perlu sedikit modifikasi dalam langkah-langkah faktorisasi. Ada beberapa pendekatan:
   ...
   **Langkah** <InlineMath math="1" />: Hitung <InlineMath math="ac = 2 \times (-3) = -6" />

   **Langkah** <InlineMath math="2" />: Cari pasangan faktor dari <InlineMath math="-6" /> yang jika dijumlahkan menghasilkan <InlineMath math="5" />:
   ...
   **Langkah** <InlineMath math="3" />: Pisahkan suku <InlineMath math="5x" /> menjadi <InlineMath math="6x - x" />:

   <BlockMath math="2x^2 + 6x - x - 3 = 0" />

   **Langkah** <InlineMath math="4" />: Faktorkan dengan pengelompokan:
   ...
   **Langkah** <InlineMath math="5" />: Tentukan akar-akar persamaan:
...
1. <InlineMath math="x^2 + 6x + 5 = 0" />
   ...
   **Langkah** <InlineMath math="1" />: Identifikasi koefisien

   <BlockMath math="a = 1, b = 6, c = 5" />

   **Langkah** <InlineMath math="2" />: Cari dua bilangan yang jika dikalikan menghasilkan <InlineMath math="ac = 5" /> dan jika dijumlahkan menghasilkan <InlineMath math="b = 6" />

   <BlockMath math="\text{Faktor dari } 5: 1 \times 5 = 5 \text{ dan} 1 + 5 = 6" />

   **Langkah** <InlineMath math="3" />: Faktorisasi
   ...
   **Langkah** <InlineMath math="4" />: Tentukan akar-akar persamaan
...
2. <InlineMath math="2x^2 + 5x + 2 = 0" />
   ...
   **Langkah** <InlineMath math="2" />: Cari dua bilangan yang jika dikalikan menghasilkan <InlineMath math="ac = 2 \times 2 = 4" /> dan jika dijumlahkan menghasilkan <InlineMath math="b = 5" />
...
3. <InlineMath math="3x^2 - x - 2 = 0" />
   ...
   **Langkah** <InlineMath math="2" />: Cari dua bilangan yang jika dikalikan menghasilkan <InlineMath math="ac = 3 \times (-2) = -6" /> dan jika dijumlahkan menghasilkan <InlineMath math="b = -1" />
...
4. <InlineMath math="2x^2 - 8x + 6 = 0" />
   ...
   **Langkah** <InlineMath math="2" />: Cari dua bilangan yang jika dikalikan menghasilkan <InlineMath math="ac = 2 \times 6 = 12" /> dan jika dijumlahkan menghasilkan <InlineMath math="b = -8" />
...
5. <InlineMath math="x^2 - 9 = 0" />
   ...
   **Langkah** <InlineMath math="1" />: Identifikasi sebagai bentuk selisih kuadrat

   <BlockMath math="x^2 - 9 = x^2 - 3^2" />

   **Langkah** <InlineMath math="2" />: Gunakan rumus selisih kuadrat <InlineMath math="a^2 - b^2 = (a+b)(a-b)" />

   <BlockMath math="x^2 - 3^2 = (x + 3)(x - 3) = 0" />

   **Langkah** <InlineMath math="3" />: Tentukan akar-akar persamaan
