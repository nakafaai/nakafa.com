export const metadata = {
    ...
    description: "Cari luas maksimum dengan fungsi kuadrat melalui masalah nyata, solusi bertahap, dan interpretasi grafik. Pelajari cara membaca luas maksimum.",
