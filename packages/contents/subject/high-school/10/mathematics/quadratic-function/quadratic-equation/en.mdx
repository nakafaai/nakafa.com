...
Four reading corners of the same size are created in a room measuring 4 m × 6 m. If each corner is a square with side length <InlineMath math="x" /> meters, then the remaining area of the room for arranging seats is:
