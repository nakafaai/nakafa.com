...
export const metadata = {
  ...
  description: "Learn to construct quadratic functions using three points, vertex form, roots, and symmetry. Learn different methods with step-by-step examples and solutions.",
...
2. **Factored Form**: <InlineMath math="f(x) = a(x - p)(x - q)" /> where <InlineMath math="p" /> and <InlineMath math="q" /> are the roots of the equation
...
If we know the roots (<InlineMath math="x" />-intercepts) <InlineMath math="p" /> and <InlineMath math="q" /> of the quadratic function, and an additional point <InlineMath math="(r, s)" /> on the curve, we can use the factored form <InlineMath math="f(x) = a(x - p)(x - q)" />.
...
We can also construct a quadratic function by knowing the axis of symmetry (or the <InlineMath math="x" />-coordinate of the vertex) and the value of the discriminant.
...
There are many values of <InlineMath math="a" /> and <InlineMath math="c" /> that satisfy this equation. Let's take the simple case with <InlineMath math="a = 1" />.
...
1. Determine the <InlineMath math="x" />-coordinate of the vertex: <InlineMath math="h = -\frac{b}{2a}" />
...
2. If the roots are <InlineMath math="p" /> and <InlineMath math="q" />, then:
