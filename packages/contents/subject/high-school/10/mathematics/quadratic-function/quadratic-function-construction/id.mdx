...
export const metadata = {
  ...
  description: "Pelajari cara mengonstruksi fungsi kuadrat dengan tiga titik, bentuk vertex, akar-akar, dan simetri. Pelajari berbagai metode dengan contoh dan solusi lengkap.",
...
2. **Bentuk Faktor**: <InlineMath math="f(x) = a(x - p)(x - q)" /> dimana <InlineMath math="p" /> dan <InlineMath math="q" /> adalah akar-akar persamaan
3. **Bentuk Vertex**: <InlineMath math="f(x) = a(x - h)^2 + k" /> dimana <InlineMath math="(h, k)" /> adalah titik puncak
...
Jika kita mengetahui akar-akar (titik potong dengan sumbu <InlineMath math="x" />) <InlineMath math="p" /> dan <InlineMath math="q" /> dari fungsi kuadrat, dan satu titik tambahan <InlineMath math="(r, s)" /> pada kurva, kita dapat menggunakan bentuk faktor <InlineMath math="f(x) = a(x - p)(x - q)" />.
...
Kita juga dapat mengonstruksi fungsi kuadrat dengan mengetahui sumbu simetri (atau koordinat <InlineMath math="x" /> dari titik puncak) dan nilai diskriminan.
...
Ada banyak nilai <InlineMath math="a" /> dan <InlineMath math="c" /> yang memenuhi persamaan ini. Mari kita ambil kasus sederhana dengan <InlineMath math="a = 1" />.
...
1. Tentukan koordinat <InlineMath math="x" /> dari titik puncak: <InlineMath math="h = -\frac{b}{2a}" />
...
2. Jika akar-akarnya adalah <InlineMath math="p" /> dan <InlineMath math="q" />, maka:
...
Gunakan bentuk vertex dengan <InlineMath math="h = -1" /> dan <InlineMath math="k = 4" />:
