...
export const metadata = {
  ...
  description: "Pelajari cara mengonstruksi fungsi kuadrat dengan tiga titik, bentuk vertex, akar-akar, dan simetri. Pelajari berbagai metode dengan contoh dan pembahasan.",
