export const metadata = {
  ...
  description: "Pelajari kapan persamaan kuadrat memiliki akar imajiner, cara mengidentifikasi dengan diskriminan, dan menyelesaikan bilangan kompleks bertahap.",
...
**Langkah** <InlineMath math="1" />: Identifikasi nilai <InlineMath math="a" />, <InlineMath math="b" />, dan <InlineMath math="c" />.

- <InlineMath math="a = 1" />
- <InlineMath math="b = 4" />
- <InlineMath math="c = 5" />

**Langkah** <InlineMath math="2" />: Hitung diskriminan.
...
**Langkah** <InlineMath math="3" />: Gunakan rumus akar-akar persamaan kuadrat.
...
**Langkah** <InlineMath math="3" />: Cari akar-akar persamaan.
