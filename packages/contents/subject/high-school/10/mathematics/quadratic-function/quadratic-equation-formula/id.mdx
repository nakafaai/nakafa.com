export const metadata = {
  ...
  description: "Pelajari rumus kuadrat untuk menyelesaikan persamaan ax²+bx+c=0. Pelajari penurunan langkah demi langkah, pahami diskriminan, dan terapkan pada masalah nyata.",
...
**Langkah** <InlineMath math="1" />: Kita bagi semua suku dengan <InlineMath math="a" /> (koefisien <InlineMath math="x^2" />):
...
**Langkah** <InlineMath math="4" />: Ruas kiri sekarang membentuk kuadrat sempurna:
...
**Contoh** <InlineMath math="1" />: Selesaikan persamaan <InlineMath math="x^2 + 5x + 6 = 0" />
...
**Contoh** <InlineMath math="2" />: Selesaikan persamaan <InlineMath math="2x^2 - 7x + 3 = 0" />
...
1. Persamaan kuadrat <InlineMath math="x^2 + 4x + 3 = 0" /> memiliki akar-akar <InlineMath math="p" /> dan <InlineMath math="q" />.
   ...
   **Langkah** <InlineMath math="1" />: Temukan nilai <InlineMath math="p + q" /> dan <InlineMath math="p \cdot q" />
   ...
   **Langkah** <InlineMath math="2" />: Hitung jumlah dan hasil kali akar-akar baru
   ...
   **Langkah** <InlineMath math="3" />: Buat persamaan kuadrat baru
