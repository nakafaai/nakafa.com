export const metadata = {
  ...
  description: "Learn the quadratic formula to solve any ax²+bx+c=0 equation. Learn step-by-step derivation, understand the discriminant, and apply to real-world problems.",
...
**Step** <InlineMath math="1" />: Divide all terms by <InlineMath math="a" /> (the coefficient of <InlineMath math="x^2" />):

<BlockMath math="x^2 + \frac{b}{a}x + \frac{c}{a} = 0" />

**Step** <InlineMath math="2" />: Move the constant term to the right side:
...
**Step** <InlineMath math="4" />: The left side now forms a perfect square:
...
**Step** <InlineMath math="7" />: Solve for <InlineMath math="x" />:
...
**Example** <InlineMath math="1" />: Solve the equation <InlineMath math="x^2 + 5x + 6 = 0" />
...
**Example** <InlineMath math="2" />: Solve the equation <InlineMath math="2x^2 - 7x + 3 = 0" />
...
1. The quadratic equation <InlineMath math="x^2 + 4x + 3 = 0" /> has roots <InlineMath math="p" /> and <InlineMath math="q" />.
   ...
   **Step** <InlineMath math="1" />: Find the values of <InlineMath math="p + q" /> and <InlineMath math="p \cdot q" />
   ...
   **Step** <InlineMath math="2" />: Calculate the sum and product of the new roots
   ...
   **Step** <InlineMath math="3" />: Create the new quadratic equation
