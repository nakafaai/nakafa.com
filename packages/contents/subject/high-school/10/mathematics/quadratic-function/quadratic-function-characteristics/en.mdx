...
3. Y-intercept:
   ...
   So the y-intercept is at <InlineMath math="(0, -3)" />.
...
4. X-intercepts: <InlineMath math="f(x) = 0" /> or <InlineMath math="x^2 - 2x - 3 = 0" />
   ...
   So the x-intercepts are at <InlineMath math="(-1, 0)" /> and <InlineMath math="(3, 0)" />.
...
3. Y-intercept:
   ...
   So the y-intercept is at <InlineMath math="(0, 0)" />.
...
4. X-intercepts: <InlineMath math="f(x) = 0" /> or <InlineMath math="-x^2 = 0" />
   ...
   So the x-intercept is at <InlineMath math="(0, 0)" />.
