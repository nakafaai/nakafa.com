...
3. Titik potong dengan sumbu Y:
   ...
   Jadi titik potong dengan sumbu Y adalah <InlineMath math="(0, -3)" />.
...
4. Titik potong dengan sumbu X: <InlineMath math="f(x) = 0" /> atau <InlineMath math="x^2 - 2x - 3 = 0" />
   ...
   Jadi titik potong dengan sumbu X adalah <InlineMath math="(-1, 0)" /> dan <InlineMath math="(3, 0)" />.
...
3. Titik potong dengan sumbu Y:
   ...
   Jadi titik potong dengan sumbu Y adalah <InlineMath math="(0, 0)" />.
...
4. Titik potong dengan sumbu X: <InlineMath math="f(x) = 0" /> atau <InlineMath math="-x^2 = 0" />
   ...
   Jadi titik potong dengan sumbu X adalah <InlineMath math="(0, 0)" />.
