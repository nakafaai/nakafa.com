...
- **Phase 1**: <InlineMath math="3 = 3^1 \text{ people}" /> infected
- **Phase 2**: <InlineMath math="9 = 3^2 \text{ people}" /> infected
- **Phase 3**: <InlineMath math="27 = 3^3 \text{ people}" /> infected
- **Phase 4**: <InlineMath math="81 = 3^4 \text{ people}" /> infected
- **Phase 5**: <InlineMath math="243 = 3^5 \text{ people}" /> infected
