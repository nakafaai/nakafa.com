...
- **Fase 1**: <InlineMath math="3 = 3^1 \text{ orang}" /> tertular
- **Fase 2**: <InlineMath math="9 = 3^2 \text{ orang}" /> tertular
- **Fase 3**: <InlineMath math="27 = 3^3 \text{ orang}" /> tertular
- **Fase 4**: <InlineMath math="81 = 3^4 \text{ orang}" /> tertular
- **Fase 5**: <InlineMath math="243 = 3^5 \text{ orang}" /> tertular
