...
The value of <InlineMath math="1^x" /> is always 1 for any value of <InlineMath math="x" />. As a result, the function becomes a constant function <InlineMath math="f(x) = n" />, no longer an exponential function. Its graph will be a horizontal line intersecting the vertical axis at point <InlineMath math="(0, n)" />.
