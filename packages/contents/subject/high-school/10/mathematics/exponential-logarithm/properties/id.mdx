export const metadata = {
   ...
   description: "Pelajari 7 aturan dasar eksponen dengan contoh praktis. Pelajari operasi perkalian, pembagian, pangkat dan eksponen rasional untuk pemecahan masalah.",
   authors: [{ name: "Nabil Akbarazzima Fatih" }],
   date: "04/01/2025",
   subject: "Eksponen dan Logaritma",
};

## Tabel Nilai Eksponen untuk Basis Dua
...
- Pada sifat <InlineMath math="1" />, <InlineMath math="2" />, dan <InlineMath math="3" />, nilai <InlineMath math="a \neq 0" /> karena eksponen dengan basis <InlineMath math="0" /> hanya terdefinisi untuk pangkat positif.
- Pada sifat <InlineMath math="4" />, nilai <InlineMath math="a, b \neq 0" /> untuk memastikan eksponen terdefinisi.
- Pada sifat <InlineMath math="5" />, nilai <InlineMath math="b \neq 0" /> untuk menghindari pembagian dengan nol.
- Pada sifat <InlineMath math="6" /> dan <InlineMath math="7" />, nilai <InlineMath math="a > 0" /> karena eksponen rasional pada bilangan negatif dapat menghasilkan bilangan kompleks.
