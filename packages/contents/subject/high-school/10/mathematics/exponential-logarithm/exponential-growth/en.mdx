...
| Phase (<InlineMath math="30 \text{ minutes}" />) | 0   | 1   | 2   | 3   | 4   | 5   |
| ------------------ | --- | --- | --- | --- | --- | --- |
...
If we want to calculate the number of bacteria at the 5th hour, we need to know that the 5th hour occurs at phase 10 (because each phase is <InlineMath math="30 \text{ minutes}" />):

<BlockMath math="f(10) = 30 \cdot (2^{10}) = 30 \cdot 1024 = 30,720" />

So, at the 5th hour, there are <InlineMath math="30{,}720 \text{ bacteria}" />.
...
So, the number of bacteria after <InlineMath math="10 \text{ hours}" /> is 2,<InlineMath math="048{,}000 \text{ bacteria}" />.
...
1. E.coli bacteria cause diarrhea in humans. A researcher observed the growth of 50 of these bacteria on a piece of food and found that these bacteria divide into 2 every quarter of an hour.
   ...
   c. Predict how many bacteria will be present after the first 3 and <InlineMath math="4 \text{ hours}" />.

2. In 2015, positive HIV-AIDS cases totaled about <InlineMath math="36 \text{ million people}" />. This number increased by an average of <InlineMath math="2\%" /> each year from 2010 to 2015. If the increase in positive HIV cases in subsequent years is predicted to increase exponentially at <InlineMath math="2\%" /> each year, how many cases will occur in 2020?
...
1. E.coli bacteria with an initial count of <InlineMath math="50 \text{ bacteria}" /> that divide into two every <InlineMath math="15 \text{ minutes}" />.
   ...
   | Phase (<InlineMath math="15 \text{ minutes}" />) | 0   | 1   | 2   | 3   | 4   | 5     |
   | ------------------ | --- | --- | --- | --- | --- | ----- |
...
2. HIV-AIDS cases:
   ...
   The number of cases in 2015 was 36,<InlineMath math="000{,}000 \text{ people}" /> with a <InlineMath math="2\%" /> annual increase.

   Mathematical model:

   <BlockMath math="f(x) = 36,000,000 \cdot (1 + 0.02)^x" />

   To calculate cases in 2020 (<InlineMath math="5 \text{ years}" /> after 2015):
   ...
   Therefore, the predicted number of HIV-AIDS cases in 2020 is approximately 39,<InlineMath math="746{,}908 \text{ people}" />.
