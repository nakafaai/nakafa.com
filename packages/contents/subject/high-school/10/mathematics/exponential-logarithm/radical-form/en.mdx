export const metadata = {
  title: "Radical Form",
  description: "Convert fractional exponents to radical form and vice versa. Learn simplification techniques and understand key properties with real-world applications.",
...
If we want to know the amount of dosage that decays after <InlineMath math="30 \text{ minutes}" />, we substitute <InlineMath math="x = 30" /> into the function.
