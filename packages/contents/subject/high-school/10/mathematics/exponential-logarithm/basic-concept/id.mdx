...
Bilangan <InlineMath math="a^{\frac{1}{n}}" /> juga sering disebut sebagai akar pangkat-<InlineMath math="n" /> dari <InlineMath math="a" />. Rumus ini muncul sebagai kebalikan dari pemangkatan. Untuk menggunakannya, kamu perlu menemukan bilangan yang jika dipangkatkan sebanyak <InlineMath math="n" /> kali akan menghasilkan <InlineMath math="a" />. Contoh: <InlineMath math="16^{\frac{1}{4}} = 2" /> karena <InlineMath math="2^4 = 16" />.
