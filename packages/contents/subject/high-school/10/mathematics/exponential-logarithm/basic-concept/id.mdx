...
Pola penyebaran virus seperti COVID-19 juga sering mengikuti model eksponensial, terutama pada fase awal. Jika satu orang dapat menularkan virus ke rata-rata <InlineMath math="R \text{ orang}" /> baru (angka reproduksi), jumlah kasus setelah <InlineMath math="n" /> siklus penularan bisa diperkirakan dengan:
