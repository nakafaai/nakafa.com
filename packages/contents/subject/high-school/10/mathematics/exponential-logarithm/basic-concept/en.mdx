...
export const metadata = {
  ...
  description: "Learn exponent fundamentals from paper folding to viral spread. Learn base, power definitions, zero/negative/fractional exponents with real applications.",
