...
3. The population of city A in 2010 was <InlineMath math="300{,}000 \text{ people}" />. The average population growth rate is <InlineMath math="6\%" /> per year. If the population growth is assumed to be the same each year, in how many years will the population of city A become <InlineMath math="1 \text{ million}" />?
...
3. Initial population = <InlineMath math="300{,}000 \text{ people}" />

   Annual population growth = <InlineMath math="6\%" />
   ...
   For a population of 1,<InlineMath math="000{,}000 \text{ people}" />:
   ...
   Therefore, the population will reach 1,<InlineMath math="000{,}000 \text{ people}" /> in 20 or <InlineMath math="21 \text{ years}" />.

4. Initial savings = Rp2,000,000.00

   Final savings = Rp6,500,000.00

   Interest rate = <InlineMath math="12\%" />
   ...
   Therefore, Dini's savings will reach Rp6,500,000.00 in <InlineMath math="10 \text{ years}" />.
