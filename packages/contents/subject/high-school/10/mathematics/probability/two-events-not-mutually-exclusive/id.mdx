...
- Kejadian A: Dapat kartu Hati (<InlineMath math="\heartsuit" />). Ada <InlineMath math="13 \text{ kartu}" /> Hati dari <InlineMath math="52 \text{ kartu}" />. <InlineMath math="P(A) = 13/52" />.
- Kejadian B: Dapat kartu King. Ada <InlineMath math="4 \text{ kartu}" /> King dari <InlineMath math="52 \text{ kartu}" />. <InlineMath math="P(B) = 4/52" />.
- Kejadian A **dan** B: Dapat kartu King Hati (<InlineMath math="K\heartsuit" />). Cuma ada <InlineMath math="1 \text{ kartu}" /> King Hati. <InlineMath math="P(A \cap B) = 1/52" />.
