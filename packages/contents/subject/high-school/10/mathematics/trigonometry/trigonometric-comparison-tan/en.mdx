...
Consider the following right-angled triangle with an angle of <InlineMath math="70°" />, an opposite side of <InlineMath math="15 \text{ cm}" />, and an adjacent side of <InlineMath math="7 \text{ cm}" />.
