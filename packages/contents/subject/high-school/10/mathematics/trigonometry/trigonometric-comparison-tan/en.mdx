...
- <InlineMath math="\tan 30^\circ = 0.57 \text{ or} \frac{1}{\sqrt{3}}" />
- <InlineMath math="\tan 45^\circ = 1" />
- <InlineMath math="\tan 60^\circ = 1.73 \text{ or} \sqrt{3}" />
...
For instance, if we have a right-angled triangle with an angle of <InlineMath math="30^\circ" />, an opposite side of <InlineMath math="15 \text{ cm}" />, and an adjacent side of <InlineMath math="26 \text{ cm}" />.
...
<Triangle
  ...
  description={
    <>
      ...
      side (<InlineMath math="26 \text{ cm}" />).
    </>
  }
  angle={30}
  labels={{
...
<BlockMath math="\tan 30^\circ = \frac{\text{opposite side}}{\text{adjacent side}} = \frac{15 \text{ cm}}{26 \text{ cm}} = 0.57" />
...
Consider the following right-angled triangle with an angle of <InlineMath math="70^\circ" />, an opposite side of <InlineMath math="15 \text{ cm}" />, and an adjacent side of <InlineMath math="7 \text{ cm}" />.

<Triangle
  title={
    <>
      Triangle with <InlineMath math="70^\circ" /> Angle
    </>
  }
  description={
    <>
...
Can you find the tangent ratio value of <InlineMath math="\tan 70^\circ" />? Explain why!

### Answer Key

Yes, we can find the value of <InlineMath math="\tan 70^\circ" /> by dividing the opposite side by the adjacent side:

<BlockMath math="\tan 70^\circ = \frac{\text{opposite side}}{\text{adjacent side}} = \frac{15 \text{ cm}}{7 \text{ cm}} = 2.14" />

Therefore, the value of <InlineMath math="\tan 70^\circ = 2.14" />.
