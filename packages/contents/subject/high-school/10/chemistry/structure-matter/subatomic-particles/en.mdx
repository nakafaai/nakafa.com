...
Dalton's model made chemical reactions easier to count, but it still pictured atoms as solid spheres. The next question was simple: if atoms were truly solid and had no inner parts, why were atoms connected to electricity?
...
This table is not yet a full atomic symbol calculation. Its job is to build a first map: which particle has which charge, where it is found, and how much mass it contributes.
...
Hold this map for the next lesson: **protons determine element identity**, **neutrons help determine mass**, and **electrons determine many chemical behaviors**. Once this map is clear, subatomic particle properties and atomic symbols become much easier to read.
