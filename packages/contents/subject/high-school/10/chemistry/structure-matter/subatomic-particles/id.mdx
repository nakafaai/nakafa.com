...
Tabel ini adalah peta awal untuk membaca atom: siapa bermuatan apa, ada di mana, dan menyumbang massa sebesar apa.
...
Pegang tiga hubungan ini: **proton menentukan identitas unsur**, **neutron ikut menentukan massa**, dan **elektron menentukan banyak perilaku kimia**. Dengan peta ini, hubungan antara muatan, massa, dan identitas atom lebih mudah dibaca.
