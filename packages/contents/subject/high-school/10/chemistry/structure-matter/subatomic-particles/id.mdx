...
Model Dalton membuat reaksi kimia lebih mudah dihitung, tetapi model itu masih membayangkan atom seperti bola pejal. Pertanyaan berikutnya sederhana: kalau atom benar-benar pejal dan tidak punya bagian dalam, mengapa atom bisa berkaitan dengan listrik?
    ...
    modes: {
      ...
      "gold-foil": {
        ...
        facts: [
          ...
          { label: "Makna", value: "Atom banyak ruang kosong" },
        ],
      },
      "atom-map": {
        tab: "Isi atom",
...
Untuk membayangkan model Thomson, pikirkan roti berisi kismis. Adonan roti mewakili muatan positif yang tersebar, sedangkan kismis mewakili elektron negatif yang tertanam. Analogi ini membantu, tetapi jangan dibaca terlalu jauh: atom tentu bukan roti, dan model Thomson nanti diperbaiki oleh Rutherford.
...
Tabel ini belum masuk ke perhitungan lambang atom secara lengkap. Tujuannya hanya membuat peta awal: siapa bermuatan apa, ada di mana, dan menyumbang massa sebesar apa.
...
Yang perlu dipegang untuk bab berikutnya: **proton menentukan identitas unsur**, **neutron ikut menentukan massa**, dan **elektron menentukan banyak perilaku kimia**. Setelah peta ini jelas, sifat partikel subatom dan lambang atom akan jauh lebih mudah dibaca.
