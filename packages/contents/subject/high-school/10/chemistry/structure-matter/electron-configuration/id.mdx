...
Kata **diskret** berarti tidak semua nilai energi boleh dipakai. Analogi sederhananya seperti tangga: kalian bisa berdiri di anak tangga pertama, kedua, atau ketiga, tetapi tidak nyaman berdiri di "setengah ruang kosong" di antara dua anak tangga. Dalam atom, elektron hanya boleh berada pada tingkat energi tertentu.
...
## Peta Interaktif Kulit Elektron
...
<ElectronConfigurationLab
  title={<>Peta Konfigurasi Elektron</>}
  description={
    <>
...
Catatan penting: kulit <InlineMath math="\mathrm{M}" /> dapat dibahas lebih rinci pada materi lanjutan. Di sini, pola <InlineMath math="2, 8, 8, 2" /> dipakai sebagai jembatan kelas 10 untuk membaca unsur ringan, bukan sebagai aturan lengkap untuk semua unsur.
...
Untuk kelas <InlineMath math="10" />, cukup pegang hubungan idenya: elektron punya tingkat energi tertentu, perubahan tingkat energi menghasilkan cahaya tertentu, dan susunan elektron membantu kita membaca perilaku atom.
