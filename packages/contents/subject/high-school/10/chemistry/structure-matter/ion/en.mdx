...
A simple way to read charge is by its sign. Protons add positive count, while electrons add negative count. If the counts match, the result is <InlineMath math="0" /> or neutral. If electrons decrease, positive charge remains. If electrons increase, negative charge remains.
