...
<ChemicalReactionCharacteristicsLab
  ...
  labels={{
    ...
    cues: {
      gas: {
        tab: "Gas",
        beforeCaption: <>The solution is still calm.</>,
        afterCaption: <>Bubbles appear.</>,
      ...
      precipitate: {
        tab: "Precipitate",
        beforeCaption: <>Two solutions appear to mix evenly.</>,
        afterCaption: <>A solid forms at the bottom.</>,
      ...
      color: {
        tab: "Color",
        beforeCaption: <>The starting color is uniform.</>,
        afterCaption: <>The solution changes color.</>,
      ...
      energy: {
        tab: "Energy",
        beforeCaption: <>The starting temperature is unchanged.</>,
        afterCaption: <>Heat, cooling, or light appears.</>,
