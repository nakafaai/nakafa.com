...
Notice the pattern: once a unit is built from operations between other units, the quantity is no longer base. This way of reading values, units, and dimensions will come back when we study unit systems in more detail.
