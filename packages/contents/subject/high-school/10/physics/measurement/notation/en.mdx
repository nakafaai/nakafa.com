...
For example, the calculated area of a bottle cap is <InlineMath math="7.641404 \text{ cm}^2" />. If the original diameter supports only <InlineMath math="3" /> significant figures, the area is written as:
