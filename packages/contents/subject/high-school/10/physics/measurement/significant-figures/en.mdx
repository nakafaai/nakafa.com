...
## Zero Can Be a Digit or a Placeholder
...
| <InlineMath math="3.14 \times 10^{-5} \text{ m}" /> | The coefficient <InlineMath math="3.14" /> has <InlineMath math="3" /> significant figures. The power <InlineMath math="10^{-5}" /> only gives the scale. |
...
For a bottle cap with diameter <InlineMath math="3.12 \text{ cm}" />, constants such as <InlineMath math="\pi" /> and <InlineMath math="\frac{1}{4}" /> do not limit significant figures because they come from the formula, not from a measuring tool. In this classroom calculation, <InlineMath math="\pi" /> is approximated as <InlineMath math="3.14" />.
...
Reference for the rules: [OpenStax University Physics, Significant Figures section](https://openstax.org/books/university-physics-volume-1/pages/1-6-significant-figures) and [NIST Technical Note 1297, reporting uncertainty section](https://www.nist.gov/pml/nist-technical-note-1297/nist-tn-1297-7-reporting-uncertainty).
