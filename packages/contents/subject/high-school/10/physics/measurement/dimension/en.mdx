...
Concept reference for dimensional analysis: [OpenStax dimensional analysis](https://openstax.org/books/university-physics-volume-1/pages/1-4-dimensional-analysis).
