...
The physics lesson is not simply "there is water, so electricity is guaranteed". The better question is whether the water flow is stable enough, the height difference is large enough, the turbine is protected from flooding, and the community has a way to maintain the system.
