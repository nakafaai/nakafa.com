...
<Mermaid
  chart={`flowchart TD
    ...
    A --> C["Aliran alam"]
    B --> D["Batu bara<br/>minyak bumi<br/>gas alam"]
    C --> E["Matahari<br/>angin<br/>air<br/>biomassa<br/>panas bumi<br/>laut"]
    D --> F["Tak terbarukan"]
    E --> G["Terbarukan, tetapi ketersediaannya tetap perlu dicek"]`}/>
...
Cara paling aman membaca sumber energi adalah menelusuri bentuk energi awal, alat konversinya, dan batasannya. Tabel ini bukan untuk dihafal mentah-mentah. Pakai tabel ini sebagai pola baca.

| Sumber energi | Bentuk energi awal | Jalur konversi yang umum | Catatan yang perlu dibaca |
| :------------ | :----------------- | :----------------------- | :------------------------ |
| Batu bara, minyak bumi, gas alam | energi kimia pada bahan bakar fosil | pembakaran menghasilkan kalor, lalu kalor dapat memutar turbin melalui uap atau gas panas | tak terbarukan karena pembentukannya sangat lama; pembakaran menghasilkan emisi seperti <InlineMath math="\text{CO}_2" /> |
| Biomassa dan biogas | energi kimia dari bahan organik | pembakaran, fermentasi, atau penguraian tanpa oksigen menghasilkan bahan bakar | dapat terbarukan jika bahan bakunya dikelola; biogas banyak mengandung <InlineMath math="\text{CH}_4" /> |
| Air | energi potensial gravitasi dan energi kinetik aliran | air mengalir memutar turbin, lalu generator menghasilkan listrik | cocok jika debit dan beda ketinggian mendukung |
| Angin | energi kinetik udara bergerak | angin memutar bilah turbin, lalu generator menghasilkan listrik | keluarannya berubah mengikuti kelajuan angin |
| Matahari | energi radiasi | sel fotovoltaik mengubah cahaya menjadi listrik, atau sistem termal surya mengumpulkan kalor | kuat pada lokasi dengan radiasi Matahari tinggi |
| Gelombang dan pasang surut laut | energi mekanik gerak air laut | pelampung, kolom air, atau turbin laut mengubah gerak air menjadi listrik | sangat bergantung pada lokasi pesisir dan teknologi yang dipakai |
| Panas bumi | energi termal dari dalam Bumi | fluida panas atau uap mengalir ke turbin, lalu generator menghasilkan listrik | stabil, tetapi lokasi dan pengeboran sangat menentukan |
...
**Energi surya** tidak selalu berarti panel fotovoltaik. Panel fotovoltaik mengubah cahaya langsung menjadi listrik, sedangkan sistem termal surya mengumpulkan kalor dari sinar Matahari. EIA menjelaskan cara sel fotovoltaik mengubah cahaya menjadi listrik pada halaman Photovoltaics and Electricity yang bisa dibuka di [tautan sumber](https://www.eia.gov/energyexplained/solar/photovoltaics-and-electricity.php).
