...
OpenStax College Physics 2e discusses energy conservation on the Conservation of Energy page. That page can be opened through [this source link](https://openstax.org/books/college-physics-2e/pages/7-6-conservation-of-energy).
...
<Mermaid
  chart={`flowchart LR
    ...
    B --> C["Useful energy"]
    B --> D["Dissipated energy<br/>heat, sound, vibration"]`}/>
...
## A Quick Way to Check Energy Claims
