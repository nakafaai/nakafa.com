export const metadata = {
   ...
   description: "Sederhanakan perhitungan limit kompleks dengan sifat penting. Pelajari aturan jumlah, kali, bagi, pangkat, dan akar dengan penerapan langkah demi langkah.",
