export const metadata = {
   ...
   description: "Simplify complex limit calculations with essential properties. Learn sum, product, quotient, power, and root rules with step-by-step applications.",
...
After learning the [basic concept of limits](/subject/high-school/12/mathematics/limit/concept-of-limit-function), we can use **limit properties** to break complex limit calculations into simpler parts.
