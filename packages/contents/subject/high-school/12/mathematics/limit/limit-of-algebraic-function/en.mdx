export const metadata = {
   ...
   description: "Calculate limits of polynomial and rational functions. Learn factoring, rationalization techniques, and solve indeterminate forms with detailed examples.",
