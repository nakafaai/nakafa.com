export const metadata = {
   ...
   description: "Hitung limit fungsi polinomial dan rasional. Pelajari teknik pemfaktoran, rasionalisasi, dan selesaikan bentuk tak tentu dengan contoh terperinci.",
