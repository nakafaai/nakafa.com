...
- Event A: Students who are tall (> <InlineMath math="160 \text{ cm}" />)
...
4. In a box there are <InlineMath math="10 \text{ balls}" /> numbered 1 to 10. A ball is drawn randomly. Calculate the probability of drawing an even-numbered ball or an odd prime-numbered ball.
