export const metadata = {
   ...
   description: "Learn independent event probability with formulas and real-world examples, then calculate combined probabilities.",
...
4. **Solution:**
   ...
   **Method <InlineMath math="1" />: Direct Enumeration**
   ...
   Sample space for <InlineMath math="3" /> coins (<InlineMath math="H" /> = Heads, <InlineMath math="T" /> = Tails): <InlineMath math="\{HHH, HHT, HTH, HTT, THH, THT, TTH, TTT\}" />, total is <InlineMath math="8" />
