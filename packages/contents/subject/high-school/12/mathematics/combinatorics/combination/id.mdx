...
Kadang-kadang ada **pembatasan tertentu** dalam pemilihan. Misalnya, dari <InlineMath math="12 \text{ siswa}" /> (7 laki-laki dan 5 perempuan), kita harus memilih <InlineMath math="4 \text{ siswa}" /> dengan syarat minimal 2 perempuan.
...
1. **Jawaban: <InlineMath math="56 \text{ cara}" />**
   ...
   Jadi, ada <InlineMath math="56 \text{ cara}" /> memilih 3 buku dari 8 buku yang tersedia.
...
2. **Jawaban: <InlineMath math="792 \text{ cara}" />**
   ...
   Tim futsal dapat memilih 5 pemain dari 12 pemain dengan <InlineMath math="792 \text{ cara}" /> berbeda.

3. **Jawaban: <InlineMath math="186 \text{ cara}" />**
   
   Langkah penyelesaian (**metode kasus**):
   
   Total bola: 6 merah + 4 biru adalah <InlineMath math="10 \text{ bola}" />
