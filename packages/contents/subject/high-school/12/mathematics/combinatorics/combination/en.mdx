...
From 10 available students, how many ways can we select <InlineMath math="5 \text{ students}" /> for a basketball team?
...
Sometimes there are **certain restrictions** in selection. For example, from <InlineMath math="12 \text{ students}" /> (7 males and 5 females), we must select <InlineMath math="4 \text{ students}" /> with the condition of at least 2 females.
...
3. In a box there are 6 red balls and 4 blue balls. How many ways can you take <InlineMath math="5 \text{ balls}" /> with the condition of at least 3 red balls?
...
1. **Answer: <InlineMath math="56 \text{ ways}" />**
   ...
   Therefore, there are <InlineMath math="56 \text{ ways}" /> to choose 3 books from 8 available books.
...
3. **Answer: <InlineMath math="186 \text{ ways}" />**
   ...
   Total balls: 6 red + 4 blue is <InlineMath math="10 \text{ balls}" />
