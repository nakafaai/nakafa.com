...
3. **Answer: <InlineMath math="186 \text{ ways}" />**
   ...
   Take <InlineMath math="5 \text{ balls}" /> with at least 3 red balls
   ...
   **Total:** <InlineMath math="120 + 60 + 6 = 186" />
   ...
   There are <InlineMath math="186 \text{ ways}" /> to take <InlineMath math="5 \text{ balls}" /> with at least 3 red balls.
