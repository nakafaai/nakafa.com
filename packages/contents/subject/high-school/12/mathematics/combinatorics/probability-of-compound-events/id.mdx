...
- Kejadian A (kartu merah): <InlineMath math="26 \text{ kartu}" /> (13 Hati + 13 Wajik)
- Kejadian B (kartu bergambar): <InlineMath math="12 \text{ kartu}" /> (4 Jack + 4 Queen + 4 King)
...
Total bola awal = <InlineMath math="8 + 4 = 12 \text{ bola}" />

- Kejadian A (bola pertama biru): <InlineMath math="8 \text{ bola}" /> biru dari <InlineMath math="12 \text{ bola}" /> total
- Kejadian B (bola kedua biru setelah A): Karena <InlineMath math="1 \text{ bola}" /> biru sudah diambil, tersisa <InlineMath math="7 \text{ bola}" /> biru dari <InlineMath math="11 \text{ bola}" /> total
...
2. **Penyelesaian:**
   ...
   Total bola = <InlineMath math="6 + 4 = 10 \text{ bola}" />
   
   - Kejadian A (bola pertama merah): <InlineMath math="6 \text{ bola}" /> merah dari <InlineMath math="10 \text{ bola}" /> total
   - Kejadian B (bola kedua merah setelah A): Setelah <InlineMath math="1 \text{ bola}" /> merah diambil, tersisa <InlineMath math="5 \text{ bola}" /> merah dari <InlineMath math="9 \text{ bola}" /> total
...
3. **Penyelesaian:**
   ...
   - Kejadian A (jumlah = <InlineMath math="7" />): <InlineMath math="(1,6), (2,5), (3,4), (4,3), (5,2), (6,1)" /> → <InlineMath math="6 \text{ cara}" />
   - Kejadian B (jumlah = <InlineMath math="11" />): <InlineMath math="(5,6), (6,5)" /> → <InlineMath math="2 \text{ cara}" />
...
4. **Penyelesaian:**
   ...
   - Kejadian A (kartu As): <InlineMath math="4 \text{ kartu}" /> As
   - Kejadian B (kartu hitam): <InlineMath math="26 \text{ kartu}" /> (Spade dan Club)
   
   Irisan (As hitam): As Spade dan As Club = <InlineMath math="2 \text{ kartu}" />
