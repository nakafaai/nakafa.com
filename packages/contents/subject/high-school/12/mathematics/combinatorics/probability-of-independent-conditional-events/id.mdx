...
Misalkan kita ingin menghitung peluang mendapat dua kartu As berturut-turut dari deck standar (<InlineMath math="52 \text{ kartu}" />, 4 As).
...
1. **Penyelesaian:**
   ...
   Total bola awal = <InlineMath math="8 + 12 = 20 \text{ bola}" />
...
2. **Penyelesaian:**
   ...
   Deck standar memiliki <InlineMath math="52 \text{ kartu}" /> dengan masing-masing: 4 As, 4 King, 4 Queen
