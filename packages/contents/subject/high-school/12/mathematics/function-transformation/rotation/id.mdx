...
1. Tentukan hasil rotasi titik <InlineMath math="(3, 4)" /> terhadap titik asal dengan sudut <InlineMath math="90°" /> berlawanan arah jarum jam.

2. Fungsi <InlineMath math="f(x) = x^2 - 2x + 1" /> dirotasi <InlineMath math="180°" /> terhadap titik asal. Tentukan koordinat titik puncak hasil rotasi jika titik puncak asli berada di <InlineMath math="(1, 0)" />.

3. Garis <InlineMath math="y = 3x - 2" /> dirotasi <InlineMath math="270°" /> terhadap titik asal. Tentukan persamaan garis hasil rotasi.

4. Titik <InlineMath math="(2, 5)" /> dirotasi <InlineMath math="60°" /> terhadap titik <InlineMath math="(1, 1)" />. Tentukan koordinat hasil rotasi.

5. Fungsi <InlineMath math="y = \sqrt{x}" /> untuk <InlineMath math="x \geq 0" /> dirotasi <InlineMath math="90°" /> berlawanan arah jarum jam terhadap titik asal. Jelaskan bentuk grafik hasil rotasi.

### Kunci Jawaban

1. Menggunakan rumus rotasi <InlineMath math="90°" />:
...
2. Titik puncak asli dirotasi <InlineMath math="180°" />:
...
3. Ambil dua titik pada garis dan rotasi <InlineMath math="270°" />:
...
4. Menggunakan rumus rotasi terhadap titik dengan sudut <InlineMath math="60°" />:
...
5. Fungsi <InlineMath math="y = \sqrt{x}" /> dirotasi <InlineMath math="90°" /> menjadi:
