...
1. Determine the rotation result of point <InlineMath math="(3, 4)" /> around the origin with a <InlineMath math="90°" /> counterclockwise angle.

2. Function <InlineMath math="f(x) = x^2 - 2x + 1" /> is rotated <InlineMath math="180°" /> around the origin. Determine the coordinates of the rotation result vertex if the original vertex is at <InlineMath math="(1, 0)" />.

3. Line <InlineMath math="y = 3x - 2" /> is rotated <InlineMath math="270°" /> around the origin. Determine the equation of the rotation result line.

4. Point <InlineMath math="(2, 5)" /> is rotated <InlineMath math="60°" /> around point <InlineMath math="(1, 1)" />. Determine the rotation result coordinates.

5. Function <InlineMath math="y = \sqrt{x}" /> for <InlineMath math="x \geq 0" /> is rotated <InlineMath math="90°" /> counterclockwise around the origin. Explain the shape of the rotation result graph.

### Answer Key

1. Using the <InlineMath math="90°" /> rotation formula:
...
2. Original vertex rotated <InlineMath math="180°" />:
...
3. Take two points on the line and rotate <InlineMath math="270°" />:
...
4. Using the rotation formula around a point with <InlineMath math="60°" /> angle:
...
5. Function <InlineMath math="y = \sqrt{x}" /> rotated <InlineMath math="90°" /> becomes:
   ...
   The rotation result graph forms a parabola that opens upward with domain <InlineMath math="x \leq 0" /> and range <InlineMath math="y \geq 0" />. This is a reflection of parabola <InlineMath math="y = x^2" /> across the <InlineMath math="y" />-axis.
