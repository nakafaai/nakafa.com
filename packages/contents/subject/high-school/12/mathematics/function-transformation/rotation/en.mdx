export const metadata = {
  title: "Rotation",
  description: "Learn function rotation around fixed points with step-by-step examples. Learn rotation formulas, angles, and transformations for various function types.",
...
4. Using the rotation formula around a point with <InlineMath math="60^\circ" /> angle:
