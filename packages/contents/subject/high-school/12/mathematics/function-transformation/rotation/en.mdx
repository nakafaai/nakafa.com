export const metadata = {
  title: "Rotation",
  description: "Learn function rotation around fixed points with worked examples. Learn rotation formulas, angles, and transformations for various function types.",
