...
Vertical translation is a geometric transformation that shifts the graph of a function up or down along the <InlineMath math="y" />-axis without changing the shape of the graph. Imagine lifting or lowering an object vertically, its shape remains the same, only its position changes.
