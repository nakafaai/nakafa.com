...
- The original function <InlineMath math="f(x) = x^2" /> (purple) has its vertex at <InlineMath math="(0, 0)" />
- Function <InlineMath math="g(x) = (x - 3)^2" /> (orange) shifts right by 3 units with vertex at <InlineMath math="(3, 0)" />
- Function <InlineMath math="h(x) = (x + 2)^2" /> (teal) shifts left by 2 units with vertex at <InlineMath math="(-2, 0)" />
