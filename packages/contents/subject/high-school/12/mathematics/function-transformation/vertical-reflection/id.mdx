export const metadata = {
  ...
  description: "Pelajari refleksi vertikal untuk membalik grafik fungsi terhadap sumbu x, lengkap dengan contoh dan latihan soal.",
...
Refleksi vertikal adalah transformasi geometri yang memantulkan grafik fungsi terhadap sumbu <InlineMath math="x" />, seperti melihat bayangan objek di permukaan air yang tenang. Bayangkan sebuah objek yang dipantulkan di cermin horizontal, bentuknya tetap sama tetapi posisinya terbalik secara vertikal.
...
- Kedua grafik simetris terhadap sumbu <InlineMath math="x" />
...
Refleksi vertikal menggunakan sumbu <InlineMath math="x" /> sebagai garis cermin. Setiap titik pada grafik asli memiliki jarak yang sama ke sumbu <InlineMath math="x" /> dengan titik yang bersesuaian pada grafik hasil refleksi.
...
<LineEquation
  ...
  description={<>Kurva eksponensial terpantul menjadi kurva yang menurun dengan asimtot horizontal di bawah sumbu <InlineMath math="x" />.</>}
  showZAxis={false}
...
Mari kita lihat bagaimana refleksi vertikal mempengaruhi fungsi <InlineMath math="\sin" />.
...
2. Jika grafik fungsi <InlineMath math="g(x) = 3^x + 2" /> direfleksikan terhadap sumbu <InlineMath math="x" />, tentukan:
