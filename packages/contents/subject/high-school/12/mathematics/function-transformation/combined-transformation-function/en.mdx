export const metadata = {
  ...
  description: "Learn combined function transformations with step-by-step examples. Learn vertical, horizontal transformations, order effects, and solve practice exercises.",
...
Vertical transformations involve changes on the <InlineMath math="y" />-axis. A common combination is vertical translation followed by vertical dilation.
...
Horizontal transformations affect the <InlineMath math="x" />-axis. An example is reflection across the <InlineMath math="y" />-axis followed by horizontal translation.

For function <InlineMath math="f(x)" /> that is reflected across the <InlineMath math="y" />-axis then translated horizontally by <InlineMath math="a" />, the formula is:
...
2. **Step** <InlineMath math="1" /> **- Vertical Translation**: Shift <InlineMath math="2 \text{ units}" /> up

   <BlockMath math="f_1(x) = f(x) + 2 = x^2 + 2" />

3. **Step** <InlineMath math="2" /> **- Vertical Dilation**: Multiply by factor <InlineMath math="0.5" />
...
<LineEquation
  ...
  description={
    <>
      Quadratic function with vertical translation <InlineMath math="2 \text{ units}" /> up then vertical dilation with factor <InlineMath math="0.5" />.
    </>
  }
  data={[
    {
...
1. Initial function: <InlineMath math="f(x) = x^2" />
2. Vertical dilation with factor <InlineMath math="2" />: <InlineMath math="h_1(x) = 2 \cdot f(x) = 2x^2" />
3. Vertical translation <InlineMath math="+1" />: <InlineMath math="h_A(x) = h_1(x) + 1 = 2x^2 + 1" />

**Order B: Translation first, then dilation**
1. Initial function: <InlineMath math="f(x) = x^2" />
2. Vertical translation <InlineMath math="+1" />: <InlineMath math="h_2(x) = f(x) + 1 = x^2 + 1" />
3. Vertical dilation with factor <InlineMath math="2" />: <InlineMath math="h_B(x) = 2 \cdot h_2(x) = 2(x^2 + 1) = 2x^2 + 2" />
...
2. **Step** <InlineMath math="1" /> **- Reflection across <InlineMath math="y" />-axis**: replace <InlineMath math="x" /> with <InlineMath math="-x" />

   <BlockMath math="f_1(x) = f(-x) = 1.5^{-x}" />

3. **Step** <InlineMath math="2" /> **- Horizontal translation**: Shift <InlineMath math="2 \text{ units}" /> to the right
...
<LineEquation
  ...
  description={<>Exponential function with reflection across <InlineMath math="y" />-axis then horizontal translation.</>}
...
1. Function <InlineMath math="f(x) = x^2" /> is translated vertically <InlineMath math="3 \text{ units}" /> up, then dilated vertically with factor <InlineMath math="\frac{1}{2}" />. Determine the formula of the transformed function.

2. Function <InlineMath math="g(x) = 2^x" /> is reflected across the <InlineMath math="y" />-axis, then translated horizontally <InlineMath math="1 \text{ unit}" /> to the right. Write the formula of the transformed function.

3. Compare the transformation results of function <InlineMath math="h(x) = x^2" /> with two different orders:
   - Order A: Vertical dilation factor <InlineMath math="3" />, then vertical translation <InlineMath math="2 \text{ units}" /> up
   - Order B: Vertical translation <InlineMath math="2 \text{ units}" /> up, then vertical dilation factor <InlineMath math="3" />
...
5. Determine the formula of the transformed function if <InlineMath math="f(x) = |x|" /> is translated horizontally <InlineMath math="2 \text{ units}" /> to the left, reflected across the <InlineMath math="x" />-axis, then dilated vertically with factor <InlineMath math="3" />.

### Answer Key

1. Step-by-step transformation of <InlineMath math="f(x) = x^2" />:
   
   Step <InlineMath math="1" />: Vertical translation <InlineMath math="+3" />

   <BlockMath math="f_1(x) = x^2 + 3" />
   
   Step <InlineMath math="2" />: Vertical dilation with factor <InlineMath math="\frac{1}{2}" />
...
2. Step-by-step transformation of <InlineMath math="g(x) = 2^x" />:
   ...
   Step <InlineMath math="1" />: Reflection across <InlineMath math="y" />-axis

   <BlockMath math="g_1(x) = 2^{-x}" />
   
   Step <InlineMath math="2" />: Horizontal translation <InlineMath math="1 \text{ unit}" /> to the right
...
4. Analysis of transformation <InlineMath math="g(x) = 2\sqrt{x + 3} - 1" /> from <InlineMath math="f(x) = \sqrt{x}" />:
   ...
   - Horizontal translation <InlineMath math="3 \text{ units}" /> to the left: <InlineMath math="f(x + 3) = \sqrt{x + 3}" />
   - Vertical dilation with factor <InlineMath math="2" />: <InlineMath math="2\sqrt{x + 3}" />
   - Vertical translation <InlineMath math="1 \text{ unit}" /> down: <InlineMath math="2\sqrt{x + 3} - 1" />
