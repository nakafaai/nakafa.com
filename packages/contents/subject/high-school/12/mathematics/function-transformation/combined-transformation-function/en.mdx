...
3. Compare the transformation results of function <InlineMath math="h(x) = x^2" /> with two different orders:
   - Order A: Vertical dilation factor 3, then vertical translation <InlineMath math="2 \text{ units}" /> up
   - Order B: Vertical translation <InlineMath math="2 \text{ units}" /> up, then vertical dilation factor 3
...
2. Step-by-step transformation of <InlineMath math="g(x) = 2^x" />:
   ...
   Step 1: Reflection across <InlineMath math="y" />-axis

   <BlockMath math="g_1(x) = 2^{-x}" />
   
   Step 2: Horizontal translation <InlineMath math="1 \text{ unit}" /> to the right
