...
2. **Step 1 - Vertical Translation**: Shift <InlineMath math="2 \text{ units}" /> up
...
2. **Step 1 - Reflection across <InlineMath math="y" />-axis**: replace <InlineMath math="x" /> with <InlineMath math="-x" />
   <BlockMath math="f_1(x) = f(-x) = 1.5^{-x}" />

3. **Step 2 - Horizontal translation**: Shift <InlineMath math="2 \text{ units}" /> to the right
