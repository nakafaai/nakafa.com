export const metadata = {
  ...
  description: "Pelajari dilatasi vertikal fungsi dengan contoh jelas. Pelajari cara meregangkan atau menekan grafik vertikal menggunakan faktor skala dan terapkan transformasi.",
...
- **Titik potong sumbu <InlineMath math="x" />**: Tidak berubah (kecuali jika <InlineMath math="k = 0" />)
