export const metadata = {
  ...
  description: "Learn horizontal reflection in functions with clear examples. Learn how to reflect graphs across the vertical axis and apply this transformation effectively.",
