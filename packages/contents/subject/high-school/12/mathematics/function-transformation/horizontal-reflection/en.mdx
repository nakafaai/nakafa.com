export const metadata = {
  ...
  description: "Master horizontal reflection in functions with clear examples. Learn how to reflect graphs across the vertical axis and apply this transformation effectively.",
...
- Both graphs are symmetric across the <InlineMath math="y" />-axis
...
- The reflected function <InlineMath math="g(x) = -2x + 3" /> has a negative slope of <InlineMath math="2" />
...
1. Horizontal reflection: <InlineMath math="f'(x) = f(-x) = (-x)^2 + 3(-x) + 2 = x^2 - 3x + 2" />
   ...
   <LineEquation
     ...
     description={<>The original parabola is reflected across the <InlineMath math="y" />-axis producing a parabola with different orientation.</>}
     showZAxis={false}
     cameraPosition={[12, 8, 12]}
     data={[
       {
