...
- The original function <InlineMath math="f(x) = (x - 2)^2" /> (purple) has its vertex at <InlineMath math="(2, 0)" />
- The reflected function <InlineMath math="g(x) = (-x - 2)^2" /> (orange) has its vertex at <InlineMath math="(-2, 0)" />
