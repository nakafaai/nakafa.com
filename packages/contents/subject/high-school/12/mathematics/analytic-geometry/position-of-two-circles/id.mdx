...
- **Batas atas**: Kalau jarak pusat adalah <InlineMath math="r_1 + r_2" />, kedua lingkaran cuma bersentuhan di luar
- **Batas bawah**: Kalau jarak pusat adalah <InlineMath math="|r_1 - r_2|" />, lingkaran kecil bersentuhan dengan yang besar dari dalam
