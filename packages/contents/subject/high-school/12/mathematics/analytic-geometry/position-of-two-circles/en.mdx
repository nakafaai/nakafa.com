...
- **Upper bound**: If center distance is <InlineMath math="r_1 + r_2" />, both circles only touch externally
- **Lower bound**: If center distance is <InlineMath math="|r_1 - r_2|" />, the small circle touches the large one internally
