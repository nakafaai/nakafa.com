...
Dalam visualisasi di atas, titik <InlineMath math="P" /> adalah pusat lingkaran, sedangkan titik <InlineMath math="A" />, <InlineMath math="B" />, dan <InlineMath math="C" /> adalah beberapa titik yang berada pada lingkaran. Coba perhatikan bahwa jarak dari <InlineMath math="P" /> ke <InlineMath math="A" />, <InlineMath math="P" /> ke <InlineMath math="B" />, dan <InlineMath math="P" /> ke <InlineMath math="C" /> semuanya sama dengan <InlineMath math="r" />. Ini yang membuat mereka semua berada di lingkaran yang sama.
...
Di mana <InlineMath math="d(P, (x,y))" /> adalah jarak dari titik pusat <InlineMath math="P" /> ke titik <InlineMath math="(x, y)" /> pada lingkaran.
