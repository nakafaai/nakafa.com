export const metadata = {
  ...
  description: "Learn tangent line equations using substitution, distance, and quadratic methods. Solve problems from external points with complete step-by-step solutions.",
...
The tangent line from point <InlineMath math="P" /> has form <InlineMath math="y - y_0 = m(x - x_0)" />, or <InlineMath math="y = mx - mx_0 + y_0" />.
...
**Step** <InlineMath math="1" />: Verify that point <InlineMath math="A" /> is outside the circle.

<BlockMath math="7^2 + 1^2 = 49 + 1 = 50 > 25 \quad \checkmark" />

**Step** <InlineMath math="2" />: Form quadratic equation in gradient with <InlineMath math="x_0 = 7" />, <InlineMath math="y_0 = 1" />, <InlineMath math="r^2 = 25" />:
...
**Step** <InlineMath math="3" />: Solve using quadratic formula:
...
**Step** <InlineMath math="4" />: Construct final equations:
...
3. **Solution**:
   ...
   **Step** <InlineMath math="2" />: Use quadratic equation in gradient. With coordinate translation to circle center, point <InlineMath math="(11,10)" /> becomes <InlineMath math="(8,6)" /> relative to center.
   
   **Step** <InlineMath math="3" />: Quadratic equation in gradient for circle <InlineMath math="x^2 + y^2 = 25" /> from point <InlineMath math="(8,6)" />:
   ...
   **Step** <InlineMath math="4" />: Using quadratic formula:
   ...
   **Step** <InlineMath math="5" />: Simplify gradients and determine tangent line equation through point <InlineMath math="(11,10)" />:
...
4. **Solution**:
   ...
   **Step** <InlineMath math="1" />: Convert circle equation to standard form by completing the square
   ...
   **Step** <InlineMath math="2" />: Line <InlineMath math="3x + 4y = 7" /> can be written as <InlineMath math="y = -\frac{3}{4}x + \frac{7}{4}" />
   
   Parallel line gradient: <InlineMath math="m = -\frac{3}{4}" />
   
   **Step** <InlineMath math="3" />: For circle with center <InlineMath math="(3,4)" />, parallel tangent line equation:
