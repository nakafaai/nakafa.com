export const metadata = {
  ...
  description: "Pelajari persamaan garis singgung dengan metode substitusi, jarak, dan kuadratik. Selesaikan soal dari titik eksternal dengan pembahasan bertahap.",
