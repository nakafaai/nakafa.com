export const metadata = {
  title: "Hiperbola",
  description: "Pelajari konsep hiperbola: fokus, asimtot, dan persamaan x²/a² - y²/b² = 1. Pelajari eksentrisitas, puncak, dan selesaikan soal dengan contoh langkah demi langkah.",
