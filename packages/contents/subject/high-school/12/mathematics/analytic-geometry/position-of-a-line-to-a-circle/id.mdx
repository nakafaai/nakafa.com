export const metadata = {
  ...
  description: "Pelajari cara garis memotong, menyinggung, atau tidak bersentuhan dengan lingkaran menggunakan analisis diskriminan. Pelajari titik potong dan kondisi singgung.",
