export const metadata = {
  ...
  description: "Learn tangent lines to circles: find equations through points, with given slopes, and from external points. Interactive examples and step-by-step solutions.",
...
**Step** <InlineMath math="1" />: Determine the equation of the polar line of point <InlineMath math="B(2, 6)" /> with respect to the circle:
