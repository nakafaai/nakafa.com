export const metadata = {
  ...
  description: "Hitung luas bidang datar menggunakan integral tentu dengan solusi langkah demi langkah. Pelajari fungsi kuadrat dan irasional melalui contoh praktis.",
