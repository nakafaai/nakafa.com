export const metadata = {
  ...
  description: "Calculate flat surface areas using definite integrals with step-by-step solutions. Learn quadratic and irrational functions through practical examples.",
