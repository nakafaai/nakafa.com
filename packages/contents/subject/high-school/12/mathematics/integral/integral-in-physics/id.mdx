...
Pertama, kita tentukan konstanta pegas. Perpindahan dari posisi alami adalah <InlineMath math="15 - 10 = 5 \text{ cm}" /> = <InlineMath math="0.05" /> m. Karena <InlineMath math="F = kx" />, maka:
...
- Posisi <InlineMath math="15 \text{ cm}" /> = <InlineMath math="0.05" /> m dari posisi alami
- Posisi <InlineMath math="18 \text{ cm}" /> = <InlineMath math="0.08" /> m dari posisi alami
...
1. Sebuah partikel bergerak sepanjang sumbu x dengan gaya <InlineMath math="F(x) = 4x - x^2" /> Newton. Hitunglah usaha yang dilakukan untuk memindahkan partikel dari <InlineMath math="x = 0" /> ke <InlineMath math="x = 3 \text{ meter}" />!

2. Sebuah pegas memiliki konstanta pegas <InlineMath math="k = 200" /> N/m. Berapa energi yang tersimpan dalam pegas ketika diregangkan sejauh <InlineMath math="0.1 \text{ meter}" /> dari posisi kesetimbangan?
