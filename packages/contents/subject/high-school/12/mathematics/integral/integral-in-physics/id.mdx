export const metadata = {
   ...
   description: "Pelajari penggunaan integral dalam fisika untuk menghitung usaha, energi pegas, distribusi massa, dan pusat massa.",
...
Bayangkan sebuah partikel yang berada pada posisi <InlineMath math="x \text{ meter}" /> dari titik asal. Gaya yang bekerja pada partikel tersebut adalah <InlineMath math="F(x) = x^2 + 2x" /> Newton. Sekarang, berapa usaha yang diperlukan untuk memindahkan partikel dari posisi <InlineMath math="x = 1 \text{ meter}" /> ke posisi <InlineMath math="x = 3 \text{ meter}" />?
...
Mari kita lihat contoh nyata. Misalkan diperlukan gaya <InlineMath math="40 \text{ N}" /> untuk menahan pegas yang telah direntangkan dari panjang aslinya <InlineMath math="10 \text{ cm}" /> sampai <InlineMath math="15 \text{ cm}" />. Sekarang, berapa usaha yang diperlukan untuk meregangkan pegas dari <InlineMath math="15 \text{ cm}" /> menjadi <InlineMath math="18 \text{ cm}" />?

Pertama, kita tentukan konstanta pegas. Perpindahan dari posisi alami adalah <InlineMath math="15 - 10 = 5 \text{ cm} = 0.05 \text{ m}" />. Karena <InlineMath math="F = kx" />, maka:

<BlockMath math="40 = k \times 0.05" />

Sehingga <InlineMath math="k = \frac{40}{0.05} = 800 \text{ N/m}" />.

Sekarang, untuk menghitung usaha meregangkan pegas dari <InlineMath math="15 \text{ cm}" /> ke <InlineMath math="18 \text{ cm}" />, kita perlu menghitung integral. Koordinat yang kita gunakan:
- Posisi <InlineMath math="15 \text{ cm} = 0.05 \text{ m}" /> dari posisi alami
- Posisi <InlineMath math="18 \text{ cm} = 0.08 \text{ m}" /> dari posisi alami
...
Misalkan kita memiliki batang sepanjang <InlineMath math="2 \text{ meter}" /> dengan densitas linear <InlineMath math="\rho(x) = 3x + 2 \text{ kg/m}" />, di mana <InlineMath math="x" /> adalah jarak dari salah satu ujung batang. Berapa massa total batang tersebut?
...
1. Sebuah partikel bergerak sepanjang sumbu <InlineMath math="x" /> dengan gaya <InlineMath math="F(x) = 4x - x^2" /> Newton. Hitunglah usaha yang dilakukan untuk memindahkan partikel dari <InlineMath math="x = 0" /> ke <InlineMath math="x = 3 \text{ meter}" />!

2. Sebuah pegas memiliki konstanta pegas <InlineMath math="k = 200 \text{ N/m}" />. Berapa energi yang tersimpan dalam pegas ketika diregangkan sejauh <InlineMath math="0.1 \text{ meter}" /> dari posisi kesetimbangan?

3. Sebuah kawat sepanjang <InlineMath math="4 \text{ meter}" /> memiliki densitas linear <InlineMath math="\rho(x) = 2 + x \text{ kg/m}" />. Tentukan massa total kawat dan posisi pusat massanya!
...
3. **Menghitung massa dan pusat massa kawat**
   ...
   Massa total kawat adalah <InlineMath math="16 \text{ kg}" /> dan pusat massanya berada pada posisi <InlineMath math="\frac{7}{3} \text{ meter}" /> dari ujung.
