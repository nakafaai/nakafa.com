...
1. A company has a sales rate of <InlineMath math="f(t) = 1000 + 500t \text{ units}" /> per month. Calculate the total sales in the first 6 months!
...
1. **Calculating total sales**
   ...
   Total sales in 6 months is <InlineMath math="15{,}000 \text{ units}" />.
...
3. **Calculating investment growth**
   ...
   Total investment growth in <InlineMath math="4 \text{ years}" /> is approximately 8.86 billion dollars.