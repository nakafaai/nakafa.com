...
Now, here's the question: what is the **total sales** in the first <InlineMath math="3 \text{ months}" />? This is where integrals play a role. We need to integrate the sales rate function:
...
The final result is <InlineMath math="S = 9333 + 2400 = 11733" /> smartphone units sold in the first <InlineMath math="3 \text{ months}" />.
...
So, the total variable cost to produce <InlineMath math="20 \text{ units}" /> is <InlineMath math="2.4 \text{ million}" /> dollars.
...
The concept of consumer surplus can also be calculated using integrals. Imagine there's a market with demand function <InlineMath math="P = 100 - 0.5Q" /> and the equilibrium price is <InlineMath math="60 \text{ dollars per unit}" />.
...
A consumer surplus of <InlineMath math="1600 \text{ units}" /> shows the total benefit obtained by consumers above the equilibrium price.
...
3. The investment growth rate function is <InlineMath math="I'(t) = 2000e^{0.05t}" /> million dollars per year. Calculate the total investment growth in <InlineMath math="4 \text{ years}" />!
...
2. **Calculating variable cost**
   ...
   Total variable cost is 1,875 thousand dollars or <InlineMath math="1.875 \text{ million}" /> dollars.
