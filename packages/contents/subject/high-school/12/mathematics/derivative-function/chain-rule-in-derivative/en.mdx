export const metadata = {
    ...
    description: "Learn the chain rule to differentiate composite functions. Learn step-by-step methods for nested functions with power and trigonometric examples.",
...
1.  **Solution for <InlineMath math="y = (3x^2 - 1)^3" />**
    ...
    **Step** <InlineMath math="1" />: Identify the functions
    -   Inner function: <InlineMath math="u = 3x^2 - 1" />
    -   Outer function: <InlineMath math="y = u^3" />

    **Step** <InlineMath math="2" />: Find the derivative of each
    -   <InlineMath math="\frac{du}{dx} = 6x" />
    -   <InlineMath math="\frac{dy}{du} = 3u^2" />

    **Step** <InlineMath math="3" />: Combine with the chain rule
    ...
    **Step** <InlineMath math="4" />: Don't forget to substitute back
...
2.  **Solution for <InlineMath math="y = \sin^3(2x)" />**
    ...
    **Step** <InlineMath math="4" />: Substitute back and simplify
