export const metadata = {
    ...
    description: "Pelajari aturan rantai untuk menurunkan fungsi komposisi. Pelajari metode langkah demi langkah untuk fungsi bersusun dengan contoh pangkat dan trigonometri.",
