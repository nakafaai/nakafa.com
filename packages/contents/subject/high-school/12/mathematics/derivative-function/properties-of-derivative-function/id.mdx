...
2.  **Aturan Pangkat**: Ini adalah aturan yang berguna untuk fungsi berbentuk <InlineMath math="f(x) = ax^n" />. Caranya sederhana, kalikan pangkat <InlineMath math="n" /> dengan koefisien <InlineMath math="a" />, lalu kurangi pangkatnya dengan satu.
