export const metadata = {
    ...
    description: "Pelajari sifat-sifat turunan penting: aturan pangkat, hasil kali, hasil bagi, dan rantai. Pelajari jalan pintas menurunkan fungsi efisien dengan penjelasan jelas.",
