...
3.  **Solution:**
    ...
    **Step 1: Find point <InlineMath math="P" />.**
...
4.  **Solution:**
    ...
    **Step 1: Find point <InlineMath math="A" />.**
    ...
    **Step 2: Prove the tangent line is parallel to the <InlineMath math="x" />-axis.**
    ...
    **Step 3: Prove its distance is <InlineMath math="4 \text{ units}" /> from the origin.**
