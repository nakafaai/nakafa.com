...
export const metadata = {
  ...
  description: "Learn finding tangent line equations using derivatives. Learn step-by-step methods, slope calculations, and solve complex problems with visual examples.",
...
Since we want to find the gradient at the point where the <InlineMath math="x" />-coordinate is <InlineMath math="x=1" />, we substitute this value into the derivative.

<BlockMath math="m = f'(1) = -8(1) = -8" />

So, the gradient of the tangent line is <InlineMath math="-8" />.
...
2.  Determine the equation of the tangent line to the parabola <InlineMath math="y = 2x^2 - 3x + 5" /> at the point with an ordinate of <InlineMath math="4" />.

3.  A curve <InlineMath math="y = 3x - \frac{3}{x^2}" /> intersects the <InlineMath math="x" />-axis at P. Find the equation of the tangent line to the curve at point <InlineMath math="P" />!

4.  The curve <InlineMath math="y = (x^2 + 2)^2" /> intersects the <InlineMath math="y" />-axis at point <InlineMath math="A" />. Show that the tangent line to the curve at point <InlineMath math="A" /> is parallel to the <InlineMath math="x" />-axis and is <InlineMath math="4 \text{ units}" /> away from the origin!

5.  Determine the coordinates of the point on the curve <InlineMath math="y = 2x^2 - 7x + 1" />, if the tangent line to the curve at that point forms an angle of <InlineMath math="45^\circ" /> with the positive <InlineMath math="x" />-axis. Also, determine the equation of the tangent line to the curve that passes through that point!
...
1.  **Solution:**
    ...
    **Step** <InlineMath math="2" />: Find the point of tangency.
    ...
    Next, we set this derivative equal to the gradient we know (<InlineMath math="m = -1/2" />) to find the <InlineMath math="x" />-coordinate of the point of tangency.
...
3.  **Solution:**
    ...
    **Step <InlineMath math="1" />: Find point <InlineMath math="P" />.**
    ...
    So, the intersection point <InlineMath math="P" /> is <InlineMath math="(1, 0)" />.

    **Step** <InlineMath math="2" />: Find the gradient at P.
...
4.  **Solution:**
    ...
    **Step <InlineMath math="1" />: Find point <InlineMath math="A" />.**
    ...
    So, the intersection point <InlineMath math="A" /> is <InlineMath math="(0, 4)" />.

    **Step <InlineMath math="2" />: Prove the tangent line is parallel to the <InlineMath math="x" />-axis.**

    A line parallel to the <InlineMath math="x" />-axis must have a gradient of <InlineMath math="0" />. Let's prove that the derivative of the function at point <InlineMath math="A" /> (<InlineMath math="x=0" />) is zero.
...
5.  **Solution:**
    ...
    **Step** <InlineMath math="1" />: Determine the gradient from the angle.
    ...
    So, the gradient of the tangent line we are looking for is <InlineMath math="1" />.
