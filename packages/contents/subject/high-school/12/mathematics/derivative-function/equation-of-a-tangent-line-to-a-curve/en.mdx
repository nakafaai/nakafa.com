...
3.  A curve <InlineMath math="y = 3x - \frac{3}{x^2}" /> intersects the <InlineMath math="x" />-axis at P. Find the equation of the tangent line to the curve at point P!

4.  The curve <InlineMath math="y = (x^2 + 2)^2" /> intersects the <InlineMath math="y" />-axis at point A. Show that the tangent line to the curve at point A is parallel to the <InlineMath math="x" />-axis and is <InlineMath math="4 \text{ units}" /> away from the origin!

5.  Determine the coordinates of the point on the curve <InlineMath math="y = 2x^2 - 7x + 1" />, if the tangent line to the curve at that point forms an angle of <InlineMath math="45°" /> with the positive <InlineMath math="x" />-axis. Also, determine the equation of the tangent line to the curve that passes through that point!
...
4.  **Solution:**
    ...
    **Step 2: Prove the tangent line is parallel to the X-axis.**
    ...
    A line parallel to the <InlineMath math="x" />-axis must have a gradient of <InlineMath math="0" />. Let's prove that the derivative of the function at point A (<InlineMath math="x=0" />) is zero.
