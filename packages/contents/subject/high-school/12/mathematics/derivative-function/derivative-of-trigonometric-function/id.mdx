export const metadata = {
    ...
    description: "Pelajari turunan fungsi trigonometri: sin, cos, tan, dan lainnya. Pelajari rumus, aturan hasil kali, hasil bagi dengan contoh langkah demi langkah dan solusi.",
...
2.  **Penyelesaian:**
    ...
    **Langkah** <InlineMath math="1" />: Tentukan u, v, u', dan v'
