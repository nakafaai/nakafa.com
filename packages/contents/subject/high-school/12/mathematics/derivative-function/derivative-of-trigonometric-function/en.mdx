export const metadata = {
    ...
    description: "Learn derivatives of trigonometric functions: sin, cos, tan, and more. Learn formulas, product rule, quotient rule with step-by-step examples and solutions.",
...
2.  **Solution:**
    ...
    **Step** <InlineMath math="1" />: Determine u, v, u', and v'
