...
Dengan fungsi ini, kita bisa menghitung kecepatan partikel kapan pun. Misalnya, pada <InlineMath math="t = 1 \text{ detik}" />, kecepatannya adalah <InlineMath math="v(1) = 3(1)^2 - 12(1) + 9 = 0 \text{ meter}" />/detik. Hasil nol ini menandakan bahwa partikel tersebut berhenti sesaat, mungkin untuk sejenak diam atau bahkan berbalik arah.
