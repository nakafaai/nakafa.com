...
export const metadata = {
  ...
  description: "Learn finding extrema using derivatives. Learn first and second derivative tests to identify critical points, maximum and minimum values with visual examples.",
...
So, the maximum turning point value of the function is <InlineMath math="4" />, which occurs at the point <InlineMath math="(1,4)" />, and its minimum turning point value is <InlineMath math="0" />, which occurs at the point <InlineMath math="(3,0)" />.
...
1.  **Solution:**
    ...
    **Step** <InlineMath math="3" />: Find the y-value
