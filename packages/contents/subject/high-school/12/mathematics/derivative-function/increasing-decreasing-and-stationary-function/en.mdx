...
export const metadata = {
  ...
  description: "Learn identifying increasing, decreasing, and stationary functions using derivatives. Learn to analyze function behavior and determine monotonicity intervals.",
