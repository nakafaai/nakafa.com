...
The ancient Egyptians used a more accurate approach. They used the value <InlineMath math="\pi \approx \frac{256}{81}" />, which when calculated gives a result of about <InlineMath math="3.16" />. This value was closer to the value of <InlineMath math="\pi" /> than the Babylonian approach.
