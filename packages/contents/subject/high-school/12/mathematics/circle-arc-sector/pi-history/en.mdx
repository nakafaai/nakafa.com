...
Zu Chongzhi, a Chinese mathematician who lived in the <InlineMath math="5" />th century AD, achieved an extraordinary breakthrough in calculating <InlineMath math="\pi" />. He used a polygon with 24,576 sides and successfully determined the value of <InlineMath math="\pi" /> to seven accurate decimal places.
