export const metadata = {
  ...
  description: "Pelajari sudut pusat yang membentuk juring dan hitung luas juring dengan rumus tepat. Pelajari teknik pengukuran, hubungan proporsional, dan aplikasi nyata.",
...
- Pizza dipotong menjadi <InlineMath math="8 \text{ bagian}" /> sama besar: <InlineMath math="\alpha = \frac{360^\circ}{8} = 45^\circ" />
- Jam dinding dengan <InlineMath math="12" /> angka: <InlineMath math="\alpha = \frac{360^\circ}{12} = 30^\circ" />
- Kue tart dipotong menjadi <InlineMath math="6 \text{ bagian}" />: <InlineMath math="\alpha = \frac{360^\circ}{6} = 60^\circ" />
