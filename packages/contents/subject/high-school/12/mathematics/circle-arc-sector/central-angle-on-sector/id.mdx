...
- **Pembagian lingkaran**: membagi <InlineMath math="360°" /> dengan jumlah bagian yang sama
...
- Pizza dipotong menjadi <InlineMath math="8 \text{ bagian}" /> sama besar: <InlineMath math="\alpha = \frac{360°}{8} = 45°" />
- Jam dinding dengan 12 angka: <InlineMath math="\alpha = \frac{360°}{12} = 30°" />
- Kue tart dipotong menjadi <InlineMath math="6 \text{ bagian}" />: <InlineMath math="\alpha = \frac{360°}{6} = 60°" />
