...
**Perbedaan Kunci:**
- **Tembereng Minor**: sudut pusat <InlineMath math="\lt 180°" />, luas tembereng <InlineMath math="\lt" /> luas setengah lingkaran
- **Tembereng Mayor**: sudut pusat <InlineMath math="\gt 180°" />, luas tembereng <InlineMath math="\gt" /> luas setengah lingkaran
...
Untuk memahami cara menghitung luas tembereng, mari kita gunakan contoh dengan sudut pusat <InlineMath math="90°" /> dan jari-jari <InlineMath math="r = 10 \text{ cm}" />, sesuai dengan visualisasi komponen pembentuk tembereng di atas.
...
1. Sebuah lingkaran memiliki jari-jari <InlineMath math="7 \text{ cm}" />. Jika terdapat tembereng dengan sudut pusat <InlineMath math="60°" />, tentukan luas tembereng tersebut.
