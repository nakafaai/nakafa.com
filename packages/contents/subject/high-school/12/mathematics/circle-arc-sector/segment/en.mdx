...
**Key Differences:**
- **Minor Segment**: central angle <InlineMath math="\lt 180°" />, segment area <InlineMath math="\lt" /> half circle area
- **Major Segment**: central angle <InlineMath math="\gt 180°" />, segment area <InlineMath math="\gt" /> half circle area
...
To understand how to calculate the area of a segment, let's use an example with a central angle of <InlineMath math="90°" /> and radius <InlineMath math="r = 10 \text{ cm}" />, according to the visualization of segment formation components above.
...
1. A circle has a radius of <InlineMath math="7 \text{ cm}" />. If there is a segment with a central angle of <InlineMath math="60°" />, determine the area of the segment.
