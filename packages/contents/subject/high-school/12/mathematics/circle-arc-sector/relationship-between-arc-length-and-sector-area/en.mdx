...
One of the most fascinating applications of the relationship between arc length and sector area is the measurement of Earth's circumference by Eratosthenes around <InlineMath math="276\text{-}195 \text{ BC}" />. By observing that sunlight fell perpendicularly at Syene while forming a <InlineMath math="7.2°" /> angle at Alexandria, which was <InlineMath math="500 \text{ miles}" /> away, he was able to calculate Earth's circumference.
...
3. Two cities are located on the same latitude with a distance of <InlineMath math="1{,}000 \text{ km}" />. If the angle formed at Earth's center is <InlineMath math="9°" />, determine the estimated circumference of Earth.
...
3. **Solution Steps:**
   ...
   Given: distance = <InlineMath math="1{,}000 \text{ km}" />, angle = <InlineMath math="9°" />
