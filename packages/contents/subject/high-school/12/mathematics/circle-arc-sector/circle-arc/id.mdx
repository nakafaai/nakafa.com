...
Mari kita terapkan konsep ini dalam perhitungan teknik. Misalkan kita merancang jembatan lengkung dengan jari-jari <InlineMath math="25 \text{ meter}" /> dan sudut pusat <InlineMath math="120°" />.
...
1. Sebuah jembatan lengkung memiliki jari-jari <InlineMath math="30 \text{ meter}" /> dan sudut pusat <InlineMath math="90°" />. Hitunglah panjang tali busur dan tinggi busur jembatan tersebut.
...
4. **Penyelesaian:**
   ...
   - Titik akhir: <InlineMath math="(0, 4)" /> → <InlineMath math="t_2 = 90°" />
