export const metadata = {
  title: "Circle Arc",
  description: "Learn arc-chord relationships, sagitta calculations, and parametric equations. Apply advanced trigonometric formulas to engineering and architectural designs.",
...
3. **Solution:**
   ...
   **Step** <InlineMath math="2" />: Calculate central angle
