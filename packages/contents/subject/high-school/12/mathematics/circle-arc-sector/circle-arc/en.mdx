...
Let's apply this concept in engineering calculations. Suppose we design an arch bridge with a radius of <InlineMath math="25 \text{ meters}" /> and a central angle of <InlineMath math="120°" />.
...
1. An arch bridge has a radius of <InlineMath math="30 \text{ meters}" /> and a central angle of <InlineMath math="90°" />. Calculate the chord length and arc height of the bridge.
...
4. **Solution:**
   ...
   - Ending point: <InlineMath math="(0, 4)" /> → <InlineMath math="t_2 = 90°" />
