export const metadata = {
  ...
  description: "Pelajari fungsi distribusi normal dengan visualisasi kurva lonceng dan contoh soal. Pahami transformasi z-score dan cara menghitung peluang bertahap.",
