export const metadata = {
  ...
  description: "Learn normal distribution function with bell curve visualization and examples. Understand z-score transformation and calculate probabilities one step at a time.",
