...
Jika tinggi badan siswa di sekolahmu terdistribusi normal dengan rata-rata <InlineMath math="165 \text{ cm}" />, maka nilai harapan tinggi badan siswa yang dipilih secara acak adalah <InlineMath math="165 \text{ cm}" />.
...
Berat bayi yang baru lahir di suatu rumah sakit terdistribusi normal dengan rata-rata <InlineMath math="3.200 \text{ gram}" /> dan standar deviasi <InlineMath math="400 \text{ gram}" />. Tentukan nilai harapan berat bayi yang akan lahir!
...
1. Waktu tempuh perjalanan dari rumah ke sekolah terdistribusi normal dengan rata-rata <InlineMath math="25 \text{ menit}" /> dan standar deviasi <InlineMath math="5 \text{ menit}" />. Tentukan nilai harapan waktu tempuh perjalanan!

2. Suhu udara harian di kota Jakarta selama bulan Juni terdistribusi normal dengan rata-rata <InlineMath math="28^\circ\text{C}" /> dan standar deviasi <InlineMath math="3^\circ\text{C}" />. Berapa nilai harapan suhu udara pada hari yang dipilih secara acak?

3. Nilai ujian fisika siswa kelas <InlineMath math="12" /> terdistribusi normal dengan rata-rata <InlineMath math="78" /> dan standar deviasi <InlineMath math="12" />. Jika seorang siswa mengikuti ujian, berapa nilai harapan yang akan diperolehnya?
