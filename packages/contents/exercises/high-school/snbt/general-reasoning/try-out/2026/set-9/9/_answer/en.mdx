...
To find the highest percentage of graduates, we must compare the number of students who passed with the total number of students (passed + failed) in each class, then multiply by <InlineMath math="100\%" />.
