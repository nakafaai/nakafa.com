...
We need to form a code with the pattern <InlineMath math="\text{Letter} - \text{Digit} - \text{Letter} - \text{Digit}" />.
...
#### First Case If the Second Digit Is One
...
#### Second Case If the Second Digit Is Not One
