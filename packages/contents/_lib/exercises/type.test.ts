...
describe("getSubjects", () => {
  it("derives SNBT materials from existing material folders", async () => {
  ...
  it("derives middle-school materials from existing material folders", async () => {
    expect(
  ...
  it("returns no subjects when a type has no material folders", async () => {
    expect(
