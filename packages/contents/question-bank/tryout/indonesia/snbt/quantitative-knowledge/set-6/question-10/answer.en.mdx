...
**Step** <InlineMath math="1" />: Find the value of <InlineMath math="a_3" /> by substituting <InlineMath math="n = 1" />. Given <InlineMath math="a_1 = 8" /> and <InlineMath math="a_2 = -5" />.
...
**Step** <InlineMath math="2" />: Find the value of <InlineMath math="a_4" /> by substituting <InlineMath math="n = 2" />.
...
**Step** <InlineMath math="3" />: Calculate the sum <InlineMath math="a_3 + a_4" />.
