...
export const exercisesHighSchoolSnbtIndonesianLanguagePlan = defineExercisePlan(
  {
    baseRoute: "exercises/high-school/snbt/indonesian-language",
    ...
    kind: "exercise",
    key: "exercises.high-school.snbt.indonesian-language",
