...
export const exercisesHighSchoolSnbtQuantitativeKnowledgePlan =
  defineExercisePlan({
    baseRoute: "exercises/high-school/snbt/quantitative-knowledge",
    ...
    kind: "exercise",
    key: "exercises.high-school.snbt.quantitative-knowledge",
