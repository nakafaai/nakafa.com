...
export const subjectHighSchool12PhysicsMagnetismTopic = defineSubjectPlanTopic({
  slug: "magnetism",
  translations: {
    en: {
      description:
  ...
  sections: [
    ...
    {
      slug: "force-current-carrying-conductor",
      translations: {
        en: {
    ...
    {
      slug: "magnetic-field-straight-wire",
      translations: {
        en: {
    ...
    {
      slug: "current-carrying-circular-wire",
      translations: {
        en: {
