...
export const subjectUniversityBachelorAiDsNlpTopic = defineSubjectMaterialTopic(
  {
    slug: "nlp",
    translations: {
      en: {
    ...
    sections: [
      ...
      {
        slug: "context-sensitive-grammar",
        translations: {
          en: {
      ...
      {
        slug: "regular-grammar-left-right",
        translations: {
          en: {
      ...
      {
        slug: "language-model-evaluation",
        translations: {
          en: {
      ...
      {
        slug: "sequence-learning-problem",
        translations: {
          en: {
