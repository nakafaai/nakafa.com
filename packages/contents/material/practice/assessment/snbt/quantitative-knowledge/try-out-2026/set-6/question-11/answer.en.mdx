...
**Step** <InlineMath math="1" />: Calculate the actual width of the object. Given the area of the rectangle is <InlineMath math="540\text{ m}^2" /> and the length is <InlineMath math="30\text{ m}" />.
...
**Step** <InlineMath math="2" />: Calculate the width of the miniature using the given ratio. The ratio of miniature size to actual size is <InlineMath math="5 : 2500" /> or <InlineMath math="\frac{5}{2500}" />.
