...
export const practiceAssessmentSnbtReadingAndWritingSkillsMaterial =
  definePracticeMaterial({
    assetRoot: "material/practice/assessment/snbt/reading-and-writing-skills",
    groups: [
      {
    ...
    kind: "practice",
    key: "practice.assessment.snbt.reading-and-writing-skills",
