...
export const practiceAssessmentSnbtGeneralReasoningMaterial =
  definePracticeMaterial({
    assetRoot: "material/practice/assessment/snbt/general-reasoning",
    groups: [
      {
    ...
    kind: "practice",
    key: "practice.assessment.snbt.general-reasoning",
