...
The United Nations uses the term **Sustainable Development Goals (SDGs)** for <InlineMath math="17" /> global goals in the <InlineMath math="2030" /> Agenda. Green chemistry does not replace the SDGs, but it can support some of them because chemistry directly involves materials, energy, water, air, and waste.
