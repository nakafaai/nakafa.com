export const metadata = {
  ...
  description: "Learn how vertical translation moves a function graph up or down while preserving its shape.",
...
Vertical translation is a geometric transformation that shifts the graph of a function up or down along the <InlineMath math="y" />-axis without changing the shape of the graph. Imagine lifting or lowering an object vertically: the shape stays the same, only its position changes.
