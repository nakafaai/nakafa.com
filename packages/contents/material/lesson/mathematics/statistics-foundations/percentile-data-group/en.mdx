...
You're already familiar with [quartiles](/en/subjects/mathematics/statistics-foundations/quartile-data-group), which divide data into <InlineMath math="4" /> equal parts, right? Well, **percentiles** are like quartiles' sibling, but they're even more detailed!
