...
You're already familiar with [quartiles](/material/lesson/mathematics/statistics-foundations/quartile-data-group), which divide data into <InlineMath math="4" /> equal parts, right? Well, **percentiles** are like quartiles' sibling, but they're even more detailed!

If quartiles divide data into <InlineMath math="4" /> chunks, percentiles divide ordered data into <InlineMath math="100" /> equal chunks. That's a lot, huh? Like dividing a chocolate bar into <InlineMath math="100" /> tiny squares.

Each chunk is separated by a percentile value. There are <InlineMath math="99" /> percentile values, starting from <InlineMath math="P_1" />, <InlineMath math="P_2" />, <InlineMath math="P_3" />, ..., up to <InlineMath math="P_{99}" />.

- <InlineMath math="P_{10}" /> (<InlineMath math="10" />th Percentile) means this value separates the smallest
  <InlineMath math="10\%" /> of the data from the remaining <InlineMath math="90\%" />.
- <InlineMath math="P_{50}" /> (<InlineMath math="50" />th Percentile) is exactly the same as the **Median**
...
- <InlineMath math="P_{85}" /> (<InlineMath math="85" />th Percentile) means this value separates the smallest
...
- <InlineMath math="i" /> = Which percentile are we looking for? (e.g., <InlineMath math="10, 50, 85" />)
...
- <InlineMath math="i" /> = Which percentile (e.g., <InlineMath math="10, 85" />)
...
For example, let's say we have the math test scores of <InlineMath math="40 \text{ students}" />:
...
We want to find the value of the <InlineMath math="85" />th Percentile (<InlineMath math="P_{85}" />).
...
Try calculating the value of the <InlineMath math="20" />th Percentile (<InlineMath math="P_{20}" />) from the math test score data above!
...
The <InlineMath math="20" />th Percentile value is <InlineMath math="74.5" />.
