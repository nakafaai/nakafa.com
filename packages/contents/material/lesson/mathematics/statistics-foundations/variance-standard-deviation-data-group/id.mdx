export const metadata = {
  ...
  description: "Pelajari cara menghitung varian dan simpangan baku untuk data berkelompok dengan contoh perhitungan. Pelajari rumus statistika untuk interval kelas data.",
...
Jadi, varian dari data durasi baterai adalah sekitar <InlineMath math="19{,}37" /> (dalam satuan jam kuadrat).
