...
Untuk memahami limit secara lebih konkret, mari kita lihat bagaimana nilai fungsi berubah ketika variabel mendekati suatu titik. Misalkan kita memiliki fungsi <InlineMath math="f(x) = x + 2" /> dan ingin melihat apa yang terjadi ketika <InlineMath math="x" /> mendekati <InlineMath math="3" />.
...
Dari tabel di atas, kita dapat melihat bahwa ketika <InlineMath math="x" /> mendekati <InlineMath math="3" /> dari kiri (nilai <InlineMath math="x < 3" />) maupun kanan (nilai <InlineMath math="x > 3" />), nilai <InlineMath math="f(x)" /> mendekati <InlineMath math="5" />. **Nilai pendekatan inilah yang disebut limit**.
...
Karena kita menghitung limit ketika <InlineMath math="x" /> **mendekati** <InlineMath math="2" /> (bukan **sama dengan** <InlineMath math="2" />), maka <InlineMath math="x \neq 2" /> dan kita dapat membatalkan <InlineMath math="(x - 2)" />:
...
2. **Penyelesaian:**
   ...
   Karena <InlineMath math="x" /> mendekati <InlineMath math="1" /> (bukan sama dengan <InlineMath math="1" />), maka <InlineMath math="x \neq 1" /> dan kita dapat membatalkan <InlineMath math="(x - 1)" />:
...
4. **Penyelesaian:**
   ...
   **Limit kanan** (ketika <InlineMath math="x" /> mendekati <InlineMath math="2" /> dari kanan, maka <InlineMath math="x \geq 2" />):
