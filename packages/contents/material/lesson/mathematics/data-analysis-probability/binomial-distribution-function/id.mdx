export const metadata = {
  ...
  description: "Pelajari rumus distribusi binomial untuk menghitung peluang keberhasilan dalam percobaan berulang dan latihan soal.",
...
**Soal:** Jika kita melempar koin ini <InlineMath math="7\text{ kali}" /> berturut-turut, berapa peluang mendapatkan gambar sebanyak <InlineMath math="5\text{ kali}" />?
...
Jadi, peluang mendapatkan <InlineMath math="5" /> gambar dalam <InlineMath math="7 \text{ kali}" /> lemparan adalah <InlineMath math="\frac{21}{128}" /> atau sekitar <InlineMath math="16{,}4\%" />.

## Latihan

1. Di sebuah kantong ada <InlineMath math="10 \text{ bola}" /> yang sama persis, kecuali warnanya: <InlineMath math="6 \text{ bola}" /> merah dan <InlineMath math="4 \text{ bola}" /> biru. Kalau kita ambil <InlineMath math="5 \text{ bola}" /> satu per satu dengan pengembalian (setiap bola yang diambil dikembalikan lagi), berapa peluang terambilnya tepat <InlineMath math="3 \text{ bola}" /> merah?

2. Seorang pemanah punya tingkat akurasi <InlineMath math="80\%" /> untuk mengenai target. Kalau dia memanah <InlineMath math="6 \text{ kali}" />, berapa peluang dia mengenai target tepat <InlineMath math="4 \text{ kali}" />?
...
1. **Jawaban Soal Bola Merah**
    ...
    **Langkah** <InlineMath math="2" />: Hitung menggunakan rumus distribusi binomial.
    ...
    Jadi, peluang terambilnya tepat <InlineMath math="3 \text{ bola}" /> merah adalah <InlineMath math="0{,}3456" /> atau sekitar <InlineMath math="34{,}6\%" />.
...
2. **Jawaban Soal Pemanah**
    ...
    **Langkah** <InlineMath math="2" />: Hitung menggunakan rumus distribusi binomial.
    ...
    Jadi, peluang pemanah mengenai target tepat <InlineMath math="4 \text{ kali}" /> adalah <InlineMath math="0{,}2458" /> atau sekitar <InlineMath math="24{,}6\%" />.
