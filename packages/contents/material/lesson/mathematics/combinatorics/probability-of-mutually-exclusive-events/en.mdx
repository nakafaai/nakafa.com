export const metadata = {
   ...
   description: "Understand mutually exclusive events in probability, calculate their probabilities, and apply the concept to examples.",
...
**Example <InlineMath math="3" />: Student Characteristics**
