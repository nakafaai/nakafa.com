...
export const metadata = {
  ...
  description: "Learn to construct quadratic functions using three points, vertex form, roots, and symmetry. Learn different methods with worked examples and solutions.",
