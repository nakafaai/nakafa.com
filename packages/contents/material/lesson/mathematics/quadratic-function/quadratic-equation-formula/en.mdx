export const metadata = {
  ...
  description: "Learn the quadratic formula to solve any ax²+bx+c=0 equation. Learn formula derivation, understand the discriminant, and apply to real-world problems.",
