export const metadata = {
  ...
  description: "Pelajari rumus kuadrat untuk menyelesaikan persamaan ax²+bx+c=0. Pelajari penurunan bertahap, pahami diskriminan, dan terapkan pada masalah nyata.",
