...
export const metadata = {
  title: "Rotation",
  description: "Learn geometric rotation transformations with formula practice, examples, and visual guides. Learn to rotate points and lines around the origin.",
