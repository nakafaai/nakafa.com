...
export const metadata = {
  ...
  description: "Explore scalar multiplication effects on complex vectors with interactive visualizations showing stretching, shrinking, and direction reversal.",
...
- Multiplying <InlineMath math="z" /> by a scalar <InlineMath math="c < 0" /> (like <InlineMath math="-0.5" />) will **reverse the direction** of the vector <InlineMath math="z" /> (by <InlineMath math="180^\circ" />) and change its length according to the value of <InlineMath math="|c|" />.
