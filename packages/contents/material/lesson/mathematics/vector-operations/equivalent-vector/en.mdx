...
export const metadata = {
  ...
  description: "Learn equivalent vectors with same magnitude and direction. Learn properties, component representation, and real-world applications in physics and engineering.",
