...
Vector components are values that indicate how far a vector moves in the direction of the <InlineMath math="x" />-axis and <InlineMath math="y" />-axis. Every vector in a plane can be expressed as a linear combination of unit vectors <InlineMath math="i" /> and <InlineMath math="j" />.
...
- <InlineMath math="a" /> is the vector component on the <InlineMath math="x" />-axis (horizontal)
- <InlineMath math="b" /> is the vector component on the <InlineMath math="y" />-axis (vertical)
- <InlineMath math="i" /> is the unit vector in the direction of the <InlineMath math="x" />-axis
- <InlineMath math="j" /> is the unit vector in the direction of the <InlineMath math="y" />-axis
...
This means that vector <InlineMath math="\overrightarrow{AB}" /> has a horizontal component of <InlineMath math="6 \text{ units}" /> to the right and a vertical component of <InlineMath math="8 \text{ units}" /> upward.
...
- <InlineMath math="a" /> is the vector component on the <InlineMath math="x" />-axis
- <InlineMath math="b" /> is the vector component on the <InlineMath math="y" />-axis
- <InlineMath math="c" /> is the vector component on the <InlineMath math="z" />-axis
...
To determine the direction of a vector, we can use a unit vector. A unit vector is a vector with a magnitude of <InlineMath math="1 \text{ unit}" />. To obtain a unit vector from a vector, we divide the vector by its magnitude.
...
For the vector <InlineMath math="\overrightarrow{AB} = 6i + 8j" /> with a magnitude of <InlineMath math="10" />, its unit direction vector is:
