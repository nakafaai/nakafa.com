...
<LineEquation
  ...
  description={
    <>
      Dari titik <InlineMath math="P" /> di luar lingkaran dapat ditarik dua
      garis singgung.
    </>
  }
  data={[
...
4. Dua lingkaran masing-masing berpusat di <InlineMath math="O_1(-4, 0)" /> dengan jari-jari <InlineMath math="2" /> dan <InlineMath math="O_2(4, 0)" /> dengan jari-jari <InlineMath math="3" />. Tentukan panjang garis singgung persekutuan luar!
