export const metadata = {
  ...
  description: "Hitung luas bidang datar menggunakan integral tentu dengan solusi bertahap. Pelajari fungsi kuadrat dan irasional melalui contoh praktis.",
...
Bayangkan kita memiliki fungsi <InlineMath math="f(x)" /> dan ingin mencari luas daerah di bawah kurva dari <InlineMath math="x = a" /> sampai <InlineMath math="x = b" />. Kita dapat membagi interval <InlineMath math="[a, b]" /> menjadi <InlineMath math="n \text{ bagian}" /> kecil dengan lebar <InlineMath math="\Delta x" />.
...
Sekarang, coba perhatikan grafik di atas. Fungsi <InlineMath math="f(x) = x^2 - 4x" /> ternyata memiliki nilai negatif di interval <InlineMath math="[1, 3]" />. Kita bisa cek dengan mudah: ketika <InlineMath math="x = 1" />, kita dapat <InlineMath math="f(1) = 1 - 4 = -3" />. Demikian juga ketika <InlineMath math="x = 3" />, kita dapat <InlineMath math="f(3) = 9 - 12 = -3" />.
...
Jadi, luas daerah tersebut adalah <InlineMath math="\frac{22}{3} \text{ satuan}" /> luas.
...
1. **Soal pertama dengan fungsi <InlineMath math="y = x^2 + 1" />**
   ...
   Jadi, luas daerah tersebut adalah <InlineMath math="\frac{14}{3} \text{ satuan}" /> luas.
...
2. **Soal kedua dengan fungsi rasional**
   ...
   Luas daerah tersebut adalah <InlineMath math="\frac{\pi}{4} \text{ satuan}" /> luas.
...
3. **Soal ketiga dengan parabola**
   ...
   Luas daerah tersebut adalah <InlineMath math="\frac{4}{3} \text{ satuan}" /> luas.
