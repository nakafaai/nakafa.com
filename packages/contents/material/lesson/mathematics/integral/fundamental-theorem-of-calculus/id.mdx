export const metadata = {
    ...
    description: "Pelajari bagaimana Teorema Dasar Kalkulus menghubungkan turunan, integral, dan antiturunan.",
...
Teorema Dasar Kalkulus (TDK) adalah penghubung utama antara dua konsep dalam kalkulus: **turunan** dan **integral**. Teorema ini memberikan cara yang lebih sederhana untuk menghitung integral tentu tanpa harus melalui proses limit Jumlahan Riemann yang panjang. Teorema ini terbagi menjadi dua bagian penting.
