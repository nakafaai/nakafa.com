export const metadata = {
  ...
  description: "Pelajari penjumlahan matriks pada matriks seordo. Pahami sifat komutatif dan asosiatif, lalu selesaikan soal praktis dengan contoh pembahasan.",
