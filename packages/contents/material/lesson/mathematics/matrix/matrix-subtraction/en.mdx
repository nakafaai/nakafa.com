export const metadata = {
  ...
  description: "Learn matrix subtraction with worked examples, properties, and practice problems. Learn subtracting corresponding elements and matrix operations.",
