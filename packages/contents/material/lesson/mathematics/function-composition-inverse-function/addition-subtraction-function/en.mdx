...
export const metadata = {
  ...
  description: "Learn how to add and subtract functions one step at a time with domain intersection rules. Learn function operations through clear examples and practice problems.",
...
2.  <InlineMath math="g(x) = \sqrt{x+2}" />, with domain <InlineMath math="D_g = \{x | x \ge -2, x \in \mathbb{R}\}" /> (all
    real numbers greater than or equal to <InlineMath math="-2" />, because the square root cannot be
    negative).
