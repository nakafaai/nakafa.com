import { FunctionIllustration } from "@repo/design-system/components/contents/mathematics/function/illustration";
import { LineEquation } from "@repo/design-system/components/contents/mathematics/line-equation";
import { getColor } from "@repo/design-system/lib/color";

export const metadata = {
  title: "Inverse Function",
  description: "Learn inverse functions one step at a time: definition, bijective requirements, finding formulas, and graph reflections. Learn f⁻¹(x) with clear examples.",
