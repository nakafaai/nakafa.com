...
export const metadata = {
  ...
  description: "Learn trigonometric function graphs with interactive visualizations. Learn sine, cosine, tangent graphs, amplitude, period, transformations & conversions.",
