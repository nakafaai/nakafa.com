export const metadata = {
  ...
  description: "Learn logarithmic identities including product, quotient, power, and change of base formulas. Solve equations with practical real-world examples.",
...
**Example:** An earthquake that occurred in Haiti in <InlineMath math="2010" /> had an intensity of <InlineMath math="10^7\text{ times}" /> compared to zero-level earthquakes. What is the Richter scale strength of that earthquake?
...
Therefore, the earthquake in Haiti in <InlineMath math="2010" /> had a strength of <InlineMath math="7" /> on the Richter scale.
...
Therefore, the charging time is approximately <InlineMath math="115 \text{ minutes}" />.
...
**Example:** At any given time, the price of a used car is not proportional to its current price. If a new car costs <InlineMath math="200 \text{ million rupiah}" /> and after <InlineMath math="5 \text{ years}" /> becomes <InlineMath math="100 \text{ million rupiah}" />, determine the car's price after <InlineMath math="10 \text{ years}" /> of use.
