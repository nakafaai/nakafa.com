export const metadata = {
  ...
  description: "Pelajari diferensiasi fungsi aljabar menggunakan aturan pangkat, hasil kali, dan hasil bagi. Pelajari cara menurunkan polinomial, akar, dan fungsi rasional.",
