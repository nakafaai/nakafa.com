export const metadata = {
  ...
  description: "Learn differentiation of algebraic functions using power, product, and quotient rules. Learn to differentiate polynomials, radicals, and rational functions.",
