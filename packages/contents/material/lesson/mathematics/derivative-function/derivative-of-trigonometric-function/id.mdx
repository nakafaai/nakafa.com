export const metadata = {
    ...
    description: "Pelajari turunan fungsi trigonometri: sin, cos, tan, dan lainnya. Pelajari rumus, aturan hasil kali, hasil bagi dengan contoh bertahap dan solusi.",
