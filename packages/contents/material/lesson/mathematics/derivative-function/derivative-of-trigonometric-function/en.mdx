export const metadata = {
    ...
    description: "Learn derivatives of trigonometric functions: sin, cos, tan, and more. Learn formulas, product rule, quotient rule with worked examples and solutions.",
