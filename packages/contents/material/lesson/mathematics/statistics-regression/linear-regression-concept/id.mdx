...
Dengan [Diagram Pencar](/material/lesson/mathematics/statistics-regression/scatter-diagram), kita bisa melihat hubungan antara dua variabel, yaitu data <InlineMath math="X" /> dan data <InlineMath math="Y" />.
