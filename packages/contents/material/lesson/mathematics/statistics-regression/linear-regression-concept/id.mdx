...
Dengan [Diagram Pencar](/id/materi/matematika/regresi-statistik/diagram-pencar-atau-diagram-scatter), kita bisa melihat hubungan antara dua variabel, yaitu data <InlineMath math="X" /> dan data <InlineMath math="Y" />.
...
Salah satu kegunaan utamanya adalah untuk **prediksi**. Misalnya, kalau ada siswa baru yang belajar selama <InlineMath math="7 \text{ jam}" />, kita bisa gunakan garis regresi ini untuk memperkirakan berapa kira-kira nilai ujian yang akan dia dapat, meskipun kita tidak punya data pasti untuk <InlineMath math="7 \text{ jam}" />.
...
- <InlineMath math="b" /> adalah **kemiringan (slope)** garis, menunjukkan seberapa
  ...
  .
- <InlineMath math="a" /> adalah **perpotongan sumbu <InlineMath math="y" /> (intercept)**, yaitu nilai
