...
With [Scatter Diagrams](/en/subjects/mathematics/statistics-regression/scatter-diagram), we can see the relationship between two variables, namely <InlineMath math="X" /> data and <InlineMath math="Y" /> data.
