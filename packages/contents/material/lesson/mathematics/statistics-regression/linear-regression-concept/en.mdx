...
With [Scatter Diagrams](/material/lesson/mathematics/statistics-regression/scatter-diagram/en), we can see the relationship between two variables, namely <InlineMath math="X" /> data and <InlineMath math="Y" /> data.
...
- <InlineMath math="\hat{y}" /> (read: y-hat) is the **predicted value of <InlineMath math="y" />** by
  the regression line.
...
- <InlineMath math="a" /> is the **<InlineMath math="y" />-intercept**, which is the predicted value of <InlineMath math="\hat{y}" /> when <InlineMath math="x = 0" />
  .
