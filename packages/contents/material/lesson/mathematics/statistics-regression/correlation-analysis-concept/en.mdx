export const metadata = {
  ...
  description: "Learn how correlation analysis measures relationships between variables, including Pearson's r and why correlation is not causation.",
...
2.  **Strength of the Relationship:**
    - How close the value of <InlineMath math="r" /> is to <InlineMath math="+1" /> or <InlineMath math="-1" /> indicates how strong the linear relationship is. The closer to <InlineMath math="+1" /> or <InlineMath math="-1" />, the stronger the relationship (the data points cluster more closely around a straight line).
    - If the value of <InlineMath math="r" /> is close to <InlineMath math="0" />, it means the linear relationship is **weak** or even **non-existent** (the data points are scattered randomly).

**Range of <InlineMath math="r" /> Values:**
The value of the correlation coefficient always lies between <InlineMath math="-1" /> and <InlineMath math="+1" />.
...
For example, if <InlineMath math="r = 0.8" /> between study hours and exam scores, then <InlineMath math="r^2 = (0.8)^2 = 0.64" />. This means about <InlineMath math="64\%" /> of the variation in students' exam scores _can be explained_ by the differences in their study hours. The rest (<InlineMath math="36\%" />) might be influenced by other factors (intelligence, study methods, etc.).

The value of <InlineMath math="r^2" /> is always between <InlineMath math="0" /> and <InlineMath math="1" />.

<BlockMath math="0 \le r^2 \le 1" />

The closer <InlineMath math="r^2" /> is to <InlineMath math="1" />, the better variable <InlineMath math="X" /> explains the variation in variable <InlineMath math="Y" />.
