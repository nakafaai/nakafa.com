import TableChairsAnimation from "@repo/design-system/components/contents/mathematics/sequence/animation";
...
When there is <InlineMath math="1" /> square table, <InlineMath math="4" /> chairs can be placed around it.
...
- When there is <InlineMath math="1" /> table, there are <InlineMath math="4" /> chairs
...
When observed, each addition of <InlineMath math="1" /> table results in an addition of <InlineMath math="2" /> chairs. This forms a number pattern with the formula:
