export const metadata = {
  ...
  description: "Pelajari garis singgung parabola, elips, dan hiperbola dengan prinsip bagi adil. Temukan persamaan untuk titik pada kurva, gradien tertentu, dan titik luar.",
