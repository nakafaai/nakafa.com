export const metadata = {
  title: "Parabola",
  description: "Learn parabola equations, vertex, focus, and directrix. Learn standard forms, real-world applications, and solve problems one step at a time with examples.",
