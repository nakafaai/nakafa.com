export const metadata = {
  ...
  description: "Learn circle fundamentals such as center, radius, and equations, then derive (x-a)² + (y-b)² = r² with examples.",
...
In the visualization above, point <InlineMath math="P" /> is the center of the circle, while points <InlineMath math="A" />, <InlineMath math="B" />, and <InlineMath math="C" /> are some points that lie on the circle. Notice that the distance from <InlineMath math="P" /> to <InlineMath math="A" />, <InlineMath math="P" /> to <InlineMath math="B" />, and <InlineMath math="P" /> to <InlineMath math="C" /> are all equal to <InlineMath math="r" />. This is what makes them all lie on the same circle.
...
Where <InlineMath math="d(P, (x,y))" /> is the distance from the center point <InlineMath math="P" /> to the point <InlineMath math="(x, y)" /> on the circle.
