export const metadata = {
  ...
  description: "Learn tangent lines to circles: find equations through points, with given slopes, and from external points. Interactive examples and worked solutions.",
