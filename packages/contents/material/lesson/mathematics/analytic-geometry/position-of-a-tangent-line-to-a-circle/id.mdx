export const metadata = {
  ...
  description: "Pelajari cara menentukan persamaan garis singgung lingkaran melalui titik, dengan gradien tertentu, dan dari titik luar. Visualisasi interaktif dan contoh.",
...
**Langkah** <InlineMath math="1" />: Tentukan persamaan garis kutub titik <InlineMath math="B(2, 6)" /> terhadap lingkaran:
