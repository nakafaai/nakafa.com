...
Imagine the following scenario: Someone carries a virus and infects <InlineMath math="3" /> other people. Then, each of those people infects <InlineMath math="3" /> more people in the next phase.

### Spread Pattern

If we track the number of infected people in each phase:

- **Phase** <InlineMath math="1" />: <InlineMath math="3 = 3^1 \text{ people}" /> infected
- **Phase** <InlineMath math="2" />: <InlineMath math="9 = 3^2 \text{ people}" /> infected
- **Phase** <InlineMath math="3" />: <InlineMath math="27 = 3^3 \text{ people}" /> infected
- **Phase** <InlineMath math="4" />: <InlineMath math="81 = 3^4 \text{ people}" /> infected
- **Phase** <InlineMath math="5" />: <InlineMath math="243 = 3^5 \text{ people}" /> infected
...
1. How many people will be infected in phase <InlineMath math="20" />?
...
3. **Intercept Point**: Always passes through point <InlineMath math="(0, 1)" /> because <InlineMath math="a^0 = 1" />.
4. **Graph Properties**:
