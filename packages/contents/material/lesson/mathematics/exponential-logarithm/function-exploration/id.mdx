import { VirusChart } from "@repo/design-system/components/contents/mathematics/exponential/virus-chart";

export const metadata = {
  title: "Eksplorasi Fungsi",
  description: "Pelajari fungsi eksponen melalui contoh penyebaran virus, lalu bandingkan pertumbuhan eksponensial dan linear dengan grafik.",
...
Bayangkan situasi berikut: Seseorang membawa virus dan menulari <InlineMath math="3 \text{ orang}" /> lainnya. Kemudian, setiap orang tersebut menulari <InlineMath math="3 \text{ orang}" /> lainnya lagi pada fase berikutnya.

### Pola Penyebaran

Jika kita melacak jumlah orang yang tertular pada setiap fase:

- **Fase** <InlineMath math="1" />: <InlineMath math="3 = 3^1 \text{ orang}" /> tertular
- **Fase** <InlineMath math="2" />: <InlineMath math="9 = 3^2 \text{ orang}" /> tertular
- **Fase** <InlineMath math="3" />: <InlineMath math="27 = 3^3 \text{ orang}" /> tertular
- **Fase** <InlineMath math="4" />: <InlineMath math="81 = 3^4 \text{ orang}" /> tertular
- **Fase** <InlineMath math="5" />: <InlineMath math="243 = 3^5 \text{ orang}" /> tertular
...
1. Berapakah jumlah orang yang tertular pada fase ke-<InlineMath math="20" />?
...
3. **Titik Potong**: Selalu melalui titik <InlineMath math="(0, 1)" /> karena <InlineMath math="a^0 = 1" />.
4. **Sifat Grafik**:
