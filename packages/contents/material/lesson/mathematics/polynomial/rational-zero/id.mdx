...
Setelah mengetahui [Teorema Faktor](/id/materi/matematika/polinomial/teorema-faktor), kita tahu bahwa mencari faktor <InlineMath math="(x-c)" /> sama saja dengan mencari pembuat nol (akar) <InlineMath math="c" /> dari polinomial <InlineMath math="P(x)" />. Namun, bagaimana cara kita menemukan nilai <InlineMath math="c" /> tersebut, terutama jika polinomialnya berderajat tinggi?
