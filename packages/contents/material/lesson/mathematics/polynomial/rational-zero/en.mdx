export const metadata = {
  ...
  description: "Learn the Rational Zero Theorem to find polynomial roots and use candidates to factor high-degree polynomials.",
...
After learning about the [Factor Theorem](/material/lesson/mathematics/polynomial/factor-theorem), we know that finding a factor <InlineMath math="(x-c)" /> is the same as finding a zero (root) <InlineMath math="c" /> of the polynomial <InlineMath math="P(x)" />. But how do we find the value of <InlineMath math="c" />, especially if the polynomial has a high degree?
...
2.  **Factors of <InlineMath math="p" /> (from <InlineMath math="20" />):** <InlineMath math="\pm 1, \pm 2, \pm 4, \pm 5, \pm 10, \pm 20" />.
3.  **Factors of <InlineMath math="q" /> (from <InlineMath math="2" />):** <InlineMath math="\pm 1, \pm 2" />.
