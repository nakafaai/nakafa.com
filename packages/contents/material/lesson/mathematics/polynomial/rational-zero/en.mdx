...
After learning about the [Factor Theorem](/en/subjects/mathematics/polynomial/factor-theorem), we know that finding a factor <InlineMath math="(x-c)" /> is the same as finding a zero (root) <InlineMath math="c" /> of the polynomial <InlineMath math="P(x)" />. But how do we find the value of <InlineMath math="c" />, especially if the polynomial has a high degree?
