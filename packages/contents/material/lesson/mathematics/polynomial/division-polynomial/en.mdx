...
- <InlineMath math="\frac{7}{4}" /> can be written as <InlineMath math="1 \frac{3}{4}" /> (<InlineMath math="1" />
  remainder <InlineMath math="3" />)
...
Note that the degree of the remainder (<InlineMath math="S(x)=2" />, degree <InlineMath math="0" />) is less than the degree of the divisor (<InlineMath math="x+3" />, degree <InlineMath math="1" />).
