...
- <InlineMath math="\frac{7}{4}" /> dapat ditulis sebagai <InlineMath math="1 \frac{3}{4}" /> (<InlineMath math="1" />
  sisa <InlineMath math="3" />)
...
Perhatikan bahwa derajat sisa (<InlineMath math="S(x)=2" />, derajat <InlineMath math="0" />) lebih rendah dari derajat pembagi (<InlineMath math="x+3" />, derajat <InlineMath math="1" />).
