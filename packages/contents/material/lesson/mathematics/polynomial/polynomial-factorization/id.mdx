export const metadata = {
  ...
  description: "Pelajari faktorisasi penuh polinomial menjadi faktor linier menggunakan bilangan kompleks. Pelajari cara mencari semua akar dan Teorema Fundamental Aljabar.",
...
Kita telah belajar memfaktorkan polinomial, misalnya menggunakan [Teorema Faktor](/material/lesson/mathematics/polynomial/factor-theorem). Namun, terkadang hasil pemfaktoran masih menyisakan faktor yang bukan linier (seperti faktor kuadrat) yang tidak dapat difaktorkan lebih lanjut menggunakan bilangan real.
