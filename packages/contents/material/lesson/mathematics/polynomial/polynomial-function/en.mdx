export const metadata = {
  ...
  description: "Learn polynomial functions: understand P(x) notation, identify leading terms, coefficients, and degrees. Learn function components with clear examples.",
