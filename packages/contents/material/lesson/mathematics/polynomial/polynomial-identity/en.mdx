export const metadata = {
  ...
  description: "Explore key polynomial identities like binomial squares and sum of cubes. Learn these formulas to simplify expressions and solve equations efficiently.",
