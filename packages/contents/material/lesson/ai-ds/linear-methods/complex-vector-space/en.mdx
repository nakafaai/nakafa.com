export const metadata = {
    ...
    description: "Learn complex vector spaces with complex numbers, fundamental theorem of algebra, and 8 essential axioms. Learn AI linear methods one step at a time.",
...
The main difference lies in the **scalar field** used. Real vector spaces use <InlineMath math="\mathbb{R}" /> as the scalar field, whereas complex vector spaces use <InlineMath math="\mathbb{C}" /> which provides more flexibility in calculations.
