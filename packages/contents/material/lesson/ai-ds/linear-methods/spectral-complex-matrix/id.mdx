export const metadata = {
   ...
   description: "Pelajari diagonalisasi ortogonal matriks normal: buktikan ekuivalensi antara normalitas dan basis vektor eigen menggunakan induksi matematis.",
