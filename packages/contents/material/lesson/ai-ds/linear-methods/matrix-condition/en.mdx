export const metadata = {
    ...
    description: "Learn matrix norms, condition numbers, and numerical stability. Study spectral radius, eigenvalue analysis, and error estimation for AI systems.",
...
A more specific result applies to the **spectral norm** or <InlineMath math="2" />-norm of matrices. For symmetric matrices <InlineMath math="A \in \mathbb{R}^{n \times n}" />, the spectral norm equals the spectral radius:
