...
Hasil yang lebih spesifik berlaku untuk **norma spektral** atau norma <InlineMath math="2" /> matriks. Untuk matriks simetris <InlineMath math="A \in \mathbb{R}^{n \times n}" />, norma spektral sama dengan spektralradius:
