export const metadata = {
    ...
    description: "Pelajari algoritma iteratif nilai eigen untuk masalah nonlinear. Pelajari metode nilai eigen dominan, diagonalisasi, dan pendekatan komputasi untuk AI.",
