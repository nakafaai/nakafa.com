...
Untuk matriks positif definit, ada sifat khusus yang membuat dekomposisi menjadi lebih sederhana. [Dekomposisi LU](/material/lesson/ai-ds/linear-methods/lu-decomposition) dapat dilakukan tanpa menggunakan matriks permutasi <InlineMath math="P" /> karena eliminasi Gauss dapat berjalan tanpa pertukaran baris, dan semua elemen pivot yang dihasilkan dijamin positif.
