...
| **Float** | `float16` | Half-precision float | <InlineMath math="5 \text{ bit exponent}" />, <InlineMath math="10 \text{ bit mantissa}" /> |
| | `float32` | Single-precision float | <InlineMath math="8 \text{ bit exponent}" />, <InlineMath math="23 \text{ bit mantissa}" /> |
| | `float64` | Double-precision float | <InlineMath math="11 \text{ bit exponent}" />, <InlineMath math="52 \text{ bit mantissa}" /> |
