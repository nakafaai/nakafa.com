...
simultaneously every <InlineMath math="5 \text{ years}" />, including the election of the President, Vice President, members of the Regional
...
Gibran, the son of President Joko Widodo, was under <InlineMath math="40 \text{ years old}" /> when he was nominated. This situation sparked
...
previous threshold of <InlineMath math="20\%" /> of DPRD seats or <InlineMath math="25\%" /> of votes did not allow sufficient opportunity for
...
| Regulation Category | Election Law | Constitutional Court Decision | DPR Decision |
| --- | --- | --- | --- |
| Candidacy Threshold | <InlineMath math="20\%" /> of DPRD seats or <InlineMath math="25\%" /> of valid votes | <InlineMath math="6.5\%\text{-}10\%" /> based on population | Only applies to parties without DPRD seats |
| Governor Age Requirement | Minimum <InlineMath math="30 \text{ years}" /> old | At least <InlineMath math="30 \text{ years}" /> when registered as candidate | At least <InlineMath math="30 \text{ years}" /> when appointed |
| Regent/Mayor Age Requirement | Minimum <InlineMath math="25 \text{ years}" /> old | At least <InlineMath math="25 \text{ years}" /> when registered as candidate | At least <InlineMath math="25 \text{ years}" /> when appointed |
...
or Political Party Coalitions can register Candidates if they have obtained at least <InlineMath math="20\%" /> of the DPRD seats
or <InlineMath math="25\%" /> of the total valid votes in the DPRD elections in the relevant area. The first paragraph of Article
...
- Provinces with up to two million registered voters, political parties, or political party
  coalitions must obtain at least <InlineMath math="10\%" /> of valid votes in that province.
- Provinces with more than two million but up to six million registered voters, political parties,
  or political party coalitions must obtain at least <InlineMath math="8.5\%" /> of valid votes in that province.
- Provinces with more than six million but up to twelve million registered voters, political
  parties, or political party coalitions must obtain at least <InlineMath math="7.5\%" /> of valid votes in that province.
- Provinces with more than twelve million registered voters, political parties, or political
  party coalitions must obtain at least <InlineMath math="6.5\%" /> of valid votes in that province.

**To propose candidates for regent and deputy regent or mayor and deputy mayor**

- Districts/cities with up to <InlineMath math="250{,}000" /> registered voters, political parties, or political party
  coalitions must obtain at least <InlineMath math="10\%" /> of valid votes in that district/city.
- Districts/cities with more than <InlineMath math="250{,}000" /> but up to <InlineMath math="500{,}000" /> registered voters, political parties,
  or political party coalitions must obtain at least <InlineMath math="8.5\%" /> of valid votes in that district/city.
- Districts/cities with more than <InlineMath math="500{,}000" /> but up to one million registered voters, political parties,
  or political party coalitions must obtain at least <InlineMath math="7.5\%" /> of valid votes in that district/city.
- Districts/cities with more than one million registered voters, political parties, or political
  party coalitions must obtain at least <InlineMath math="6.5\%" /> of valid votes in that district/city.
...
stipulates that the minimum age for selected candidates must be <InlineMath math="30 \text{ years}" /> for governor and deputy
governor candidates, <InlineMath math="25 \text{ years}" /> for regent and deputy regent candidates, and <InlineMath math="30 \text{ years}" /> for mayor and
...
is <InlineMath math="30 \text{ years}" /> for governor and deputy governor candidates and <InlineMath math="25 \text{ years}" /> for regent and deputy regent
