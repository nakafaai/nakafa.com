...
export const tableData = [
  {
    ...
    electionLaw: (
      <>
        <InlineMath math="20\%" /> of DPRD seats or <InlineMath math="25\%" /> of valid votes
      </>
    ),
    courtDecision: (
      <>
        <InlineMath math="6.5\%\text{-}10\%" /> based on population
      </>
    ),
  ...
  },
  {
    ...
    electionLaw: <>Minimum <InlineMath math="30 \text{ years}" /> old</>,
    courtDecision: <>At least <InlineMath math="30 \text{ years}" /> when registered as candidate</>,
    dprDecision: <>At least <InlineMath math="30 \text{ years}" /> when appointed</>,
  },
  {
    category: "Regent/Mayor Age Requirement",
    electionLaw: <>Minimum <InlineMath math="25 \text{ years}" /> old</>,
    courtDecision: <>At least <InlineMath math="25 \text{ years}" /> when registered as candidate</>,
    dprDecision: <>At least <InlineMath math="25 \text{ years}" /> when appointed</>,
  },
];
