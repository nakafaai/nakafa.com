...
export const metadata = {
  ...
  description:
    "Analysis of pork barrel politics, social assistance budgets, and how public programs can be used to maintain electoral power in Indonesia.",
  authors: [
    {
...
John Ferejohn's research (Wilk, 2010), there are <InlineMath math="3" /> reasons underlying this statement. First, using pork
...
budget for social assistance in January 2024, reaching <InlineMath math="\text{Rp }12.45" /> trillion. The realization of social
assistance expenditures includes: (1) distribution of conditional cash transfers (PKH) to <InlineMath math="9.2 \text{ million}" />
Beneficiary Families (KPM); (2) distribution of assistance through the staple food card program to <InlineMath math="18.5 \text{ million}" />
KPM; (3) distribution of premium assistance to <InlineMath math="96.7 \text{ million}" /> participants of the National
Health Insurance (JKN) Premium Assistance Program; and (4) distribution of assistance through the
Smart Indonesia Program (PIP) for <InlineMath math="4{,}000" /> students and the Smart Indonesia Card (KIP) for <InlineMath math="4{,}000" />
...
Central Java region, with a total expenditure of <InlineMath math="13.2 \text{ million}" />. Therefore, a series of policies undertaken
...
Jokowi's electability showed a more stable trend, ranging from <InlineMath math="50\text{-}60\%" />, while Prabowo Subianto's electability
was still below Jokowi's, ranging from <InlineMath math="30\text{-}35\%" />. The high electability of Jokowi ahead of the 2019 presidential
...
the increase in the social protection budget to <InlineMath math="496 \text{ trillion rupiah}" /> in November 2023 (Kemenkeu RI, 2024a).
...
## Public Oversight of Social Assistance
...
practical tool for gathering votes. Social assistance, which is the main instrument in this pork barrel
