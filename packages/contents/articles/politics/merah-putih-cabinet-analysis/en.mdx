...
the 2024-2029 Period outlines the composition of the Merah Putih Cabinet, consisting of <InlineMath math="53" /> ministers
and officials with ministerial rank, including <InlineMath math="7" /> coordinating ministers; <InlineMath math="41" /> ministers; and <InlineMath math="5" />
officials with ministerial rank, as well as <InlineMath math="56" /> deputy ministers (Cabinet Secretariat of the Republic
of Indonesia, 2024).
...
in response to Prabowo's invitation. A total of <InlineMath math="49" /> people met Prabowo from afternoon until night to
...
<ContentGrid>
  <CabinetChart
    ...
    footnote={
      <>
        The Merah Putih cabinet is the largest cabinet in Indonesia's history, with <InlineMath math="48" /> ministers.
      </>
    }
    labels={{
      cabinet: "Cabinet",
  ...
  <CompositionChart
    ...
    labels={{
      ...
      nonPoliticians: "Non Politicians",
    }}
  />
</ContentGrid>
...
A significant issue is that Prabowo did not use state resources to conduct thorough background
checks on candidates, resulting in at least <InlineMath math="18" /> ministers and deputy ministers with negative records
...
approximately <InlineMath math="60\%\text{-}70\%" /> of it consists of professionals and experts, with the remainder coming from
