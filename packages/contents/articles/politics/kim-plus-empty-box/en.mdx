...
export const metadata = {
  ...
  description:
    "How KIM Plus used an independent-candidate scenario in Jakarta's 2024 regional election, despite survey support for other names.",
  authors: [
    {
...
is Anies Baswedan, with <InlineMath math="39.7\%" /> of the votes. He is followed by Ahok with <InlineMath math="23.8\%" />, and Ridwan Kamil with <InlineMath math="13.1\%" />.
...
<ElectabilityChart
  ...
  footnote={<>Anies Baswedan has a survey result more than <InlineMath math="3 \text{ times}" /> higher than Ridwan Kamil.</>}
  labels={{
...
upcoming Jakarta Governor Election. With the support of <InlineMath math="12" /> political parties, this coalition provides
...
participating in the 2024 Regional Election. With only <InlineMath math="10" /> legislative seats, PKB was unable to independently
...
due to the <InlineMath math="25\%" /> candidacy threshold for regional head elections through political parties
...
electability not even reaching <InlineMath math="1\%" /> despite meeting the necessary qualifications (Metro TV, 2024b).
...
ID misuse involved less than <InlineMath math="1\%" /> of the total support they received, and they remained confident about
