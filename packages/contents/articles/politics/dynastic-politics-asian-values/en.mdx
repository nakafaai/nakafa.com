...
Asian values tend to have a strong belief in family status in leading the government with <InlineMath math="5" /> principal
...
<InlineMath math="8" /> points related to family, respect for hierarchical order, hard work, consensus, commitment to education,
...
findings from Formappi (Forum Masyarakat Peduli Parlemen Indonesia) revealed that <InlineMath math="50" /> legislative candidates have
...
at least <InlineMath math="10" /> regional head candidates come from political families. These include Zita Anjani, the daughter of the Chairman
...
Regent of Bangkalan. In the 2020 Pilkada, there were <InlineMath math="16" /> candidates from dynastic politics out of <InlineMath math="270" /> electoral
regions, with details of <InlineMath math="9" /> provinces, <InlineMath math="224" /> regencies, and <InlineMath math="37" /> cities (Dairani, 2024). These numbers prove the
...
## What Voters and Parties Can Do
...
of family members in office during election campaigns, including disqualification if they use or benefit from state
