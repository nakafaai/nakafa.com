...
<StateTable
  ...
  labels={{
    country: "Country",
    judicialEfficiencyIndex: "Judicial Efficiency Index",
    corruptionIndex: "Corruption Index",
    goodGovernanceIndex: "Good Governance Index",
    governanceQualityCategory: "Governance Quality Category",
    good: "Good",
    medium: "Medium",
    low: "Low",
  }}
...
limit for presidential and vice-presidential candidates is at least <InlineMath math="40 \text{ years old}" /> has drawn criticism
...
being under <InlineMath math="40 \text{ years old}" />. This decision shows the tendency of dynastic politics, because it involves policies
