...
<StateTable 
  ...
  labels={{
    country: "Negara",
    judicialEfficiencyIndex: "Indeks Efisiensi Peradilan",
    corruptionIndex: "Indeks Korupsi",
    goodGovernanceIndex: "Indeks Tata Kelola yang Baik",
    governanceQualityCategory: "Kategori Kualitas Tata Kelola",
    good: "Baik",
    medium: "Sedang",
    low: "Rendah"
  }}
