...
import { Stage } from "@repo/design-system/components/contents/politics/nepotism/stage";
...
<StateTable
  ...
  labels={{
    country: "Negara",
    judicialEfficiencyIndex: "Indeks Efisiensi Hukum",
    corruptionIndex: "Indeks Kekorupan",
    goodGovernanceIndex: "Indeks Good Governance",
    governanceQualityCategory: "Kategori Kualitas Good Governance",
    good: "Baik",
    medium: "Sedang",
    low: "Rendah",
  }}
...
Sebelum membahas lebih lanjut tentang politik dinasti, perlu dipahami bahwa fenomena ini
...
calon presiden dan wakil presiden minimal <InlineMath math="40 \text{ tahun}" /> telah menuai kritik
...
berusia di bawah <InlineMath math="40 \text{ tahun}" />. Keputusan ini menunjukkan kecenderungan politik dinasti, karena melibatkan kebijakan
