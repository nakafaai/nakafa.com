...
/** Maximum rows returned by one curriculum relationship query. */
export const PROGRAM_RELATED_LIMIT = 100;

/** Maximum material projections returned by one curriculum route. */
export const PROGRAM_MATERIAL_LIMIT = 256;
