...
import { cleanupReceiptValidator } from "@repo/backend/convex/contentRelease/spec";
...
const cleanupProgram = Effect.fn("contentRelease.cleanup")(function* (
  ...
  const exhausted = rows.length < MAX_CLEANUP_PAGE_COUNT;
