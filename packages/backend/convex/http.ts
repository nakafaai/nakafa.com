...
import { registerPredecessorContentRuntimeRoute } from "@repo/backend/convex/contentRelease/http/runtime/predecessor";
...
registerPredecessorContentRuntimeRoute(app);
