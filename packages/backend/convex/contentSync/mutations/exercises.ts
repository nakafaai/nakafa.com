...
export const deleteStaleExerciseQuestions = registeredFunctions.contentSync.mutations.exercises.deleteStaleExerciseQuestions;
export const deleteStaleExerciseSets = registeredFunctions.contentSync.mutations.exercises.deleteStaleExerciseSets;
