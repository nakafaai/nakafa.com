...
export declare const internal: {
  ...
  contentRelease: {
    ...
    adoption: {
      ...
      >;
      internal: {
        artifacts: FunctionReference<
          "query",
          "internal",
          { nextHash: string; priorHash: string },
          {
            next: {
              _creationTime: number;
              _id: Id<"contentArtifacts">;
              artifactHash: string;
              artifactJson: string;
              createdAt: number;
              retainUntil: number;
        ...
        commit: FunctionReference<
          ...
          "internal",
          {
            artifacts: Array<{ artifactHash: string; jsonHash: string }>;
            candidateManifestHash: string;
            candidateReleaseId: string;
            expectedHistoryHash: string;
            newBundleHash: string;
          ...
          },
          {
            history: {
              entries: Array<{
                ...
                placements: Array<{
                  _creationTime: number;
                  _id: Id<"tryoutAttemptPlacements">;
                  answerArtifactHash: string;
                  answerContentKey: string;
                  contentHash: string;
                ...
                responses: Array<{
                  ...
                  timeSpent: number;
                  tryoutAttemptId: Id<"tryoutAttempts">;
                  tryoutSectionAttemptId: Id<"tryoutSectionAttempts">;
                  updatedAt: number;
                }>;
                scores: Array<{
                  _creationTime: number;
              ...
              scaleEntries: Array<{
                items: Array<{
                  _creationTime: number;
                  _id: Id<"irtScaleItems">;
                  calibrationRunId: Id<"irtCalibrationRuns">;
                  calibrationStatus: "provisional" | "emerging" | "calibrated";
                  correctRate: number;
                  difficulty: number;
            ...
            placements: Array<{
              next: {
                _creationTime: number;
                _id: Id<"tryoutPlacements">;
                answerArtifactHash: string;
                answerArtifactLocale: "en" | "id" | "de";
                appLocale: "en" | "id" | "de";
                contentHash: string;
                countryKey: string;
                deliveryLanguage: "en" | "id" | "de";
                examKey: string;
                identity: string;
                index: number;
                questionArtifactHash: string;
                questionArtifactLocale: "en" | "id" | "de";
                questionOrder: number;
                rowHash: string;
                rowJson: string;
                sectionKey: string;
            ...
            release: {
              _creationTime: number;
              _id: Id<"contentReleases">;
              abortedAt?: number;
              abortedRows?: number;
              abortingAt?: number;
              baseFamilies: Array<"article" | "material" | "page" | "question">;
              checkedIndex: number;
              checkedItems: number;
              cleanupAt?: number;
              cleanupDeletedArtifacts?: number;
              cleanupFutureAt?: number;
              cleanupHash?: string;
              cleanupRetryAt?: number;
              completedAt?: number;
              createdAt: number;
              proofAt?: number;
              proofFailure?: "canceled" | "failed";
              proofJson?: string;
              proofWorkflowId?: string;
              receiptJson?: string;
              releaseId: string;
              releaseJson: string;
              rendererJson: string;
              resultFamilies: Array<
                "article" | "material" | "page" | "question"
              >;
              ...
              status:
                ...
                | "aborting"
                | "aborted";
              tryoutRuntimeBundleHash?: string;
