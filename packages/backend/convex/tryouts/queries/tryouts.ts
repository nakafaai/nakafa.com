...
export const getPublicActiveTryoutCatalogSnapshot = registeredFunctions.tryouts.queries.tryouts.getPublicActiveTryoutCatalogSnapshot;
export const getTryoutDetails = registeredFunctions.tryouts.queries.tryouts.getTryoutDetails;
