...
const tables = {
   ...
   * URL structure: /assessment/{category}/{type}/{material}/{exerciseType}/{year?}/{setName}/{number}
  ...
  exerciseQuestions: defineTable({
    ...
    /** Full URL path: "material/practice/assessment/tka/mathematics/try-out-2026/set-1/question-12" */
    slug: v.string(),
