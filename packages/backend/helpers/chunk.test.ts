...
describe("chunk", () => {
  ...
  describe("chunkScript", () => {
    it.effect("should return single chunk for short text", () =>
      Effect.sync(() => {
    ...
    it.effect("should respect character limit", () =>
      Effect.sync(() => {
        const maxLength =
    ...
    it.effect("should split at paragraph boundaries when possible", () =>
      Effect.sync(() => {
    ...
    it.effect("should split long sentences at word boundaries", () =>
      Effect.sync(() => {
        const maxLength =
          DEFAULT_CHUNK_CONFIG.maxRequestChars -
          DEFAULT_CHUNK_CONFIG.safetyMargin;
    ...
    it.effect("should handle empty script", () =>
      Effect.sync(() => {
    ...
    it.effect("should handle script with only whitespace", () =>
      Effect.sync(() => {
        const result = chunkScript("   \n\n   ");
    ...
    it.effect("should set correct index and totalChunks", () =>
      Effect.sync(() => {
        const maxLength =
          DEFAULT_CHUNK_CONFIG.maxRequestChars -
          DEFAULT_CHUNK_CONFIG.safetyMargin;
    ...
    it.effect("should work with custom config", () =>
      Effect.sync(() => {
        const customConfig = {
  ...
  describe("edge cases for 100% coverage", () => {
    it.effect("should handle text without sentence punctuation", () =>
      Effect.sync(() => {
    ...
    it.effect("should handle empty string input", () =>
      Effect.sync(() => {
    ...
    it.effect("should handle multiple empty paragraphs", () =>
      Effect.sync(() => {
    ...
    it.effect("should handle single character words", () =>
      Effect.sync(() => {
    ...
    it.effect(
      "should handle ternary branch when currentChunk is empty in splitSentenceAtWords",
      () =>
        Effect.sync(() => {
    ...
    it.effect(
      "should handle ternary branch when currentChunk has content in splitSentenceAtWords",
      () =>
        Effect.sync(() => {
          // Tests line 73: currentChunk ? ` ${word}` : word
  ...
  describe("integration scenarios", () => {
    it.effect("should handle realistic podcast script", () =>
      Effect.sync(() => {
        const script = `
...
These concepts might seem strange, but they're backed by decades of experimental evidence and form the foundation of modern technologies like lasers, transistors, and quantum computers.
    ...
    it.effect("should maintain audio tags integrity", () =>
      Effect.sync(() => {
        const script = `
...
[excited] Let's dive in!
    ...
    it.effect("should handle real educational script", () =>
      Effect.sync(() => {
...
[exhales] It sounds a bit technical... but it's just a recipe for perfect roundness!`;
    ...
    it.effect("should handle consecutive short paragraphs", () =>
      Effect.sync(() => {
    ...
    it.effect("should handle paragraphs with mixed content lengths", () =>
      Effect.sync(() => {
        const maxLength =
          DEFAULT_CHUNK_CONFIG.maxRequestChars -
          DEFAULT_CHUNK_CONFIG.safetyMargin;
    ...
    it.effect(
      "should push current chunk when sentence doesn't fit and start new chunk with next sentence",
      () =>
        Effect.sync(() => {
    ...
    it.effect(
      "should handle sentence that fits in new chunk after pushing current chunk",
      () =>
        Effect.sync(() => {
    ...
    it.effect(
      "should accumulate multiple short sentences that together exceed limit",
      () =>
        Effect.sync(() => {
    ...
    it.effect("should handle exact boundary where sentence would exceed", () =>
      Effect.sync(() => {
    ...
    it.effect("should hit line 115 branch where remaining is empty", () =>
      Effect.sync(() => {
    ...
    it.effect("should hit line 121 where currentChunk is empty", () =>
      Effect.sync(() => {
    ...
    it.effect(
      "should handle text with trailing content without punctuation",
      () =>
        Effect.sync(() => {
    ...
    it.effect(
      "should handle long first sentence that exceeds chunk with empty currentChunk",
      () =>
        Effect.sync(() => {
    ...
    it.effect("should handle single word longer than chunk limit", () =>
      Effect.sync(() => {
    ...
    it.effect(
      "should handle word that exceeds limit when currentChunk is empty",
      () =>
        Effect.sync(() => {
    ...
    it.effect(
      "should handle multiple words where middle word exceeds limit alone",
      () =>
        Effect.sync(() => {
    ...
    it.effect("should handle multiple long words that don't fit together", () =>
      Effect.sync(() => {
    ...
    it.effect("should handle empty result from processParagraphs", () =>
      Effect.sync(() => {
    ...
    it.effect(
      "should push remaining content after processing all paragraphs",
      () =>
        Effect.sync(() => {
    ...
    it.effect(
      "should handle paragraphs where all content gets pushed leaving no remainder",
      () =>
        Effect.sync(() => {
          const customConfig = { maxRequestChars: 30, safetyMargin: 5 };
    ...
    it.effect(
      "should never push whitespace-only chunks that trim to empty",
      () =>
        Effect.sync(() => {
    ...
    it.effect("should filter out empty chunks at final push", () =>
      Effect.sync(() => {
    ...
    it.effect("should cover false branch when finalChunk is empty", () =>
      Effect.sync(() => {
    ...
    it.effect(
      "should never push empty chunks when all content is processed in paragraphs",
      () =>
        Effect.sync(() => {
    ...
    it.effect(
      "should handle edge case where last paragraph pushes all content via sentences",
      () =>
        Effect.sync(() => {
