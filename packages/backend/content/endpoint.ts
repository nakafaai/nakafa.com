...
/** Temporary current endpoint removed after controlled clients switch and its marker is quiet. */
export const TRANSITION_PUBLIC_CONTENT_RUNTIME_PATH = `${CONTENT_RUNTIME_PATH}/v2`;

/** Temporary current batch endpoint removed after controlled clients switch and its marker is quiet. */
