...
export const bulkSyncAuthors = Effect.fnUntraced(function* (args: {
...
export const deleteUnusedAuthors = Effect.fnUntraced(function* (args: {
  readonly authorIds: readonly Id<"authors">[];
}) {
  const reader = yield* DatabaseReader;
  const writer = yield* DatabaseWriter;
  yield* assertContentSyncBatchSize({
...
export const listAuthorsPage = Effect.fnUntraced(function* (args: {
