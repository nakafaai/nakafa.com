...
const loadContentRefBySlug = Effect.fnUntraced(function* (args: {
...
const upsertContentView = Effect.fnUntraced(function* (args: {
...
export const recordContentView = Effect.fnUntraced(function* (args: {
  contentRef: ContentViewRef;
  deviceId: string;
  locale: Locale;
}) {
...
export const getRecentlyViewed = Effect.fnUntraced(function* (args: {
  limit?: number;
  locale: Locale;
}) {
  const reader = yield* DatabaseReader;
