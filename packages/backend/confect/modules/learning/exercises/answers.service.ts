...
const scoreExerciseAnswer = Effect.fnUntraced(function* (args: {
...
export const submitAnswer = Effect.fnUntraced(function* (args: {
...
const loadOwnedInProgressAttempt = Effect.fnUntraced(function* (args: {
  readonly attemptId: Id<"exerciseAttempts">;
...
const applyAnswerAggregateDelta = Effect.fnUntraced(function* (
