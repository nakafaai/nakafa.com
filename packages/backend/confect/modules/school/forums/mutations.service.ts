...
export const createForum = Effect.fnUntraced(function* (args: {
  body: string;
...
export const createForumPost = Effect.fnUntraced(function* (args: {
  ...
  yield* Effect.promise(() => forumPostsBySequence.insert(ctx, aggregatePost));
...
export const toggleForumReaction = Effect.fnUntraced(function* (args: {
  emoji: string;
  forumId: Id<"schoolClassForums">;
}) {
  const reader = yield* DatabaseReader;
...
export const togglePostReaction = Effect.fnUntraced(function* (args: {
  emoji: string;
...
export const markForumRead = Effect.fnUntraced(function* (args: {
  forumId: Id<"schoolClassForums">;
