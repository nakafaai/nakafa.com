...
export const createSyncedAuthUser = Effect.fnUntraced(function* (
...
export const syncUpdatedAuthUser = Effect.fnUntraced(function* (
  ctx: ConvexMutationCtx,
...
export const cleanupDeletedAuthUser = Effect.fnUntraced(function* (
  ctx: ConvexMutationCtx,
  authUser: AuthUser
) {
  yield* Effect.promise(() =>
