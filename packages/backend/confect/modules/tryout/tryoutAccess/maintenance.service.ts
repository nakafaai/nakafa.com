...
export const getTryoutAccessCampaignIntegrity = Effect.fnUntraced(
  function* (args: {
...
export const getTryoutAccessGrantIntegrity = Effect.fnUntraced(
  function* (args: {
    readonly nowMs: number;
    readonly paginationOpts: PaginationOpts;
  }) {
...
export const getTryoutAccessEntitlementIntegrity = Effect.fnUntraced(
  function* (args: {
    readonly nowMs: number;
    readonly paginationOpts: PaginationOpts;
  }) {
...
export const listCompetitionCampaignProductsByProduct = Effect.fnUntraced(
  function* (args: {
    readonly paginationOpts: PaginationOpts;
