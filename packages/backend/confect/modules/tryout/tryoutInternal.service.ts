...
export const expireTryoutAttemptInternal = Effect.fnUntraced(function* (args: {
...
export const sweepExpiredTryoutAttempts = Effect.fnUntraced(function* () {
  const reader = yield* DatabaseReader;
...
export const promoteProvisionalTryoutScores = Effect.fnUntraced(
  function* (args: {
