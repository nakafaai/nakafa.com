...
export const startTryout = Effect.fn("tryouts.attempts.startTryout")(
  function* (args: {
    ...
    if (Either.isLeft(startableTryoutResult)) {
      ...
      yield* Effect.logWarning("Tryout start denied.", {
        locale: args.locale,
    ...
    if (!scaleVersion) {
      yield* Effect.logWarning(
        "Tryout start denied because scoring is not ready.",
        {
          locale: args.locale,
          product: args.product,
          tryoutId: tryout._id,
...
export const startPart = Effect.fn("tryouts.attempts.startPart")(
  function* (args: {
...
export const completePart = Effect.fn("tryouts.attempts.completePart")(
  function* (args: {
    readonly partKey: string;
    readonly tryoutAttemptId: Id<"tryoutAttempts">;
  }) {
