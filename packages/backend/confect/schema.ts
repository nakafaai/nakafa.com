...
import { tables as modules_chat_chats_tables_ts } from "./modules/chat/chats.tables";
import { tables as modules_commerce_credits_tables_ts } from "./modules/commerce/credits.tables";
import { tables as modules_commerce_customers_tables_ts } from "./modules/commerce/customers.tables";
import { tables as modules_commerce_subscriptions_tables_ts } from "./modules/commerce/subscriptions.tables";
import { tables as modules_content_articleContents_tables_ts } from "./modules/content/articleContents.tables";
import { tables as modules_content_audioStudies_tables_ts } from "./modules/content/audioStudies.tables";
import { tables as modules_content_authors_tables_ts } from "./modules/content/authors.tables";
import { tables as modules_content_bookmarks_tables_ts } from "./modules/content/bookmarks.tables";
import { tables as modules_content_comments_tables_ts } from "./modules/content/comments.tables";
import { tables as modules_content_contents_tables_ts } from "./modules/content/contents.tables";
import { tables as modules_content_exerciseQuestions_tables_ts } from "./modules/content/exerciseQuestions.tables";
import { tables as modules_content_exerciseSets_tables_ts } from "./modules/content/exerciseSets.tables";
import { tables as modules_content_subjectSections_tables_ts } from "./modules/content/subjectSections.tables";
import { tables as modules_content_subjectTopics_tables_ts } from "./modules/content/subjectTopics.tables";
import { tables as modules_identity_users_tables_ts } from "./modules/identity/users.tables";
import { tables as modules_learning_exercises_tables_ts } from "./modules/learning/exercises.tables";
import { tables as modules_notifications_notifications_tables_ts } from "./modules/notifications/notifications.tables";
import { tables as modules_school_assessments_tables_ts } from "./modules/school/assessments.tables";
import { tables as modules_school_classes_tables_ts } from "./modules/school/classes.tables";
import { tables as modules_school_schools_tables_ts } from "./modules/school/schools.tables";
import { tables as modules_tryout_access_tables_ts } from "./modules/tryout/access.tables";
import { tables as modules_tryout_irt_tables_ts } from "./modules/tryout/irt.tables";
import { tables as modules_tryout_tryouts_tables_ts } from "./modules/tryout/tryouts.tables";
