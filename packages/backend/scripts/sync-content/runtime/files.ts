...
import { SyncStateSchema } from "@repo/backend/scripts/sync-content/contract/schemas";
import type { SyncState } from "@repo/backend/scripts/sync-content/contract/types";
import {
  CONTENTS_DIR,
  getBackendEnvFilePath,
  getSyncStateFile,
} from "@repo/backend/scripts/sync-content/runtime/paths";
