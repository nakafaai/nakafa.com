...
export function registerNakafaMcpPrompts(server: McpServer) {
  server.registerPrompt(
    "nakafa_find_lesson",
    {
      argsSchema: toMcpSchema<unknown>(FindLessonPromptArgsSchema),
      description:
  ...
  server.registerPrompt(
    ...
    {
      argsSchema: toMcpSchema<unknown>(AnswerFromContentPromptArgsSchema),
      description:
  ...
  server.registerPrompt(
    ...
    {
      argsSchema: toMcpSchema<unknown>(QuranReferencePromptArgsSchema),
      description:
...
/** Builds the search-first lesson workflow prompt. */
...
/** Builds the grounded content-answer workflow prompt. */
...
/** Builds the bounded Quran-reference workflow prompt. */
...
/** Converts prompt lines into one MCP user message. */
...
/** Applies Effect Schema defaults and transformations at the prompt boundary. */
