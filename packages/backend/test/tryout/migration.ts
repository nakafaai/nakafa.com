...
export const seedResponseMigrationFixture = Effect.fn(
  "test.tryout.responseMigration.seed"
)(function* (t: ConvexTest, additional: number) {
...
export const seedInvalidResponseMigration = Effect.fn(
  "test.tryout.responseMigration.seedInvalid"
)(function* (
  t: ConvexTest,
  suffix: string,
  makeResponse: (input: {
...
export const readResponseMigrationState = Effect.fn(
  "test.tryout.responseMigration.readState"
)(function* (t: ConvexTest) {
  return yield* Effect.promise(() =>
    t.query(async (ctx) => ({
