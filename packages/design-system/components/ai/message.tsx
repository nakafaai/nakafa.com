  ...
  ({ children, className, ...props }: MessageContentProps) => (
    <div
      className={cn(
        ...
        "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-muted group-[.is-user]:px-3 group-[.is-user]:py-2 group-[.is-user]:text-foreground",
...
export const MessageBranch = memo(
  ({
    defaultBranch = 0,
    onBranchChange,
    className,
...
export const MessageBranchContent = memo(
...
export const MessageBranchSelector = memo(
...
export const MessageBranchPrevious = memo(
...
export const MessageBranchNext = memo(
...
export const MessageBranchPage = memo(
