...
export function PromptInputProvider({
  ...
  const openRef = useRef<() => void>(() => {
    // Noop - will be replaced by __registerFileInput
  });
...
export const PromptInputToolbar = ({
  ...
  <InputGroupAddon
    align="block-end"
    className={cn("justify-between gap-1 p-1", className)}
    {...props}
  />
);
...
declare global {
  // biome-ignore lint/nursery/useConsistentTypeDefinitions: It's a global declaration
  interface Window {
    SpeechRecognition: {
