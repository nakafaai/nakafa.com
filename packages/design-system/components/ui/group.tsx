...
/**
 * Groups related controls under one visual and semantic boundary.
 * Use this when adjacent controls should read as one action set; standalone
 * actions should keep using their underlying COSS primitives directly.
 */
...
/**
 * Adds non-interactive text inside a grouped control row.
 * It preserves the group silhouette without pretending to be a button or input.
 */
...
/**
 * Separates adjacent controls while preserving the connected COSS group shape.
 * Orientation defaults to vertical because horizontal groups are the common case.
 */
