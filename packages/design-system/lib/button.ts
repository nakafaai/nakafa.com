...
/**
 * Defines the shared native COSS button variants for buttons and anchor-like surfaces.
 *
 * The helper is pure class composition so non-client modules such as markdown,
 * pagination, and error pages can use button styling without importing the
 * interactive `Button` component. It does not introduce compatibility variants;
 * callers should map old one-off states to these semantic variants plus local
 * state classes.
 */
