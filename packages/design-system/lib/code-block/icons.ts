import type { SimpleIcon as ProgrammingIcon } from "simple-icons";
import {
  siAstro,
  siBiome,
  siBower,
...
/** Programming icons keyed by filename and extension patterns. */
...
/** Programming icons keyed by the language identifiers used by Shiki. */
export const languageIconMap: Readonly<Record<string, ProgrammingIcon>> = {
  astro: siAstro,
  bash: siGnubash,
  c: siC,
  "c++": siCplusplus,
