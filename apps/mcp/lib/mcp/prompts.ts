    ...
    messages: [
      {
        content: {
          text: [
            ...
            "Use `nakafa_get_quran_reference`, preserve semantic translation notes, distinguish embedded tafsir from official link-only access, and cite the canonical Nakafa URL plus returned sources.",
          ].join("\n"),
          type: "text" as const,
        },
        role: "user" as const,
