...
export function getNakafaSkillText() {
  return [
    ...
    "- Use `https://nakafa.com/llms-full.txt` only when a complete site snapshot is needed.",
    "- Use `https://nakafa.com/llms-full/index.json` to choose smaller locale and section full-content shards before downloading the complete snapshot.",
