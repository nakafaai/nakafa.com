...
import { parseGrade } from "@repo/contents/_lib/curriculum/grade";
import { parseMaterial } from "@repo/contents/_lib/curriculum/route";
import { getSlugPath } from "@repo/contents/_lib/curriculum/slug";
...
/** Wraps curriculum pages with graph content-view tracking when the route resolves. */
export default async function Layout(
  props: LayoutProps<"/[locale]/curriculum/[category]/[grade]/[material]/[...slug]">
) {
