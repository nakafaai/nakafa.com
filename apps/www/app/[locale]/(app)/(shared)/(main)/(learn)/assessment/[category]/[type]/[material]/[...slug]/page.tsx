...
import {
  ...
  getResolvedParams,
} from "@/app/[locale]/(app)/(shared)/(main)/(learn)/assessment/[category]/[type]/[material]/[...slug]/data";
import { YearGroupPage } from "@/app/[locale]/(app)/(shared)/(main)/(learn)/assessment/[category]/[type]/[material]/[...slug]/group";
import { ExerciseSetPage } from "@/app/[locale]/(app)/(shared)/(main)/(learn)/assessment/[category]/[type]/[material]/[...slug]/set";
import { SingleExercisePage } from "@/app/[locale]/(app)/(shared)/(main)/(learn)/assessment/[category]/[type]/[material]/[...slug]/single";
...
export async function generateMetadata({
  ...
  params: PageProps<"/[locale]/assessment/[category]/[type]/[material]/[...slug]">["params"];
}): Promise<Metadata> {
...
export default async function Page({
  params,
}: PageProps<"/[locale]/assessment/[category]/[type]/[material]/[...slug]">) {
  const { locale, category, type, material, slug } =
    await getResolvedParams(params);
  const data = await getExerciseRouteData(
    locale,
