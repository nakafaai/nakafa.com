...
| --- | --- | --- |
| Profile or contact data (name, email, optional profile image, optional role) | Account creation, support, and service delivery | Convex (database/hosting) - [Privacy Policy](https://www.convex.dev/legal/privacy/v2024-09-24), [DPA](https://www.convex.dev/legal/dpa/v2024-03-21); Vercel (hosting) - [Privacy Policy](https://vercel.com/legal/privacy-policy); Resend (email) - [Privacy Policy](https://resend.com/legal/privacy-policy) |
...
| Device and usage data (IP address, browser/OS, usage events) | Security, analytics, and service improvement | PostHog (analytics) - [GDPR Compliance](https://posthog.com/docs/privacy/gdpr-compliance); Vercel Analytics - [Privacy Policy](https://vercel.com/legal/privacy-policy); Vercel (hosting) |
...
- PostHog (product analytics) - [Privacy Compliance](https://posthog.com/docs/privacy)
- Vercel Analytics (website and product analytics) - [Privacy Policy](https://vercel.com/legal/privacy-policy)
