...
/**
 * Deletes any existing message tail that will be regenerated by a transcript
 * rewrite before Nina reads pinned context for the replacement turn.
 */
export const prepareExistingChatMessage = Effect.fn(
  "chat.prepareExistingChatMessage"
)(function* ({
  chatId,
  message,
  token,
