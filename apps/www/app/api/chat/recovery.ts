...
/**
 * Recovers invalid chat tool calls with deterministic page-fetch input when needed.
 *
 ...
 */
export const recoverChatToolCall = Effect.fn("chat.recoverChatToolCall")(
  function* ({
    error,
    inputSchema,
    reservePageFetch,
    ...
    if (NoSuchToolError.isInstance(error)) {
      yield* Effect.logWarning(
        "Invalid tool name, not attempting recovery"
