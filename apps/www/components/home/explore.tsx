...
function SubjectIcon() {
  return (
    <div className="relative flex h-18 w-20 items-center justify-center">
      <div className="relative flex h-14 w-16 flex-col gap-2 rounded-md border bg-card p-2.5 shadow-xs transition-transform ease-out group-hover:-translate-y-1">
        ...
        <div className="absolute -right-2 bottom-1 flex size-5.5 items-center justify-center rounded-full border-2 border-card bg-chart-3 text-background shadow-xs transition-transform ease-out group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:scale-110">
          <HugeIcons className="size-3" icon={Atom02Icon} />
        </div>

        <div className="absolute -bottom-2 -left-2 flex size-9 items-center justify-center rounded-full border-2 border-card bg-chart-1 text-background shadow-xs transition-transform ease-out group-hover:-translate-x-1 group-hover:translate-y-1 group-hover:scale-110">
...
function TryoutIcon() {
  return (
    <div className="relative flex h-18 w-20 items-center justify-center">
      <div className="relative flex h-14 w-16 flex-col justify-between rounded-md border bg-card p-2.5 shadow-xs transition-transform ease-out group-hover:-translate-y-1">
        ...
        <div className="absolute -bottom-2 -left-2 flex size-9 items-center justify-center rounded-full border-2 border-card bg-chart-2 text-background shadow-xs transition-transform ease-out group-hover:-translate-x-1 group-hover:translate-y-1 group-hover:scale-110">
          <HugeIcons className="size-4.5" icon={Timer02Icon} />
        </div>

        <div className="absolute -top-2 -right-2 flex size-6 items-center justify-center rounded-full border-2 border-card bg-chart-5 text-background shadow-xs transition-transform ease-out group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:scale-110">
...
function NinaIcon() {
  return (
    <div className="relative flex h-18 w-20 items-center justify-center">
      <div className="relative h-14 w-16 transition-transform ease-out group-hover:-translate-y-1">
        ...
        <div className="absolute -top-2 -left-2 flex size-9 items-center justify-center rounded-full border-2 border-card bg-chart-1 text-background shadow-xs transition-transform ease-out group-hover:-translate-x-1 group-hover:-translate-y-1 group-hover:scale-110">
          <HugeIcons className="size-4.5" icon={AiChat02Icon} />
        </div>

        <div className="absolute -right-2 -bottom-2 flex size-6 items-center justify-center rounded-full border-2 border-card bg-chart-2 text-background shadow-xs transition-transform ease-out group-hover:translate-x-1 group-hover:translate-y-1 group-hover:scale-110">
